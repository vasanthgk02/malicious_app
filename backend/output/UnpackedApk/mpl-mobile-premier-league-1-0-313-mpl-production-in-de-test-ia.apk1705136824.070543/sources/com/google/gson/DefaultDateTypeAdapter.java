...
public final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public String toString() {
        ...
        if (dateFormat instanceof SimpleDateFormat) {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("DefaultDateTypeAdapter(");
            outline73.append(((SimpleDateFormat) dateFormat).toPattern());
            outline73.append(')');
            return outline73.toString();
        }
        StringBuilder outline732 = GeneratedOutlineSupport.outline73("DefaultDateTypeAdapter(");
        outline732.append(dateFormat.getClass().getSimpleName());
        outline732.append(')');
