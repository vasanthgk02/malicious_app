            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (map.put(read, this.valueTypeAdapter.read(jsonReader)) == null) {
                        ...
                        throw new JsonSyntaxException(GeneratedOutlineSupport.outline48("duplicate key: ", read));
                    }
                }
                jsonReader.endArray();
            } else {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (map.put(read2, this.valueTypeAdapter.read(jsonReader)) != null) {
                        throw new JsonSyntaxException(GeneratedOutlineSupport.outline48("duplicate key: ", read2));
                    }
                }
