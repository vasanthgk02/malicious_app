...
public class JsonReader implements Closeable {
        ...
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() {
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                if (i == 13) {
                    ...
                    outline73.append(jsonReader.locationString());
        ...
        while (true) {
            if (i == i2) {
                ...
                if (fillBuffer(1)) {
                    ...
                    StringBuilder outline73 = GeneratedOutlineSupport.outline73("End of input");
                    ...
                    while (i5 < i6) {
                        ...
                        if (c4 < '0' || c4 > '9') {
                            if (c4 >= 'a' && c4 <= 'f') {
                                ...
                                StringBuilder outline73 = GeneratedOutlineSupport.outline73("\\u");
                                outline73.append(new String(this.buffer, this.pos, 4));
    ...
    private IOException syntaxError(String str) throws IOException {
        ...
        outline73.append(locationString());
        throw new MalformedJsonException(outline73.toString());
    }
    ...
    public String getPath() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (i3 == 1 || i3 == 2) {
                outline72.append('[');
                outline72.append(this.pathIndices[i2]);
                outline72.append(']');
    ...
    public String locationString() {
        StringBuilder outline75 = GeneratedOutlineSupport.outline75(" at line ", this.lineNumber + 1, " column ", (this.pos - this.lineStart) + 1, " path ");
        outline75.append(getPath());
    ...
    public double nextDouble() throws IOException {
        ...
        if (i == 16) {
            ...
            this.peekedString = nextQuotedValue(i == 8 ? ExtendedMessageFormat.QUOTE : StringEscapeUtils.CSV_QUOTE);
        } else if (i == 10) {
    ...
    public int nextInt() throws IOException {
        ...
        if (i == 16) {
            ...
            outline732.append(locationString());
        ...
        outline733.append(locationString());
        throw new NumberFormatException(outline733.toString());
    }
    ...
    public String nextName() throws IOException {
        ...
        if (i == 14) {
            ...
            str = nextQuotedValue(StringEscapeUtils.CSV_QUOTE);
        } else {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("Expected a name but was ");
            outline73.append(peek());
            outline73.append(locationString());
        ...
        do {
            ...
            if (i2 == 3) {
                ...
                if (i2 == 4) {
                    ...
                    skipQuotedValue(StringEscapeUtils.CSV_QUOTE);
                    this.peeked = 0;
                } else {
                    if (i2 == 16) {
                        this.pos += this.peekedNumberLength;
