...
public final class zzll {
    ...
    public static void zzd(zzlj zzlj, StringBuilder sb, int i) {
        boolean z;
        ...
        while (it.hasNext()) {
            ...
            String substring = str.startsWith(Constant.GET) ? str.substring(3) : str;
            ...
            if (((Method) hashMap2.get("set".concat(substring))) != null && (!substring.endsWith("Bytes") || !hashMap.containsKey(Constant.GET.concat(String.valueOf(substring.substring(0, substring.length() - 5)))))) {
                String concat3 = String.valueOf(substring.substring(0, 1).toLowerCase()).concat(String.valueOf(substring.substring(1)));
                Method method4 = (Method) hashMap.get(Constant.GET.concat(substring));
