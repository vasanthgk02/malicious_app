...
public final class zza extends AbstractClientBuilder<zzaz, NoOptions> {
    public final Client buildClient(Context context, Looper looper, ClientSettings clientSettings, Object obj, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        zzaz zzaz = new zzaz(context, looper, connectionCallbacks, onConnectionFailedListener, "activity_recognition", new Builder(context).zaa());
        return zzaz;
    }
}
