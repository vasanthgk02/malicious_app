...
public final class zzip {
    ...
    public static int zzc(zzlu zzlu, byte[] bArr, int i, int i2, int i3, zzio zzio) throws IOException {
        zzlm zzlm = (zzlm) zzlu;
        Object zze = zzlm.zze();
    ...
    public static int zze(zzlu zzlu, int i, byte[] bArr, int i2, int i3, zzkj zzkj, zzio zzio) throws IOException {
    ...
    public static int zzi(int i, byte[] bArr, int i2, int i3, zzmm zzmm, zzio zzio) throws zzkm {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
    ...
    public static int zzj(byte[] bArr, int i, zzio zzio) {
        ...
        byte b2 = bArr[i];
        if (b2 < 0) {
            return zzk(b2, bArr, i2, zzio);
        }
        zzio.zza = b2;
        return i2;
    }

    public static int zzk(int i, byte[] bArr, int i2, zzio zzio) {
        int i3 = i & 127;
        int i4 = i2 + 1;
        byte b2 = bArr[i2];
        if (b2 >= 0) {
        ...
        byte b3 = bArr[i4];
        if (b3 >= 0) {
            zzio.zza = i5 | (b3 << MqttWireMessage.MESSAGE_TYPE_DISCONNECT);
            return i6;
        }
    ...
    public static int zzl(int i, byte[] bArr, int i2, int i3, zzkj zzkj, zzio zzio) {
        zzkd zzkd = (zzkd) zzkj;
        int zzj = zzj(bArr, i2, zzio);
        zzkd.zzh(zzio.zza);
        while (zzj < i3) {
