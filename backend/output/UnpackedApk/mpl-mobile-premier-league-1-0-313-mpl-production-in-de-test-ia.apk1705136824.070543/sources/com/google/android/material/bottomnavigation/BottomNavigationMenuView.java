...
public class BottomNavigationMenuView extends NavigationBarMenuView {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!isShifting(getLabelVisibilityMode(), size2) || !this.itemHorizontalTranslationEnabled) {
            ...
            if (childAt.getVisibility() != 8) {
                childAt.measure(MeasureSpec.makeMeasureSpec(this.activeItemMaxWidth, LinearLayoutManager.INVALID_OFFSET), makeMeasureSpec);
