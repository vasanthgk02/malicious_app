...
public final class zzay extends zzaw {
    ...
    public static boolean zzc(zzap zzap, zzap zzap2) {
    ...
    public static boolean zzd(zzap zzap, zzap zzap2) {
        ...
        if (!Double.isNaN(doubleValue) && !Double.isNaN(doubleValue2)) {
            ...
            if (!(i == 0 && doubleValue2 == 0.0d) && (!(i == 0 && doubleValue2 == 0.0d) && Double.compare(doubleValue, doubleValue2) < 0)) {
                return true;
            }
        }
        return false;
    ...
    public static boolean zze(zzap zzap, zzap zzap2) {
        if (zzap instanceof zzal) {
            zzap = new zzat(zzap.zzi());
        }
        if (zzap2 instanceof zzal) {
