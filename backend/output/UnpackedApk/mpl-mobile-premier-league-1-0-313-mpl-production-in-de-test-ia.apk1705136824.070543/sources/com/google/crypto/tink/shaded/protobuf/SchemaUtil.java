...
public final class SchemaUtil {
    ...
    public static <UT, UB> UB storeUnknownEnum(int i, int i2, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        if (ub == null) {
            if (((UnknownFieldSetLiteSchema) unknownFieldSchema) != null) {
                ub = UnknownFieldSetLite.newInstance();
            } else {
                throw null;
            }
        }
    ...
    public static void writeBoolList(int i, List<Boolean> list, Writer writer, boolean z) throws IOException {
        if (list != null && !list.isEmpty()) {
            ...
            if (codedOutputStreamWriter != null) {
                if (z) {
                    ((ArrayEncoder) codedOutputStreamWriter.output).writeUInt32NoTag((i << 3) | 2);
                    int i2 = 0;
                    for (int i3 = 0; i3 < list.size(); i3++) {
                        list.get(i3).booleanValue();
                        i2++;
                    }
                    codedOutputStreamWriter.output.writeUInt32NoTag(i2);
                    for (int i4 = 0; i4 < list.size(); i4++) {
                        codedOutputStreamWriter.output.write(list.get(i4).booleanValue() ? (byte) 1 : 0);
                    }
                    return;
                }
                for (int i5 = 0; i5 < list.size(); i5++) {
                    ...
                    arrayEncoder.write(booleanValue ? (byte) 1 : 0);
                }
                return;
            }
            throw null;
    ...
    public static void writeBytesList(int i, List<ByteString> list, Writer writer) throws IOException {
        if (list != null && !list.isEmpty()) {
            ...
            if (codedOutputStreamWriter != null) {
                for (int i2 = 0; i2 < list.size(); i2++) {
                    ArrayEncoder arrayEncoder = (ArrayEncoder) codedOutputStreamWriter.output;
                    arrayEncoder.writeUInt32NoTag((i << 3) | 2);
                    arrayEncoder.writeBytesNoTag(list.get(i2));
                }
                return;
            }
            throw null;
            ...
            if (codedOutputStreamWriter != null) {
                ...
                while (i2 < list.size()) {
                    ...
                    if (codedOutputStream2 != null) {
                        ...
                        ArrayEncoder arrayEncoder = (ArrayEncoder) codedOutputStream2;
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (codedOutputStreamWriter != null) {
                ...
                if (z) {
                    ...
                    codedOutputStreamWriter.output.writeUInt32NoTag(i3);
                    while (i2 < list.size()) {
                        codedOutputStreamWriter.output.writeEnumNoTag(list.get(i2).intValue());
                        i2++;
                    }
                    return;
                }
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (codedOutputStreamWriter != null) {
                ...
                while (i2 < list.size()) {
                    ...
                    arrayEncoder.writeFixed32NoTag(intValue);
                    i2++;
                }
                return;
            }
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (codedOutputStreamWriter != null) {
                ...
                while (i2 < list.size()) {
                    ...
                    ArrayEncoder arrayEncoder = (ArrayEncoder) codedOutputStream;
                    arrayEncoder.writeUInt32NoTag((i << 3) | 1);
                    arrayEncoder.writeFixed64NoTag(longValue);
                    i2++;
                }
                return;
            }
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (codedOutputStreamWriter != null) {
                if (z) {
                    ...
                    codedOutputStreamWriter.output.writeUInt32NoTag(i2);
                    for (int i4 = 0; i4 < list.size(); i4++) {
                        codedOutputStreamWriter.output.writeUInt64NoTag(list.get(i4).longValue());
                    }
                    return;
                }
                int i5 = 0;
                while (i5 < list.size()) {
                    ...
                    if (codedOutputStream != null) {
                        ArrayEncoder arrayEncoder = (ArrayEncoder) codedOutputStream;
                        arrayEncoder.writeUInt32NoTag((i << 3) | 0);
                        arrayEncoder.writeUInt64NoTag(longValue);
                        i5++;
                    } else {
                        throw null;
                    }
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (codedOutputStreamWriter != null) {
                if (z) {
                    ...
                    codedOutputStreamWriter.output.writeUInt32NoTag(i2);
                    for (int i4 = 0; i4 < list.size(); i4++) {
                        codedOutputStreamWriter.output.writeUInt32NoTag(CodedOutputStream.encodeZigZag32(list.get(i4).intValue()));
                    }
                    return;
                }
                int i5 = 0;
                while (i5 < list.size()) {
                    ...
                    if (codedOutputStream != null) {
                        int encodeZigZag32 = CodedOutputStream.encodeZigZag32(intValue);
                        ArrayEncoder arrayEncoder = (ArrayEncoder) codedOutputStream;
                        arrayEncoder.writeUInt32NoTag((i << 3) | 0);
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (codedOutputStreamWriter != null) {
                if (z) {
                    ...
                    codedOutputStreamWriter.output.writeUInt32NoTag(i2);
                    for (int i4 = 0; i4 < list.size(); i4++) {
                        codedOutputStreamWriter.output.writeUInt64NoTag(CodedOutputStream.encodeZigZag64(list.get(i4).longValue()));
                    }
                    return;
                }
                int i5 = 0;
                while (i5 < list.size()) {
                    ...
                    long longValue = list.get(i5).longValue();
                    if (codedOutputStream != null) {
                        long encodeZigZag64 = CodedOutputStream.encodeZigZag64(longValue);
                        ArrayEncoder arrayEncoder = (ArrayEncoder) codedOutputStream;
                        arrayEncoder.writeUInt32NoTag((i << 3) | 0);
    ...
    public static void writeStringList(int i, List<String> list, Writer writer) throws IOException {
        if (list != null && !list.isEmpty()) {
            ...
            if (codedOutputStreamWriter != null) {
                ...
                if (list instanceof LazyStringList) {
                    ...
                    while (i2 < list.size()) {
                        ...
                        if (raw instanceof String) {
                            ArrayEncoder arrayEncoder = (ArrayEncoder) codedOutputStreamWriter.output;
                            arrayEncoder.writeUInt32NoTag((i << 3) | 2);
                            arrayEncoder.writeStringNoTag((String) raw);
                        } else {
                            ArrayEncoder arrayEncoder2 = (ArrayEncoder) codedOutputStreamWriter.output;
                            arrayEncoder2.writeUInt32NoTag((i << 3) | 2);
                            arrayEncoder2.writeBytesNoTag((ByteString) raw);
                        }
                        i2++;
                    }
                    return;
                ...
                while (i2 < list.size()) {
                    ArrayEncoder arrayEncoder3 = (ArrayEncoder) codedOutputStreamWriter.output;
                    arrayEncoder3.writeUInt32NoTag((i << 3) | 2);
                    arrayEncoder3.writeStringNoTag(list.get(i2));
                    i2++;
                }
                return;
            }
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (codedOutputStreamWriter != null) {
                if (z) {
                    ...
                    codedOutputStreamWriter.output.writeUInt32NoTag(i2);
                    for (int i4 = 0; i4 < list.size(); i4++) {
                        codedOutputStreamWriter.output.writeUInt32NoTag(list.get(i4).intValue());
                    }
                    return;
                }
                for (int i5 = 0; i5 < list.size(); i5++) {
                    ...
                    ArrayEncoder arrayEncoder = (ArrayEncoder) codedOutputStream;
                    arrayEncoder.writeUInt32NoTag((i << 3) | 0);
                    arrayEncoder.writeUInt32NoTag(intValue);
                }
                return;
            }
            throw null;
