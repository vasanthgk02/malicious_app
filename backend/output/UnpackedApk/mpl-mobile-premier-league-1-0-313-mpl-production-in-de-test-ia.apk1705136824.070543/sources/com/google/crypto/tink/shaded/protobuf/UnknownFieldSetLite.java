...
public final class UnknownFieldSetLite {
    ...
    public static void writeField(int i, Object obj, Writer writer) throws IOException {
        ...
        int i3 = i & 7;
        if (i3 == 0) {
            ((CodedOutputStreamWriter) writer).writeInt64(i2, ((Long) obj).longValue());
        } else if (i3 == 1) {
            ((CodedOutputStreamWriter) writer).writeFixed64(i2, ((Long) obj).longValue());
        } else if (i3 == 2) {
            ((CodedOutputStreamWriter) writer).writeBytes(i2, (ByteString) obj);
        } else if (i3 == 3) {
            ...
            if (fieldOrder == fieldOrder) {
                int i4 = i2 << 3;
                ((ArrayEncoder) codedOutputStreamWriter.output).writeUInt32NoTag(i4 | 3);
                ((UnknownFieldSetLite) obj).writeTo(writer);
                ((ArrayEncoder) codedOutputStreamWriter.output).writeUInt32NoTag(i4 | 4);
                return;
            }
            int i5 = i2 << 3;
            ((ArrayEncoder) codedOutputStreamWriter.output).writeUInt32NoTag(i5 | 4);
            ((UnknownFieldSetLite) obj).writeTo(writer);
            ((ArrayEncoder) codedOutputStreamWriter.output).writeUInt32NoTag(i5 | 3);
        } else if (i3 == 5) {
            ((CodedOutputStreamWriter) writer).writeFixed32(i2, ((Integer) obj).intValue());
        } else {
