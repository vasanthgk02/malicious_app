...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeStringNoTag(String str) throws IOException {
            ...
            try {
                ...
                this.position = i;
                CodedOutputStream.logger.log(Level.WARNING, "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", e2);
    ...
    public final void writeEnumNoTag(int i) throws IOException {
        ArrayEncoder arrayEncoder = (ArrayEncoder) this;
        if (i >= 0) {
            arrayEncoder.writeUInt32NoTag(i);
        } else {
            arrayEncoder.writeUInt64NoTag((long) i);
        }
    }
