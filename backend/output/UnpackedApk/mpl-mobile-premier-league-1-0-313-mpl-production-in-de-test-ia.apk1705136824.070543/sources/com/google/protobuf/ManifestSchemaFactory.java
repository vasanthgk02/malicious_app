...
public final class ManifestSchemaFactory implements SchemaFactory {
    ...
    public ManifestSchemaFactory() {
        ...
        try {
            messageInfoFactory2 = (MessageInfoFactory) Class.forName("com.google.protobuf.DescriptorMessageInfoFactory").getDeclaredMethod("getInstance", new Class[0]).invoke(null, new Object[0]);
