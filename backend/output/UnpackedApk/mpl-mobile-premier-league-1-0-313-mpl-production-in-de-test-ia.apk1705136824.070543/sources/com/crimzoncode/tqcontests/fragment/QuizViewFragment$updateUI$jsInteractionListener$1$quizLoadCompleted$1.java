...
public final class QuizViewFragment$updateUI$jsInteractionListener$1$quizLoadCompleted$1 implements Runnable {
    public final /* synthetic */ QuizViewFragment$updateUI$jsInteractionListener$1 this$0;

    public QuizViewFragment$updateUI$jsInteractionListener$1$quizLoadCompleted$1(QuizViewFragment$updateUI$jsInteractionListener$1 quizViewFragment$updateUI$jsInteractionListener$1) {
    ...
    public final void run() {
        ...
        if (access$getListener$p != null) {
            String string = this.this$0.this$0.getString(R.string.label_loading_images);
