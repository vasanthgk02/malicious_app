...
public final class ScreensShadowNode extends LayoutShadowNode {
    ...
    public static final void m109onBeforeLayout$lambda0(ScreensShadowNode screensShadowNode, NativeViewHierarchyManager nativeViewHierarchyManager) {
        ...
        View resolveView = nativeViewHierarchyManager.resolveView(screensShadowNode.mReactTag);
        ...
        if (uIManagerModule != null) {
            uIManagerModule.addUIBlock(new UIBlock() {
                public final void execute(NativeViewHierarchyManager nativeViewHierarchyManager) {
                    ScreensShadowNode.m109onBeforeLayout$lambda0(ScreensShadowNode.this, nativeViewHierarchyManager);
                }
            });
        }
    }
