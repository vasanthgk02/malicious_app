...
public final class RNGestureHandlerRootViewManager extends ViewGroupManager<RNGestureHandlerRootView> {
    ...
    public final ViewManagerDelegate<RNGestureHandlerRootView> mDelegate = new RNGestureHandlerRootViewManagerDelegate(this);
    ...
    public Map<String, Map<String, String>> getExportedCustomDirectEventTypeConstants() {
        return ArraysKt___ArraysJvmKt.mutableMapOf(new Pair("onGestureHandlerEvent", ArraysKt___ArraysJvmKt.mutableMapOf(new Pair("registrationName", "onGestureHandlerEvent"))), new Pair("onGestureHandlerStateChange", ArraysKt___ArraysJvmKt.mutableMapOf(new Pair("registrationName", "onGestureHandlerStateChange"))));
    }
    ...
    public void onDropViewInstance(RNGestureHandlerRootView rNGestureHandlerRootView) {
        ...
        RNGestureHandlerRootHelper rNGestureHandlerRootHelper = rNGestureHandlerRootView.rootHelper;
