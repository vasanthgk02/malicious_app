...
public class ConfigManager {
    ...
    public Date mLastInitiatedUpdate;
    public boolean mUseHardcodedConfig = false;
    ...
    public com.paypal.android.sdk.onetouch.core.config.OtcConfiguration getConfig() {
        /*
            ...
            r1 = 0
            java.lang.String r2 = "com.paypal.otc.config.file"
        ...
        L_0x001a:
            ...
            r3 = 1
        L_0x001c:
            com.paypal.android.sdk.onetouch.core.config.OtcConfiguration r1 = r5.getOtcConfiguration(r0)     // Catch:{ JSONException -> 0x0024 }
            r4 = r1
            r1 = r0
            r0 = r4
            goto L_0x002c
        L_0x0024:
            com.paypal.android.sdk.onetouch.core.config.OtcConfiguration r0 = r5.getOtcConfiguration(r1)     // Catch:{ JSONException -> 0x0035 }
            r5.refreshConfiguration()     // Catch:{ JSONException -> 0x0035 }
            r3 = 1
        L_0x002c:
    ...
    public final OtcConfiguration getOtcConfiguration(String str) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (jSONObject3 != null) {
                ...
                configFileParser.populateCommonData(oAuth2Recipe, jSONObject3);
                JSONArray jSONArray2 = jSONObject3.getJSONArray("scope");
                for (int i2 = 0; i2 < jSONArray2.length(); i2++) {
                    String string = jSONArray2.getString(i2);
                    if (!"*".equals(string)) {
                        oAuth2Recipe.mScope.add(string);
                    }
                }
                if (jSONObject3.has("endpoints")) {
                    JSONObject jSONObject4 = jSONObject3.getJSONObject("endpoints");
                    if (jSONObject4.has("live")) {
                        configFileParser.addEnvironment(oAuth2Recipe, "live", jSONObject4.getJSONObject("live"));
                    }
                    if (jSONObject4.has("develop")) {
                        configFileParser.addEnvironment(oAuth2Recipe, "develop", jSONObject4.getJSONObject("develop"));
                    }
                    if (jSONObject4.has("mock")) {
                        configFileParser.addEnvironment(oAuth2Recipe, "mock", jSONObject4.getJSONObject("mock"));
                    }
                }
                otcConfiguration.mOauth2RecipesInDecreasingPriorityOrder.add(oAuth2Recipe);
            }
        }
        ...
        for (int i3 = 0; i3 < jSONArray3.length(); i3++) {
            ...
            if (jSONObject5 != null) {
                ...
                configFileParser.populateCommonData(checkoutRecipe, jSONObject5);
                otcConfiguration.mCheckoutRecipesInDecreasingPriorityOrder.add(checkoutRecipe);
            }
        }
        ...
        for (int i4 = 0; i4 < jSONArray4.length(); i4++) {
            ...
            if (jSONObject6 != null) {
                ...
                configFileParser.populateCommonData(billingAgreementRecipe, jSONObject6);
                otcConfiguration.mBillingAgreementRecipesInDecreasingPriorityOrder.add(billingAgreementRecipe);
            }
        }
    ...
    public void refreshConfiguration() {
        if (!this.mUseHardcodedConfig) {
            Calendar instance = Calendar.getInstance();
            instance.add(11, -4);
            boolean before = new Date(this.mContextInspector.mPreferences.getLong("com.paypal.otc.config.lastUpdated.timestamp", 0)).before(instance.getTime());
            Calendar instance2 = Calendar.getInstance();
            instance2.add(13, -5);
            Date date = this.mLastInitiatedUpdate;
            boolean z = false;
            boolean z2 = date != null && !date.before(instance2.getTime());
            boolean z3 = this.mContextInspector.mPreferences.getBoolean("com.paypal.otc.config.isDefault", true);
            if ((before || z3) && !z2) {
                z = true;
            }
            if (z) {
                this.mLastInitiatedUpdate = new Date();
                this.mHttpClient.get("https://www.paypalobjects.com/webstatic/otc/otc-config.android.json", new HttpResponseCallback() {
    ...
    public final void setConfig(String str, boolean z) {
        this.mContextInspector.mPreferences.edit().putString("com.paypal.otc.config.file", str).apply();
        ContextInspector contextInspector = this.mContextInspector;
        contextInspector.mPreferences.edit().putLong("com.paypal.otc.config.lastUpdated.timestamp", System.currentTimeMillis()).apply();
        this.mContextInspector.mPreferences.edit().putBoolean("com.paypal.otc.config.isDefault", z).apply();
    }
}
