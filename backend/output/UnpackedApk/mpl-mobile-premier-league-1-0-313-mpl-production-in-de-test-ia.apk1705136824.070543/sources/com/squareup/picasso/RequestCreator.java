...
public class RequestCreator {
    ...
    public RequestCreator(Picasso picasso2, Uri uri, int i) {
    ...
    private Request createRequest(long j) {
        ...
        if (transformRequest != build) {
            ...
            if (z) {
                ...
                Utils.log(Utils.OWNER_MAIN, "changed", logId, "into " + transformRequest);
            }
        }
            ...
            if (this.data.hasImage()) {
                ...
                if (!MemoryPolicy.shouldReadFromMemoryCache(this.memoryPolicy) || this.picasso.quickMemoryCacheCheck(createKey) == null) {
                    ...
                    if (this.picasso.loggingEnabled) {
                        ...
                        Utils.log(Utils.OWNER_MAIN, Utils.VERB_COMPLETED, plainId, outline73.toString());
                    }
                    if (callback != null) {
                        callback.onSuccess();
                    }
        ...
        if (imageView2 == null) {
            ...
            if (MemoryPolicy.shouldReadFromMemoryCache(this.memoryPolicy)) {
                ...
                if (quickMemoryCacheCheck != null) {
                    this.picasso.cancelRequest(imageView2);
                    Picasso picasso2 = this.picasso;
                    PicassoDrawable.setBitmap(imageView, picasso2.context, quickMemoryCacheCheck, LoadedFrom.MEMORY, this.noFade, picasso2.indicatorsEnabled);
                    if (this.picasso.loggingEnabled) {
                        String plainId = createRequest.plainId();
                        StringBuilder outline73 = GeneratedOutlineSupport.outline73("from ");
                        outline73.append(LoadedFrom.MEMORY);
