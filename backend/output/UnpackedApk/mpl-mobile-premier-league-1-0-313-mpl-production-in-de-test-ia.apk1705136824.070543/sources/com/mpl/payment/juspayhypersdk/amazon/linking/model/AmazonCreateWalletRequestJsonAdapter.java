...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\u0010\u0010\u000e\u001a\u00020\u00022\u0006\u0010\u000f\u001a\u00020\u0010H\u0016J\u001a\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u00142\b\u0010\u0015\u001a\u0004\u0018\u00010\u0002H\u0016J\b\u0010\u0016\u001a\u00020\rH\u0016R\u0016\u0010\u0006\u001a\n\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u0007X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u000b0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\f\u001a\b\u0012\u0004\u0012\u00020\r0\u0001X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Lcom/mpl/payment/juspayhypersdk/amazon/linking/model/AmazonCreateWalletRequestJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/mpl/payment/juspayhypersdk/amazon/linking/model/AmazonCreateWalletRequest;", "moshi", "Lcom/squareup/moshi/Moshi;", "(Lcom/squareup/moshi/Moshi;)V", "constructorRef", "Ljava/lang/reflect/Constructor;", "options", "Lcom/squareup/moshi/JsonReader$Options;", "payloadAdapter", "Lcom/mpl/payment/juspayhypersdk/amazon/linking/model/Payload;", "stringAdapter", "", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "toString", "mpl-payment_release"}, k = 1, mv = {1, 4, 2})
/* compiled from: AmazonCreateWalletRequestJsonAdapter.kt */
public final class AmazonCreateWalletRequestJsonAdapter extends JsonAdapter<AmazonCreateWalletRequest> {
    public volatile Constructor<AmazonCreateWalletRequest> constructorRef;
    public final Options options;
    public final JsonAdapter<Payload> payloadAdapter;
    public final JsonAdapter<String> stringAdapter;

    public AmazonCreateWalletRequestJsonAdapter(Moshi moshi) {
    ...
    public String toString() {
        Intrinsics.checkNotNullExpressionValue("GeneratedJsonAdapter(AmazonCreateWalletRequest)", "StringBuilder(capacity).…builderAction).toString()");
        return "GeneratedJsonAdapter(AmazonCreateWalletRequest)";
    }

    public AmazonCreateWalletRequest fromJson(JsonReader jsonReader) {
        long j;
        ...
        if (i != ((int) 4294967292L)) {
            Constructor<AmazonCreateWalletRequest> constructor = this.constructorRef;
            if (constructor == null) {
                constructor = AmazonCreateWalletRequest.class.getDeclaredConstructor(new Class[]{cls, cls, Payload.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER});
                this.constructorRef = constructor;
                Intrinsics.checkNotNullExpressionValue(constructor, "AmazonCreateWalletReques…his.constructorRef = it }");
            }
            ...
            if (payload != null) {
                ...
                objArr[4] = null;
                AmazonCreateWalletRequest newInstance = constructor.newInstance(objArr);
            ...
            return new AmazonCreateWalletRequest(str, str2, payload);
        } else {
    ...
    public void toJson(JsonWriter jsonWriter, AmazonCreateWalletRequest amazonCreateWalletRequest) {
        Intrinsics.checkNotNullParameter(jsonWriter, "writer");
        if (amazonCreateWalletRequest != null) {
            jsonWriter.beginObject();
            jsonWriter.name(HyperServices.REQUEST_ID);
            this.stringAdapter.toJson(jsonWriter, amazonCreateWalletRequest.getRequestId());
            jsonWriter.name("service");
            this.stringAdapter.toJson(jsonWriter, amazonCreateWalletRequest.getService());
            jsonWriter.name("payload");
            this.payloadAdapter.toJson(jsonWriter, amazonCreateWalletRequest.getPayload());
