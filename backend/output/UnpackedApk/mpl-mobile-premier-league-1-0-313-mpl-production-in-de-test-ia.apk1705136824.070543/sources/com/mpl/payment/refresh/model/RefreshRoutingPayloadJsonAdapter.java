...
@Metadata(bv = {1, 0, 3}, d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\u0010\u0010\n\u001a\u00020\u00022\u0006\u0010\u000b\u001a\u00020\fH\u0016J\u001a\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u00102\b\u0010\u0011\u001a\u0004\u0018\u00010\u0002H\u0016J\b\u0010\u0012\u001a\u00020\tH\u0016R\u000e\u0010\u0006\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0001X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, d2 = {"Lcom/mpl/payment/refresh/model/RefreshRoutingPayloadJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/mpl/payment/refresh/model/RefreshRoutingPayload;", "moshi", "Lcom/squareup/moshi/Moshi;", "(Lcom/squareup/moshi/Moshi;)V", "options", "Lcom/squareup/moshi/JsonReader$Options;", "stringAdapter", "", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "toString", "mpl-payment_release"}, k = 1, mv = {1, 4, 2})
/* compiled from: RefreshRoutingPayloadJsonAdapter.kt */
public final class RefreshRoutingPayloadJsonAdapter extends JsonAdapter<RefreshRoutingPayload> {
    public final Options options;
    public final JsonAdapter<String> stringAdapter;

    public RefreshRoutingPayloadJsonAdapter(Moshi moshi) {
    ...
    public String toString() {
        Intrinsics.checkNotNullExpressionValue("GeneratedJsonAdapter(RefreshRoutingPayload)", "StringBuilder(capacity).…builderAction).toString()");
        return "GeneratedJsonAdapter(RefreshRoutingPayload)";
    }

    public RefreshRoutingPayload fromJson(JsonReader jsonReader) {
    ...
    public void toJson(JsonWriter jsonWriter, RefreshRoutingPayload refreshRoutingPayload) {
        Intrinsics.checkNotNullParameter(jsonWriter, "writer");
        if (refreshRoutingPayload != null) {
            jsonWriter.beginObject();
            jsonWriter.name("paymentMode");
            this.stringAdapter.toJson(jsonWriter, refreshRoutingPayload.getPaymentMode());
            jsonWriter.name("paymentMethodType");
            this.stringAdapter.toJson(jsonWriter, refreshRoutingPayload.getPaymentMethodType());
