...
public final class StatusJsonAdapter extends JsonAdapter<Status> {
    ...
    public StatusJsonAdapter(Moshi moshi) {
        ...
        Options of = Options.of("code", "message", "reason", "type", "title");
        Intrinsics.checkNotNullExpressionValue(of, "JsonReader.Options.of(\"c…\",\n      \"type\", \"title\")");
        this.options = of;
    ...
    public Status fromJson(JsonReader jsonReader) {
        ...
        if (num != null) {
            Status status = new Status(num.intValue(), str, str2, str3, str4);
            return status;
        }
    ...
    public void toJson(JsonWriter jsonWriter, Status status) {
        ...
        if (status != null) {
            ...
            this.nullableStringAdapter.toJson(jsonWriter, status.getReason());
            jsonWriter.name("type");
            this.nullableStringAdapter.toJson(jsonWriter, status.getType());
            jsonWriter.name("title");
            this.nullableStringAdapter.toJson(jsonWriter, status.getTitle());
