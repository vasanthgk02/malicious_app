...
@Keep
public class MOKHttpDeleteRequest extends MRequest {
    public static final String TAG = "NetworkLib: MOKHttpDeleteRequest";
    ...
    public static final class Builder {
        ...
        public MOKHttpDeleteRequest build() {
            if (this.mResponseListener != null) {
                return new MOKHttpDeleteRequest(this);
            }
    ...
    public MOKHttpDeleteRequest() {
        ...
        MLog.d(TAG, "MOKHttpDeleteRequest() called");
    }

    public MOKHttpDeleteRequest(Builder builder) {
        this.MEDIA_TYPE_STREAM = MediaType.parse("application/octet-stream;charset=utf-8");
        this.MEDIA_TYPE_STRING = MediaType.parse("text/plain;charset=utf-8");
        this.MEDIA_TYPE_JSON = MediaType.parse("application/json; charset=utf-8");
        MLog.d(TAG, "MOKHttpDeleteRequest() called with: builder = [" + builder + CMapParser.MARK_END_OF_ARRAY);
    ...
    public Request prepareRequest() {
        ...
        if (prepareRequestBody() == null) {
            ...
            builder.delete(prepareRequestBody());
        }
    ...
    public <E> void processResponse(okhttp3.Call r9, okhttp3.Response r10, com.mpl.network.modules.listeners.IResponseListener<E> r11) {
        /*
            ...
            okhttp3.Headers r2 = r10.headers()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.util.ArrayList r3 = new java.util.ArrayList     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r3.<init>()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            if (r2 == 0) goto L_0x0039
            int r4 = r2.size()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            if (r4 <= 0) goto L_0x0039
            java.util.Set r4 = r2.names()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.util.Iterator r4 = r4.iterator()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
        L_0x0020:
            boolean r5 = r4.hasNext()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            if (r5 == 0) goto L_0x0039
            java.lang.Object r5 = r4.next()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.String r5 = (java.lang.String) r5     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.String r6 = r2.get(r5)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            com.mpl.network.modules.engine.MHeader r7 = new com.mpl.network.modules.engine.MHeader     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r7.<init>(r5, r6)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r3.add(r7)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            goto L_0x0020
        L_0x0039:
            int r4 = r3.size()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            if (r4 <= 0) goto L_0x0042
            r11.onProcessHeader(r3)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
        L_0x0042:
            okhttp3.ResponseBody r1 = r10.body()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            if (r1 == 0) goto L_0x009f
            java.lang.String r0 = r1.string()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.String r2 = "NetworkLib: MOKHttpDeleteRequest"
            r3 = 2
            java.lang.Object[] r3 = new java.lang.Object[r3]     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r4 = 0
            java.lang.String r5 = "responseBody: "
            r3[r4] = r5     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r4 = 1
            r3[r4] = r0     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            com.mpl.MLog.i(r2, r3)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.reflect.Type r2 = r11.mType     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.Class<java.lang.String> r3 = java.lang.String.class
            if (r2 != r3) goto L_0x0072
            r11.onResponseSuccess(r0)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
        L_0x0065:
        ...
        L_0x0072:
            ...
            org.json.JSONObject r2 = new org.json.JSONObject     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r2.<init>(r0)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
        L_0x007d:
            r11.onResponseSuccess(r2)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            goto L_0x0065
        L_0x0081:
            java.lang.reflect.Type r2 = r11.mType     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.Class<org.json.JSONArray> r3 = org.json.JSONArray.class
            if (r2 != r3) goto L_0x008d
            org.json.JSONArray r2 = new org.json.JSONArray     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r2.<init>(r0)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            goto L_0x007d
        L_0x008d:
            com.google.gson.Gson r2 = new com.google.gson.Gson     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r2.<init>()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.reflect.Type r3 = r11.mType     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.Object r0 = r2.fromJson(r0, r3)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r11.onResponseSuccess(r0)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r1.close()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            goto L_0x00f7
        L_0x009f:
            com.mpl.network.modules.utils.MException$b r3 = new com.mpl.network.modules.utils.MException$b     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r3.<init>()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
        ...
        L_0x00b4:
            ...
            java.lang.String r5 = (java.lang.String) r5     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.String r6 = r2.get(r5)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r3.a(r5, r6)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            goto L_0x00b4
        L_0x00c8:
            r3.f966c = r0     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.NullPointerException r0 = new java.lang.NullPointerException     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.String r2 = "Response body  is null."
            r0.<init>(r2)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r3.f965b = r0     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.String r0 = "Response body is null due from server"
            r3.f964a = r0     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            com.mpl.network.modules.utils.MException r0 = r3.a()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            goto L_0x00f4
        L_0x00dc:
            com.mpl.network.modules.utils.MException$b r2 = new com.mpl.network.modules.utils.MException$b     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r2.<init>()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r2.f966c = r0     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.NullPointerException r0 = new java.lang.NullPointerException     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.String r3 = "Response is null."
            r0.<init>(r3)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            r2.f965b = r0     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            java.lang.String r0 = "Response is null due to server error"
            r2.f964a = r0     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
            com.mpl.network.modules.utils.MException r0 = r2.a()     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
        L_0x00f4:
            r11.onResponseFail(r0)     // Catch:{ IOException -> 0x0152, JSONException -> 0x0107 }
        L_0x00f7:
            r8.printProtocol(r10)
            r8.printResponseTime(r10)
            r8.processExtraOnResponse(r10)
        ...
        L_0x01ae:
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mpl.network.modules.request.MOKHttpDeleteRequest.processResponse(okhttp3.Call, okhttp3.Response, com.mpl.network.modules.listeners.IResponseListener):void");
    }

    public String toString() {
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("MOKHttpDeleteRequest{MEDIA_TYPE_STREAM=");
