...
public class DownloadManagerCursorStatus {
    ...
    public DownloadManagerCursorStatus(Gson gson2) {
    ...
    private final DownloadManagerStatus checkCondition(int i, int i2) {
        ...
        if (i3 == 1) {
            ...
            if (i3 == 4) {
                ...
                MLogger.d("DownloadOfAssets", this.gson.toJson((Object) downloadManagerStatus));
                MLogger.d("DownloadOfAssets", "<---------------------------------------------------------------->");
            ...
            MLogger.d("DownloadOfAssets", "<---------------------------------------------------------------->");
            MLogger.d("DownloadOfAssets", this.gson.toJson((Object) downloadManagerStatus2));
            MLogger.d("DownloadOfAssets", "<---------------------------------------------------------------->");
        ...
        MLogger.d("DownloadOfAssets", "<---------------------------------------------------------------->");
        MLogger.d("DownloadOfAssets", this.gson.toJson((Object) downloadManagerStatus22));
        MLogger.d("DownloadOfAssets", "<---------------------------------------------------------------->");
