...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\u00020\u0001B\u0017\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u001a\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\f2\u0006\u0010\r\u001a\u00020\nH\u0002J\u0019\u0010\u000e\u001a\u00020\n2\u0006\u0010\r\u001a\u00020\n2\u0006\u0010\u000f\u001a\u00020\nH\u0002R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u000e\u0010\u0004\u001a\u00020\u0005X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0010"}, d2 = {"Lcom/mpl/androidapp/cleanarch/core/config/domain/usecases/GetStringZkUseCase;", "", "configManager", "Lcom/mpl/androidapp/cleanarch/core/config/domain/ConfigManagerFeature;", "logger", "Lcom/mpl/androidapp/cleanarch/core/logger/domain/LoggerFeature;", "(Lcom/mpl/androidapp/cleanarch/core/config/domain/ConfigManagerFeature;Lcom/mpl/androidapp/cleanarch/core/logger/domain/LoggerFeature;)V", "getConfigManager", "()Lcom/mpl/androidapp/cleanarch/core/config/domain/ConfigManagerFeature;", "getStringData", "", "config", "Lorg/json/JSONObject;", "keyName", "invoke", "configType", "com.mpl.androidapp-1000313-1.0.313-20230413_15_39_production_declutter_test_iaRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* compiled from: GetStringZkUseCase.kt */
public final class GetStringZkUseCase {
    public final ConfigManagerFeature configManager;
    public final LoggerFeature logger;

    public GetStringZkUseCase(ConfigManagerFeature configManagerFeature, LoggerFeature loggerFeature) {
    ...
    private final String getStringData(JSONObject jSONObject, String str) {
        String str2 = "";
        if (jSONObject != null) {
    ...
    public final String invoke(String str, String str2) {
        ...
        if (CharsKt__CharKt.equals(str2, (String) ConfigZkFeatures.CONFIG_TYPE_NORMAL, true)) {
            return getStringData(this.configManager.getNormalConfig(), str);
        }
        if (CharsKt__CharKt.equals(str2, (String) "platform", true)) {
            return getStringData(this.configManager.getPlatformConfig(), str);
        }
