...
public final class NotificationGroupChallengeHeadsUpBinding implements ViewBinding {
    ...
    public NotificationGroupChallengeHeadsUpBinding(RelativeLayout relativeLayout, LinearLayout linearLayout, ImageView imageView, ImageView imageView2, TextView textView, TextView textView2, ImageView imageView3) {
    ...
    public static NotificationGroupChallengeHeadsUpBinding bind(View view) {
                ...
                if (imageView2 != null) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (imageView3 != null) {
                                NotificationGroupChallengeHeadsUpBinding notificationGroupChallengeHeadsUpBinding = new NotificationGroupChallengeHeadsUpBinding((RelativeLayout) view, linearLayout, imageView, imageView2, textView, textView2, imageView3);
                                return notificationGroupChallengeHeadsUpBinding;
                            }
                        }
                    }
                }
    ...
    public static NotificationGroupChallengeHeadsUpBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static NotificationGroupChallengeHeadsUpBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.notification_group_challenge_heads_up, viewGroup, false);
        if (z) {
