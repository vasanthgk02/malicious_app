...
import com.mpl.androidapp.database.dao.EventDaoAll_Impl;
...
public final class DatabaseEventsAll_Impl extends DatabaseEventsAll {
    public volatile EventDaoAll _eventDaoAll;
    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        RoomOpenHelper roomOpenHelper = new RoomOpenHelper(databaseConfiguration, new Delegate(2) {
            ...
            public void dropAllTables(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                if (DatabaseEventsAll_Impl.this.mCallbacks != null) {
                    int size = DatabaseEventsAll_Impl.this.mCallbacks.size();
                    for (int i = 0; i < size; i++) {
                        ((Callback) DatabaseEventsAll_Impl.this.mCallbacks.get(i)).onDestructiveMigration(supportSQLiteDatabase);
                    }
                }
            }
            ...
            public void onCreate(SupportSQLiteDatabase supportSQLiteDatabase) {
                if (DatabaseEventsAll_Impl.this.mCallbacks != null) {
                    int size = DatabaseEventsAll_Impl.this.mCallbacks.size();
                    for (int i = 0; i < size; i++) {
                        ((Callback) DatabaseEventsAll_Impl.this.mCallbacks.get(i)).onCreate(supportSQLiteDatabase);
                    }
                }
            }

            public void onOpen(SupportSQLiteDatabase supportSQLiteDatabase) {
                DatabaseEventsAll_Impl.this.mDatabase = supportSQLiteDatabase;
                DatabaseEventsAll_Impl.this.internalInitInvalidationTracker(supportSQLiteDatabase);
                if (DatabaseEventsAll_Impl.this.mCallbacks != null) {
                    int size = DatabaseEventsAll_Impl.this.mCallbacks.size();
                    for (int i = 0; i < size; i++) {
                        ((Callback) DatabaseEventsAll_Impl.this.mCallbacks.get(i)).onOpen(supportSQLiteDatabase);
                    }
                }
            }
    ...
    public EventDaoAll eventDaoAll() {
        EventDaoAll eventDaoAll;
        if (this._eventDaoAll != null) {
            return this._eventDaoAll;
        }
        synchronized (this) {
            if (this._eventDaoAll == null) {
                this._eventDaoAll = new EventDaoAll_Impl(this);
            }
            eventDaoAll = this._eventDaoAll;
        }
        return eventDaoAll;
    }
    ...
    public Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
        ...
        hashMap.put(EventDaoAll.class, EventDaoAll_Impl.getRequiredConverters());
        return hashMap;
    }
}
