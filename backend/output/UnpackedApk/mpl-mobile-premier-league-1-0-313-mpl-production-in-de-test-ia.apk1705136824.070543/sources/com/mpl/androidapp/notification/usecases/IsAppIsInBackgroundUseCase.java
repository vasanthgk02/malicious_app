...
public final class IsAppIsInBackgroundUseCase extends SuspendUseCase<Unit, UseCaseResult<? extends MPLNotificationStates>> {
    ...
    public Object execute(Unit unit, Continuation<? super UseCaseResult<? extends MPLNotificationStates>> continuation) {
        ...
        TypeUtilsKt.runBlocking(getDispatcher(), new IsAppIsInBackgroundUseCase$execute$2$1(this, cancellableContinuationImpl, null));
