...
public final class NotificationGroupHeadsUpBinding implements ViewBinding {
    ...
    public NotificationGroupHeadsUpBinding(RelativeLayout relativeLayout, LinearLayout linearLayout, ImageView imageView, TextView textView, TextView textView2, ImageView imageView2) {
    ...
    public static NotificationGroupHeadsUpBinding bind(View view) {
            ...
            if (imageView != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (imageView2 != null) {
                            NotificationGroupHeadsUpBinding notificationGroupHeadsUpBinding = new NotificationGroupHeadsUpBinding((RelativeLayout) view, linearLayout, imageView, textView, textView2, imageView2);
                            return notificationGroupHeadsUpBinding;
                        }
                    }
                }
            }
    ...
    public static NotificationGroupHeadsUpBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static NotificationGroupHeadsUpBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.notification_group_heads_up, viewGroup, false);
        if (z) {
