...
@DebugMetadata(c = "com.mpl.androidapp.miniprofile.view.fragment.MiniProfileFragment$setClickListeners$3$1", f = "MiniProfileFragment.kt", l = {}, m = "invokeSuspend")
/* compiled from: MiniProfileFragment.kt */
public final class MiniProfileFragment$setClickListeners$3$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ MiniProfileFragment this$0;

    /* JADX WARN: Illegal instructions before constructor call commented (this can break semantics) */
    public MiniProfileFragment$setClickListeners$3$1(MiniProfileFragment miniProfileFragment, Continuation<? super MiniProfileFragment$setClickListeners$3$1> continuation) {
        // this.this$0 = miniProfileFragment;
        super(2, continuation);
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MiniProfileFragment$setClickListeners$3$1(this.this$0, continuation);
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MiniProfileFragment$setClickListeners$3$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
