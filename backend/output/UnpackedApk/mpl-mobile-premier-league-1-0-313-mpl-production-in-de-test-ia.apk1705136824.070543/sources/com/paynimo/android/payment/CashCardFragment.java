...
import com.paynimo.android.payment.model.response.k.e;
...
public class CashCardFragment extends Fragment implements OnItemClickListener {
    ...
    public static CashCardFragment instance(Checkout checkout, r rVar) {
    ...
    private void networkCallWithBankCode(java.lang.String r6) {
        ...
        L_0x008d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.paynimo.android.payment.CashCardFragment.networkCallWithBankCode(java.lang.String):void");
    }
    ...
    public void prepareListData(String str) {
        ...
        if (cashCards != null) {
            ...
            if (topBanksCount > 0) {
                ...
                List<com.paynimo.android.payment.model.response.k.b> topBanks = cashCards.getTopBanks();
                if (topBanks != null) {
            ...
            if (otherBanksCount > 0) {
                ...
                if (topBanksCount > 0) {
                    bVar2.setBankName("Other CashCards");
                    bVar2.setBankCode("");
                } else {
                    bVar2.setBankName(PaymentActivity.PAYMENT_METHOD_CASHCARDS);
                    bVar2.setBankCode("");
                }
                this.adapter.addSectionHeaderItem(bVar2);
                List<com.paynimo.android.payment.model.response.k.b> otherBanks = cashCards.getOtherBanks();
                if (otherBanks != null) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        editText.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable editable) {
                CashCardFragment.this.adapter = new c(CashCardFragment.this.getActivity(), PaymentActivity.PAYMENT_METHOD_CASHCARDS);
                CashCardFragment.this.searchText = editable.toString();
                CashCardFragment cashCardFragment = CashCardFragment.this;
                cashCardFragment.prepareListData(cashCardFragment.searchText);
    ...
    public void onEvent(q qVar) {
        ...
        if (qVar.getResponse() != null) {
            com.paynimo.android.payment.util.b.callEventLogging("T", "click", "button:CashCardsSubmit", GeneratedOutlineSupport.outline13() - this.startTime.getTime(), "PASS", this.checkoutData, PaymentActivity.PAYMENT_METHOD_CASHCARDS, this.bankName, "", "", this.mServiceManager, getActivity());
            ...
            com.paynimo.android.payment.util.b.callEventLogging("T", "click", "button:CashCardsSubmit", GeneratedOutlineSupport.outline13() - this.startTime.getTime(), GopayLinkingHandler.STATUS_FAIL, this.checkoutData, PaymentActivity.PAYMENT_METHOD_CASHCARDS, this.bankName, "", "", this.mServiceManager, getActivity());
    ...
    public void onEvent(p pVar) {
        ((PaymentActivity) getActivity()).hideProgressLoader();
        com.paynimo.android.payment.util.b.callEventLogging("T", "click", "button:CashCardsSubmit", new Date().getTime() - this.startTime.getTime(), GopayLinkingHandler.STATUS_FAIL, this.checkoutData, PaymentActivity.PAYMENT_METHOD_CASHCARDS, this.bankName, "", "", this.mServiceManager, getActivity());
