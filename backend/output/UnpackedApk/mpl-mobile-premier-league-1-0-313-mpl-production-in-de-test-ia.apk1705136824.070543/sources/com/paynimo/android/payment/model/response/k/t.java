...
public class t implements Serializable {
    ...
    public String toString() {
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("Wallets [topBanksCount=");
        outline73.append(this.topBanksCount);
        outline73.append(", topBanks=");
        outline73.append(this.topBanks.toString());
        outline73.append(", otherBanksCount=");
        outline73.append(this.otherBanksCount);
        outline73.append(", otherBanks=");
        outline73.append(this.otherBanks.toString());
