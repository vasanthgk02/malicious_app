...
public class h implements Serializable {
    ...
    public List<g> otherBanks = new ArrayList();
    public int otherBanksCount;
    public List<g> topBanks = new ArrayList();
    ...
    public String toString() {
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("DigitalMandate [topBanksCount=");
