...
import com.paynimo.android.payment.model.response.k.k;
...
public class EMIFragment extends Fragment implements OnItemClickListener {
    public static final String FRAGMENT_TAG = "EMI";
    public c adapter;
    ...
    public static EMIFragment instance(Checkout checkout, r rVar) {
    ...
    private void networkCallWithBankCode(java.lang.String r6) {
        ...
        L_0x008d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.paynimo.android.payment.EMIFragment.networkCallWithBankCode(java.lang.String):void");
    }

    /* access modifiers changed from: private */
    public void prepareListData(String str) {
        k emiBanks = this.pmiData.getBanks().getEmiBanks();
        if (emiBanks != null) {
            int topBanksCount = emiBanks.getTopBanksCount();
            int otherBanksCount = emiBanks.getOtherBanksCount();
            if (topBanksCount > 0) {
                ...
                if (otherBanksCount > 0) {
                    bVar.setBankName("Popular EMI Banks");
                    bVar.setBankCode("");
                } else {
                    bVar.setBankName("EMI Banks");
                    bVar.setBankCode("");
                }
                List<com.paynimo.android.payment.model.response.k.b> topBanks = emiBanks.getTopBanks();
                if (topBanks != null) {
            ...
            if (otherBanksCount > 0) {
                ...
                if (topBanksCount > 0) {
                    bVar2.setBankName("Other EMI Banks");
                    bVar2.setBankCode("");
                } else {
                    bVar2.setBankName("EMI Banks");
                    bVar2.setBankCode("");
                }
                List<com.paynimo.android.payment.model.response.k.b> otherBanks = emiBanks.getOtherBanks();
                if (otherBanks != null) {
    ...
    private void prepareWebviewData(h hVar) {
        try {
            ...
            if (subType == null || !subType.equalsIgnoreCase(Constant.TAG_CARD_SUBTYPE_NET)) {
                Constant.showOutputLog("EMI", "subtype is not NET type=================>>>");
                return;
            }
    ...
    public void onAttach(Context context) {
        ...
        Constant.showOutputLog("==>>EMI", "onAttach");
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        editText.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable editable) {
                EMIFragment.this.adapter = new c(EMIFragment.this.getActivity(), "EMI");
                EMIFragment.this.searchText = editable.toString();
                EMIFragment eMIFragment = EMIFragment.this;
                eMIFragment.prepareListData(eMIFragment.searchText);
                EMIFragment.this.setListData();
            }
        ...
        this.adapter = new c(getActivity(), "EMI");
        a aVar = new a();
        this.mService = aVar;
    ...
    public void onDetach() {
        ...
        Constant.showOutputLog("==>>EMI", "onDetach");
    }

    @Subscribe
    public void onEvent(q qVar) {
        Constant.showOutputLog("EMI", "got T response");
        ((PaymentActivity) getActivity()).hideProgressLoader();
        if (qVar.getResponse() != null) {
            com.paynimo.android.payment.util.b.callEventLogging("T", "click", "button:EMISubmit", GeneratedOutlineSupport.outline13() - this.startTime.getTime(), "PASS", this.checkoutData, "EMI", this.bankName, "", Logging.TAB, this.mServiceManager, getActivity());
            Constant.showOutputLog("EMI", qVar.getResponse().toString());
            try {
                if (qVar.getResponse().getPaymentMethod().getError().getCode().isEmpty()) {
                    ...
                    if (paymentMethod != null) {
                        ...
                        Constant.showOutputLog("EMI", "got NULL PaymentMethod value in T response");
                    }
                } else {
            ...
            com.paynimo.android.payment.util.b.callEventLogging("T", "click", "button:EMISubmit", GeneratedOutlineSupport.outline13() - this.startTime.getTime(), GopayLinkingHandler.STATUS_FAIL, this.checkoutData, "EMI", this.bankName, "", Logging.TAB, this.mServiceManager, getActivity());
            Constant.showOutputLog("EMI", "Null T response");
        }
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        ...
        Constant.showOutputLog("EMI", " HashMap does not contain the BANK NAME");
    }

    public void onPause() {
        super.onPause();
        Constant.showOutputLog("==>>EMI", "onPause");
    }

    public void onResume() {
        super.onResume();
        Constant.showOutputLog("==>>EMI", "onResume");
    }

    public void onEvent(p pVar) {
        ((PaymentActivity) getActivity()).hideProgressLoader();
        com.paynimo.android.payment.util.b.callEventLogging("T", "click", "button:EMISubmit", new Date().getTime() - this.startTime.getTime(), GopayLinkingHandler.STATUS_FAIL, this.checkoutData, "EMI", this.bankName, "", Logging.TAB, this.mServiceManager, getActivity());
