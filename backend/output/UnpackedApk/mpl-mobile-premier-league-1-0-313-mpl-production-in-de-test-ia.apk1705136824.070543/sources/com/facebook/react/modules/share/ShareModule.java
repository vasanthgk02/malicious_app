...
public class ShareModule extends NativeShareModuleSpec {
    ...
    public void share(ReadableMap readableMap, String str, Promise promise) {
        if (readableMap == null) {
            promise.reject((String) ERROR_INVALID_CONTENT, (String) "Content cannot be null");
            return;
        }
        try {
            ...
            promise.reject((String) ERROR_UNABLE_TO_OPEN_DIALOG, (String) "Failed to open share dialog");
        }
    }
}
