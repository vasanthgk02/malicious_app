...
public abstract class MultiplexProducer<K, T extends Closeable> implements Producer<T> {
    ...
    public final Map<K, Multiplexer> mMultiplexers;
    ...
    public class Multiplexer {
        ...
        public com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer mForwardingConsumer;
        public final K mKey;
        ...
        public void startInputProducerIfHasAttachedConsumers() {
            synchronized (this) {
                boolean z = true;
                k.checkArgument(this.mMultiplexProducerContext == null);
         ...
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:?, code lost:
            ((com.facebook.imagepipeline.producers.ProducerContext) r1.second).getProducerListener().onProducerFinishWithFailure((com.facebook.imagepipeline.producers.ProducerContext) r1.second, com.facebook.imagepipeline.producers.MultiplexProducer.access$900(r5.this$0), r7, null);
        ...
        public void onFailure(com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer r6, java.lang.Throwable r7) {
            /*
                r5 = this;
                monitor-enter(r5)
                com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer<> r0 = r5.mForwardingConsumer     // Catch:{ all -> 0x0051 }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:18:0x0046, code lost:
            ((com.facebook.imagepipeline.producers.ProducerContext) r1.second).getProducerListener().onProducerFinishWithSuccess((com.facebook.imagepipeline.producers.ProducerContext) r1.second, com.facebook.imagepipeline.producers.MultiplexProducer.access$900(r5.this$0), null);
         */
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void onNextResult(com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer r6, T r7, int r8) {
            /*
                r5 = this;
                monitor-enter(r5)
                com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer<> r0 = r5.mForwardingConsumer     // Catch:{ all -> 0x007a }
                if (r0 == r6) goto L_0x0007
