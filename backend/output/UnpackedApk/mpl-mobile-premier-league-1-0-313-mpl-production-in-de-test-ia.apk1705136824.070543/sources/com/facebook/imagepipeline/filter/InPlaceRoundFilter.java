...
public final class InPlaceRoundFilter {
    public static void roundBitmapInPlace(Bitmap bitmap) {
        if (bitmap != null) {
            ...
            int i2 = height / 2;
            if (min != 0) {
                k.checkArgument(min >= 1);
                k.checkArgument(width > 0 && ((float) width) <= 2048.0f);
                k.checkArgument(height > 0 && ((float) height) <= 2048.0f);
                k.checkArgument(i > 0 && i < width);
                k.checkArgument(i2 > 0 && i2 < height);
                int[] iArr = new int[(width * height)];
                bitmap.getPixels(iArr, 0, width, 0, 0, width, height);
                int i3 = min - 1;
                k.checkArgument(i - i3 >= 0 && i2 - i3 >= 0 && i + i3 < width && i2 + i3 < height);
                int i4 = (-min) * 2;
                ...
                while (i3 >= i6) {
                    ...
                    int i17 = i2 + i6;
                    int i18 = i2 - i6;
                    k.checkArgument(i3 >= 0 && i11 < width && i13 >= 0 && i17 < height && i18 >= 0);
                    int i19 = i17 * width;
                    int i20 = height;
                    int i21 = width * i18;
                    int i22 = i2;
