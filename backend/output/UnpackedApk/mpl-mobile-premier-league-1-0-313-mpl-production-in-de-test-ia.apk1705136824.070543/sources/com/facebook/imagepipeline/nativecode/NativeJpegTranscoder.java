...
public class NativeJpegTranscoder implements ImageTranscoder {
    ...
    public static void transcodeJpeg(InputStream inputStream, OutputStream outputStream, int i, int i2, int i3) throws IOException {
        ...
        k.checkArgument(JpegTranscoderUtils.isRotationAngleAllowed(i));
        if (!(i2 == 8 && i == 0)) {
            z = true;
        }
        k.checkArgument(z, (Object) "no transformation requested");
        if (inputStream == null) {
            throw null;
    ...
    public static void transcodeJpegWithExifOrientation(InputStream inputStream, OutputStream outputStream, int i, int i2, int i3) throws IOException {
        ...
        k.checkArgument(i3 >= 0);
        k.checkArgument(i3 <= 100);
        k.checkArgument(JpegTranscoderUtils.isExifOrientationAllowed(i));
        if (!(i2 == 8 && i == 1)) {
            z = true;
        }
        k.checkArgument(z, (Object) "no transformation requested");
