...
public class OkHttpNetworkFetcher extends BaseNetworkFetcher<OkHttpNetworkFetchState> {
    ...
    public final Factory mCallFactory;
    ...
    public void fetchWithRequest(final OkHttpNetworkFetchState okHttpNetworkFetchState, final Callback callback, Request request) {
        ...
        FirebasePerfOkHttpClient.enqueue(newCall, new okhttp3.Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    BytesRange fromContentRangeHeader = BytesRange.fromContentRangeHeader(response.header(Names.CONTENT_RANGE));
    ...
    public void fetch(OkHttpNetworkFetchState okHttpNetworkFetchState, Callback callback) {
        ...
        try {
            Builder builder = new Builder().url(okHttpNetworkFetchState.getUri().toString()).get();
