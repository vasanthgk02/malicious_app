...
public abstract class AbstractDataSource<T> implements DataSource<T> {
    ...
    public void subscribe(com.facebook.datasource.DataSubscriber<T> r3, java.util.concurrent.Executor r4) {
        /*
            ...
            monitor-enter(r2)
            boolean r0 = r2.mIsClosed     // Catch:{ all -> 0x0040 }
            if (r0 == 0) goto L_0x000c
            monitor-exit(r2)     // Catch:{ all -> 0x0040 }
            return
        L_0x000c:
            com.facebook.datasource.AbstractDataSource$DataSourceStatus r0 = r2.mDataSourceStatus     // Catch:{ all -> 0x0040 }
            com.facebook.datasource.AbstractDataSource$DataSourceStatus r1 = com.facebook.datasource.AbstractDataSource.DataSourceStatus.IN_PROGRESS     // Catch:{ all -> 0x0040 }
            if (r0 != r1) goto L_0x001b
            java.util.concurrent.ConcurrentLinkedQueue<android.util.Pair<com.facebook.datasource.DataSubscriber<T>, java.util.concurrent.Executor>> r0 = r2.mSubscribers     // Catch:{ all -> 0x0040 }
            android.util.Pair r1 = android.util.Pair.create(r3, r4)     // Catch:{ all -> 0x0040 }
            r0.add(r1)     // Catch:{ all -> 0x0040 }
        L_0x001b:
            boolean r0 = r2.hasResult()     // Catch:{ all -> 0x0040 }
            if (r0 != 0) goto L_0x0030
            boolean r0 = r2.isFinished()     // Catch:{ all -> 0x0040 }
            if (r0 != 0) goto L_0x0030
            boolean r0 = r2.wasCancelled()     // Catch:{ all -> 0x0040 }
