...
public final class R$styleable {
    ...
    public static final int[] RecyclerBanner = {R.attr.autoPlaying, R.attr.indicatorGravity, R.attr.indicatorMargin, R.attr.indicatorSelected, R.attr.indicatorSize, R.attr.indicatorSpace, R.attr.indicatorUnselected, R.attr.playInterval, R.attr.showIndicator};
    public static final int RecyclerBanner_autoPlaying = 0;
    public static final int RecyclerBanner_indicatorGravity = 1;
    public static final int RecyclerBanner_indicatorMargin = 2;
    public static final int RecyclerBanner_indicatorSelected = 3;
    public static final int RecyclerBanner_indicatorSize = 4;
    public static final int RecyclerBanner_indicatorSpace = 5;
    public static final int RecyclerBanner_indicatorUnselected = 6;
    public static final int RecyclerBanner_playInterval = 7;
    public static final int RecyclerBanner_showIndicator = 8;
