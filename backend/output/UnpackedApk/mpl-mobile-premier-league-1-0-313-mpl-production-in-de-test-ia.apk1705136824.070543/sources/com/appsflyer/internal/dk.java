...
public final class dk {
    public static int AFInAppEventParameterName(int i, int[][] iArr) {
        return ((iArr[0][i >>> 24] + iArr[1][(i >>> 16) & InvitationReply.EXPIRED]) ^ iArr[2][(i >>> 8) & InvitationReply.EXPIRED]) + iArr[3][i & InvitationReply.EXPIRED];
    }
