...
public interface GL20 {
    ...
    void glSampleCoverage(float f2, boolean z);
    ...
    void glTexParameterf(int i, int i2, float f2);
    ...
    void glUniform1f(int i, float f2);
    ...
    void glUniform2f(int i, float f2, float f3);
    ...
    void glUniform3f(int i, float f2, float f3, float f4);
    ...
    void glUniform4f(int i, float f2, float f3, float f4, float f5);
    ...
    void glVertexAttrib1f(int i, float f2);

    void glVertexAttrib1fv(int i, FloatBuffer floatBuffer);

    void glVertexAttrib2f(int i, float f2, float f3);

    void glVertexAttrib2fv(int i, FloatBuffer floatBuffer);

    void glVertexAttrib3f(int i, float f2, float f3, float f4);

    void glVertexAttrib3fv(int i, FloatBuffer floatBuffer);

    void glVertexAttrib4f(int i, float f2, float f3, float f4, float f5);
