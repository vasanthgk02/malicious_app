...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000)\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\u001e\u0010\u0003\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016J$\u0010\t\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u00062\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00020\u000bH\u0016¨\u0006\f"}, d2 = {"com/midtrans/sdk/gopaycheckout/core/GoPayCheckoutClient$enquireAccount$1", "Lretrofit2/Callback;", "Lcom/midtrans/sdk/gopaycheckout/core/account/AccountResponse;", "onFailure", "", "call", "Lretrofit2/Call;", "t", "", "onResponse", "response", "Lretrofit2/Response;", "gopay-checkout_release"}, k = 1, mv = {1, 1, 16})
public final class GoPayCheckoutClient$enquireAccount$1 implements Callback<AccountResponse> {
    public final /* synthetic */ GoPayCheckoutCallback $internalCallback;
    public final /* synthetic */ GoPayCheckoutClient this$0;

    public GoPayCheckoutClient$enquireAccount$1(GoPayCheckoutClient goPayCheckoutClient, GoPayCheckoutCallback goPayCheckoutCallback) {
    ...
    public void onFailure(Call<AccountResponse> call, Throwable th) {
        ...
        this.this$0.getAnalyticsTracker$gopay_checkout_release().trackEvent(AnalyticsEvent.ENQUIRE_ACCOUNT_ERROR, this.this$0.mapAnalyticsProperties(unknownError));
    ...
    public void onResponse(Call<AccountResponse> call, Response<AccountResponse> response) {
        ...
        if (response.isSuccessful()) {
            T t = response.body;
            if (t != null) {
                AnalyticsTracker.trackEvent$default(this.this$0.getAnalyticsTracker$gopay_checkout_release(), AnalyticsEvent.ENQUIRE_ACCOUNT_SUCCESS, null, 2, null);
        ...
        this.this$0.getAnalyticsTracker$gopay_checkout_release().trackEvent(AnalyticsEvent.ENQUIRE_ACCOUNT_ERROR, this.this$0.mapAnalyticsProperties(clientError));
