...
public interface StatusesService {
    ...
    Call<Tweet> update(@Field("status") String str, @Field("in_reply_to_status_id") Long l, @Field("possibly_sensitive") Boolean bool, @Field("lat") Double d2, @Field("long") Double d3, @Field("place_id") String str2, @Field("display_coordinates") Boolean bool2, @Field("trim_user") Boolean bool3, @Field("media_ids") String str3);
