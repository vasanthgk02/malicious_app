...
public class ARTShapeShadowNode extends ARTVirtualNode {
    ...
    public void setFill(ReadableArray readableArray) {
        this.mBrushData = TextAppearanceConfig.toFloatArray(readableArray);
        markUpdated();
    }
    ...
    public void setStrokeDash(ReadableArray readableArray) {
        this.mStrokeDash = TextAppearanceConfig.toFloatArray(readableArray);
        markUpdated();
    }
    ...
    public boolean setupFillPaint(Paint paint, float f2) {
        ...
        if (this.mShadowOpacity > 0.0f) {
            paint2.setShadowLayer(this.mShadowRadius, this.mShadowOffsetX, this.mShadowOffsetY, this.mShadowColor);
        }
        return true;
    }

    public boolean setupStrokePaint(Paint paint) {
