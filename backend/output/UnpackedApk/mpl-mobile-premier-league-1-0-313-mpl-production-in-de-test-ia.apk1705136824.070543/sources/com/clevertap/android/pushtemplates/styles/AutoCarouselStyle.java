...
public final class AutoCarouselStyle extends Style {
    ...
    public AutoCarouselStyle(TemplateRenderer templateRenderer) {
    ...
    public RemoteViews makeBigContentRemoteView(Context context, TemplateRenderer templateRenderer) {
        ...
        Intrinsics.checkNotNullParameter(templateRenderer, "renderer");
        return new AutoCarouselContentView(context, templateRenderer).remoteView;
    }
    ...
    public PendingIntent makePendingIntent(Context context, Bundle bundle, int i) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(bundle, "extras");
        return PendingIntentFactory.getPendingIntent(context, i, bundle, true, 2, this.renderer);
    }
