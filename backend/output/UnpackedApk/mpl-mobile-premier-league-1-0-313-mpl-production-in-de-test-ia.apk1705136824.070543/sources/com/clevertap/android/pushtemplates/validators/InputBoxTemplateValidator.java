...
public final class InputBoxTemplateValidator extends TemplateValidator {
    ...
    public InputBoxTemplateValidator(Validator validator2) {
    ...
    public List<Checker<? extends Object>> loadKeys() {
        Checker<? extends Object> checker = this.keys.get("PT_INPUT_FEEDBACK");
        Intrinsics.checkNotNull(checker);
        Checker<? extends Object> checker2 = this.keys.get("PT_ACTIONS");
