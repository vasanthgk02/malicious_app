...
public final class RatingTemplateValidator extends TemplateValidator {
    ...
    public List<Checker<? extends Object>> loadKeys() {
        Checker<? extends Object> checker = this.keys.get("PT_DEEPLINK_LIST");
        Intrinsics.checkNotNull(checker);
        Checker<? extends Object> checker2 = this.keys.get("PT_RATING_DEFAULT_DL");
