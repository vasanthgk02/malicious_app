...
public class bi extends WebViewClient {
    ...
    public bi(BotFaqDetailsActivity botFaqDetailsActivity) {
        this.jk = botFaqDetailsActivity;
    }

    private String t() {
        return GeneratedOutlineSupport.outline42("javascript:(function(){ document.body.style.paddingBottom = '", (int) this.jk.getResources().getDimension(R.dimen.freshchat_faq_content_padding_bottom), "px'})();");
    }

    public void onPageFinished(WebView webView, String str) {
        super.onPageFinished(webView, str);
        this.jk.pH.postDelayed(new bj(this), 500);
        webView.loadUrl(t());
    }
    ...
    public boolean shouldOverrideUrlLoading(android.webkit.WebView r4, java.lang.String r5) {
        ...
        L_0x0011:
            ...
            com.freshchat.consumer.sdk.activity.BotFaqDetailsActivity r4 = r3.jk
        ...
        L_0x0035:
            ...
            r4.putBoolean(r0, r2)
            com.freshchat.consumer.sdk.activity.BotFaqDetailsActivity r0 = r3.jk
        ...
        L_0x004a:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.freshchat.consumer.sdk.activity.bi.shouldOverrideUrlLoading(android.webkit.WebView, java.lang.String):boolean");
    }
}
