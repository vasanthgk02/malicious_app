...
public final class p {
    ...
    public static final Map<Class<?>, Class<?>> f3714a;

    /* renamed from: b  reason: collision with root package name */
    public static final Map<Class<?>, Class<?>> f3715b;
    ...
    static {
        ...
        f3714a = Collections.unmodifiableMap(hashMap);
        f3715b = Collections.unmodifiableMap(hashMap2);
    }

    public static <T> Class<T> a(Class<T> cls) {
        Class<T> cls2 = f3714a.get(a.a(cls));
    ...
    public static boolean a(Type type) {
        return f3714a.containsKey(type);
    }
}
