...
public class DateFormatUtils {
    public static final FastDateFormat ISO_DATETIME_FORMAT = FastDateFormat.getInstance(SMTConfigConstants.SERVER_TIME_FORMAT);
    ...
    public static final FastDateFormat SMTP_DATETIME_FORMAT = FastDateFormat.getInstance((String) "EEE, dd MMM yyyy HH:mm:ss Z", Locale.US);
