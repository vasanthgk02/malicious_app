...
public final class COSName extends COSBase implements Comparable<COSName> {
    ...
    public static final COSName APP = new COSName(UpdaterAnalytics.APP);
    ...
    public static final COSName BBOX = new COSName(PDLayoutAttributeObject.BBOX);
    ...
    public static final COSName BTN = new COSName(PDFieldTreeNode.FIELD_TYPE_BUTTON);
    ...
    public static final COSName CH = new COSName(PDFieldTreeNode.FIELD_TYPE_CHOICE);
    ...
    public static final COSName DESC = new COSName(PDPrintFieldAttributeObject.DESC);
    ...
    public static final COSName DIGEST_SHA1 = new COSName(WebSocketHandshake.SHA1_PROTOCOL);
    ...
    public static final COSName E = new COSName(Constant.PAYMENT_METHOD_TYPE_EMI);
    ...
    public static final COSName FLAGS = new COSName(GameConstant.GAME_FRAUD_DETECTION_FLAGS);
    ...
    public static final COSName HEIGHT = new COSName(PDLayoutAttributeObject.HEIGHT);
    ...
    public static final COSName LOCATION = new COSName(Names.LOCATION);
    ...
    public static final COSName OP_NS = new COSName(JoinRoomInvitationRequest.KEY_OPTIONAL_PARAMS);
    ...
    public static final COSName SIG = new COSName(PDFieldTreeNode.FIELD_TYPE_SIGNATURE);
    ...
    public static final COSName STRUCT_TREE_ROOT = new COSName(PDStructureTreeRoot.TYPE);
    ...
    public static final COSName SV = new COSName(Constant.REQUEST_TYPE_SV);
    ...
    public static final COSName TX = new COSName(PDFieldTreeNode.FIELD_TYPE_TEXT);
    ...
    public static final COSName V = new COSName(DefaultSFSDataSerializer.FIELD_VALUE_KEY);
    ...
    public static final COSName WIDTH = new COSName(PDLayoutAttributeObject.WIDTH);
    ...
    public String toString() {
        return GeneratedOutlineSupport.outline62(GeneratedOutlineSupport.outline73("COSName{"), this.name, "}");
    }

    public void writePDF(OutputStream outputStream) throws IOException {
        outputStream.write(47);
        for (byte b2 : getName().getBytes(Charsets.US_ASCII)) {
            int i = (b2 + 256) % 256;
            if ((i < 65 || i > 90) && ((i < 97 || i > 122) && !((i >= 48 && i <= 57) || i == 43 || i == 45 || i == 95 || i == 64 || i == 42 || i == 36 || i == 59 || i == 46))) {
                outputStream.write(35);
                outputStream.write(String.format("%02X", new Object[]{Integer.valueOf(i)}).getBytes(Charsets.US_ASCII));
            } else {
