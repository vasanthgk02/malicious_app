...
public final class CFFStandardEncoding extends CFFEncoding {
    public static final CFFStandardEncoding INSTANCE;
    ...
    static {
        ...
        INSTANCE.add(RotationOptions.ROTATE_180, 114);
        INSTANCE.add(181, 0);
        ...
        INSTANCE.add(BaseRequest.AddBuddy, 0);
        INSTANCE.add(202, 132);
        INSTANCE.add(BaseRequest.RemoveBuddy, 133);
        INSTANCE.add(BaseRequest.SetBuddyVariables, 0);
        INSTANCE.add(BaseRequest.GoOnline, 134);
        INSTANCE.add(206, 135);
        INSTANCE.add(207, 136);
        INSTANCE.add(208, 137);
        INSTANCE.add(209, 0);
        INSTANCE.add(210, 0);
        INSTANCE.add(FTPReply.SYSTEM_STATUS, 0);
        INSTANCE.add(FTPReply.DIRECTORY_STATUS, 0);
        INSTANCE.add(FTPReply.FILE_STATUS, 0);
        INSTANCE.add(FTPReply.HELP_MESSAGE, 0);
        INSTANCE.add(FTPReply.NAME_SYSTEM_TYPE, 0);
        INSTANCE.add(216, 0);
        INSTANCE.add(217, 0);
        INSTANCE.add(218, 0);
        INSTANCE.add(219, 0);
        INSTANCE.add(FTPReply.SERVICE_READY, 0);
        INSTANCE.add(FTPReply.SERVICE_CLOSING_CONTROL_CONNECTION, 0);
        INSTANCE.add(222, 0);
        INSTANCE.add(223, 0);
        INSTANCE.add(224, 0);
        INSTANCE.add(FTPReply.DATA_CONNECTION_OPEN, 138);
        INSTANCE.add(FTPReply.CLOSING_DATA_CONNECTION, 0);
        INSTANCE.add(FTPReply.ENTERING_PASSIVE_MODE, 139);
        INSTANCE.add(228, 0);
        INSTANCE.add(FTPReply.ENTERING_EPSV_MODE, 0);
        INSTANCE.add(FTPReply.USER_LOGGED_IN, 0);
        INSTANCE.add(231, 0);
        INSTANCE.add(232, 140);
        INSTANCE.add(233, 141);
        INSTANCE.add(FTPReply.SECURITY_DATA_EXCHANGE_COMPLETE, 142);
        INSTANCE.add(FTPReply.SECURITY_DATA_EXCHANGE_SUCCESSFULLY, 143);
        INSTANCE.add(236, 0);
        INSTANCE.add(237, 0);
        INSTANCE.add(238, 0);
        INSTANCE.add(239, 0);
        ...
        INSTANCE.add(253, 0);
        INSTANCE.add(254, 0);
        INSTANCE.add(InvitationReply.EXPIRED, 0);
    }
