...
public class X962NamedCurves {
    public static X9ECParametersHolder c2pnb163v1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0307AF69989546103D79329FCC3D74880F33BBE803CB")), bigInteger, valueOf, Hex.decode("D2C0FB15760860DEF1EEF4D696E6768756151754"));
    ...
    public static X9ECParametersHolder c2pnb163v2 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("030024266E4EB5106D0A964D92C4860E2671DB9B6CC5")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2pnb163v3 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0202F9F87B7C574D0BDECF8A22E6524775F98CDEBDCB")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2pnb176w1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("038D16C2866798B600F9F08BB4A8E860F3298CE04A5798")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2pnb208w1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0289FDFBE4ABE193DF9559ECF07AC0CE78554E2784EB8C1ED1A57A")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2pnb272w1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("026108BABB2CEEBCF787058A056CBE0CFE622D7723A289E08A07AE13EF0D10D171DD8D")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2pnb304w1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            F2m f2m = new F2m((int) BaseRequest.JoinRoomInvite, 1, 2, 11, new BigInteger("00FD0D693149A118F651E6DCE6802085377E5F882D1B510B44160074C1288078365A0396C8E681", 16), new BigInteger("00BDDB97E555A50A908E43B01C798EA5DAA6788F1EA2794EFCF57166B8C14039601E55827340BE", 16), bigInteger, valueOf);
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("02197B07845E9BE2D96ADB0F5F3C7F2CFFBD7A3EB8B6FEC35C7FD67F26DDF6285A644F740A2614")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2pnb368w1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("021085E2755381DCCCE3C1557AFA10C2F0C0C2825646C5B34A394CBCFA8BC16B22E7E789E927BE216F02E1FB136A5F")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2tnb191v1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            F2m f2m = new F2m(191, 9, new BigInteger("2866537B676752636A68F56554E12640276B649EF7526267", 16), new BigInteger("2E45EF571F00786F67B0081B9495A3D95462F5DE0AA185EC", 16), bigInteger, valueOf);
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0236B3DAF8A23206F9C4F299D7B21A9C369137F2C84AE1AA0D")), bigInteger, valueOf, Hex.decode("4E13CA542744D696E67687561517552F279A8C84"));
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2tnb191v2 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            F2m f2m = new F2m(191, 9, new BigInteger("401028774D7777C7B7666D1366EA432071274F89FF01E718", 16), new BigInteger("0620048D28BCBD03B6249C99182B7C8CD19700C362C46A01", 16), bigInteger, valueOf);
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("023809B2B7CC1B28CC5A87926AAD83FD28789E81E2C9E3BF10")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2tnb191v3 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            F2m f2m = new F2m(191, 9, new BigInteger("6C01074756099122221056911C77D77E77A777E7E7E77FCB", 16), new BigInteger("71FE1AF926CF847989EFEF8DB459F66394D90F32AD3F15E8", 16), bigInteger, valueOf);
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("03375D4CE24FDE434489DE8746E71786015009E66E38A926DD")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2tnb239v1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0257927098FA932E7C0A96D3FD5B706EF7E5F5C156E16B7E7C86038552E91D")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2tnb239v2 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0228F9D04E900069C8DC47A08534FE76D2B900B7D7EF31F5709F200C4CA205")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2tnb239v3 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0370F6E9D04D289C4E89913CE3530BFDE903977D42B146D539BF1BDE4E9C92")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2tnb359v1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("033C258EF3047767E7EDE0F1FDAA79DAEE3841366A132E163ACED4ED2401DF9C6BDCDE98E8E707C07A2239B1B097")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder c2tnb431r1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            F2m f2m = new F2m(FTPReply.UNAVAILABLE_RESOURCE, 120, new BigInteger("1A827EF00DD6FC0E234CAF046C6A5D8A85395B236CC4AD2CF32A0CADBDC9DDF620B0EB9906D0957F6C6FEACD615468DF104DE296CD8F", 16), new BigInteger("10D9B4A3D9047D8B154359ABFB1B7F5485B04CEB868237DDC9DEDA982A679A5A919B626D4E50A8DD731B107A9962381FB5D807BF2618", 16), bigInteger, valueOf);
            X9ECParameters x9ECParameters = new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("02120FC05D3C67A99DE161D2F4092622FECA701BE4F50F4758714E8A87BBF2A658EF8C21E7C5EFE965361F6C2999C0C247B0DBD70CE6B7")), bigInteger, valueOf, null);
            return x9ECParameters;
        }
    };
    ...
    public static X9ECParametersHolder prime192v1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(fp, new X9ECPoint(fp, Hex.decode("03188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012")), bigInteger, valueOf, Hex.decode("3045AE6FC8422f64ED579528D38120EAE12196D5"));
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder prime192v2 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(fp, new X9ECPoint(fp, Hex.decode("03eea2bae7e1497842f2de7769cfe9c989c072ad696f48034a")), bigInteger, valueOf, Hex.decode("31a92ee2029fd10d901b113e990710f0d21ac6b6"));
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder prime192v3 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(fp, new X9ECPoint(fp, Hex.decode("027d29778100c65a1da1783716588dce2b8b4aee8e228f1896")), bigInteger, valueOf, Hex.decode("c469684435deb378c4b65ca9591e2a5763059a2e"));
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder prime239v1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(fp, new X9ECPoint(fp, Hex.decode("020ffa963cdca8816ccc33b8642bedf905c3d358573d3f27fbbd3b3cb9aaaf")), bigInteger, valueOf, Hex.decode("e43bb460f0b80cc0c0b075798e948060f8321b7d"));
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder prime239v2 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(fp, new X9ECPoint(fp, Hex.decode("0238af09d98727705120c921bb5e9e26296a3cdcf2f35757a0eafd87b830e7")), bigInteger, valueOf, Hex.decode("e8b4011604095303ca3b8099982be09fcb9ae616"));
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder prime239v3 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(fp, new X9ECPoint(fp, Hex.decode("036768ae8e18bb92cfcf005c949aa2c6d94853d0e660bbf854b1c9505fe95a")), bigInteger, valueOf, Hex.decode("7d7374168ffe3471b60a857686a19475d3bfa2ff"));
            return x9ECParameters;
        }
    };
    public static X9ECParametersHolder prime256v1 = new X9ECParametersHolder() {
        public X9ECParameters createParameters() {
            ...
            X9ECParameters x9ECParameters = new X9ECParameters(fp, new X9ECPoint(fp, Hex.decode("036b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296")), bigInteger, valueOf, Hex.decode("c49d360886e704936a6678e1139d26b7819f7e90"));
            return x9ECParameters;
        }
    };
