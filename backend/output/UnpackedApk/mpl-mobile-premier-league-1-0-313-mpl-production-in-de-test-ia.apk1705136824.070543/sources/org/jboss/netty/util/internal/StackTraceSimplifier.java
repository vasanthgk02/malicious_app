...
public class StackTraceSimplifier {
    public static final Pattern EXCLUDED_STACK_TRACE = Pattern.compile("^org\\.jboss\\.netty\\.(util\\.(ThreadRenamingRunnable)|channel\\.(SimpleChannel(Upstream|Downstream)?Handler|(Default|Static)ChannelPipeline.*))$");
    public static final boolean SIMPLIFY_STACK_TRACE = (!DebugUtil.isDebugEnabled());
