...
public final class RtspResponseStatuses {
    ...
    public static final HttpResponseStatus CONFERENCE_NOT_FOUND = new HttpResponseStatus(FTPReply.INSUFFICIENT_STORAGE, "Conference Not Found");
    ...
    public static final HttpResponseStatus OPTION_NOT_SUPPORTED = new HttpResponseStatus(FTPReply.PAGE_TYPE_UNKNOWN, "Option not supported");
    public static final HttpResponseStatus PARAMETER_IS_READONLY = new HttpResponseStatus(458, "Parameter Is Read-Only");
    public static final HttpResponseStatus PARAMETER_NOT_UNDERSTOOD = new HttpResponseStatus(FTPReply.ACTION_ABORTED, "Parameter Not Understood");
    ...
    public static HttpResponseStatus valueOf(int i) {
        ...
        switch (i) {
            case FTPReply.ACTION_ABORTED /*451*/:
                return PARAMETER_NOT_UNDERSTOOD;
            case FTPReply.INSUFFICIENT_STORAGE /*452*/:
