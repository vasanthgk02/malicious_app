...
public class DefaultNameProvider implements NameProvider {
    public HashMap<Locale, Map<String, Map<String, Object>>> iByLocaleCache = createCache();
    public HashMap<Locale, Map<String, Map<Boolean, Object>>> iByLocaleCache2 = createCache();

    public final HashMap createCache() {
    ...
    /* JADX WARNING: type inference failed for: r2v1, types: [java.util.Map] */
    /* JADX WARNING: type inference failed for: r2v2, types: [java.util.Map] */
    /* JADX WARNING: type inference failed for: r2v3, types: [java.util.HashMap, java.lang.Object] */
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x00ce, code lost:
        return null;
     */
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r2v1, types: [java.util.Map]
      assigns: [java.util.Map, java.util.HashMap]
      uses: [?[int, boolean, OBJECT, ARRAY, byte, short, char], java.util.Map, java.lang.Object, java.util.HashMap]
      mth insns count: 91
    ...
    public final synchronized java.lang.String[] getNameSet(java.util.Locale r10, java.lang.String r11, java.lang.String r12) {
        /*
            r9 = this;
            monitor-enter(r9)
            r0 = 0
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized java.lang.String[] getNameSet(java.util.Locale r10, java.lang.String r11, java.lang.String r12, boolean r13) {
        /*
            r9 = this;
            monitor-enter(r9)
            r0 = 0
