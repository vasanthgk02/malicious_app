...
public final class Util {
    ...
    public static final void checkOffsetAndCount(long j, long j2, long j3) {
        if ((j2 | j3) < 0 || j2 > j || j - j2 < j3) {
            StringBuilder outline76 = GeneratedOutlineSupport.outline76("size=", j, " offset=");
            outline76.append(j2);
            outline76.append(" byteCount=");
            outline76.append(j3);
    ...
    public static final int reverseBytes(int i) {
        return ((i & InvitationReply.EXPIRED) << 24) | ((-16777216 & i) >>> 24) | ((16711680 & i) >>> 8) | ((65280 & i) << 8);
    }
