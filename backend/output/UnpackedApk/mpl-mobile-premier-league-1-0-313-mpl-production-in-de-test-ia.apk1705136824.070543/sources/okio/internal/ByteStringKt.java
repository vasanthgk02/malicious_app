...
public final class ByteStringKt {
    ...
    public static final int commonCompareTo(ByteString byteString, ByteString byteString2) {
        ...
        Intrinsics.checkNotNullParameter(byteString2, SMTNotificationConstants.NOTIF_ATTRIBUTION_OTHER);
    ...
    public static final ByteString commonSubstring(ByteString byteString, int i, int i2) {
        ...
        if (i >= 0) {
            if (i2 <= byteString.getData$okio().length) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline56(GeneratedOutlineSupport.outline73("endIndex > length("), byteString.getData$okio().length, ')').toString());
            }
        } else {
    ...
    public static final String commonToString(ByteString byteString) {
        String str;
        String str2;
        Intrinsics.checkNotNullParameter(byteString, "$this$commonToString");
        boolean z = true;
        ...
        if (access$codePointIndexToCharIndex == -1) {
            if (byteString.getData$okio().length <= 64) {
                StringBuilder outline73 = GeneratedOutlineSupport.outline73("[hex=");
                outline73.append(byteString.hex());
                outline73.append(']');
                str2 = outline73.toString();
            } else {
                StringBuilder outline732 = GeneratedOutlineSupport.outline73("[size=");
                outline732.append(byteString.getData$okio().length);
                ...
                if (z) {
                    if (64 != byteString.getData$okio().length) {
                        byteString = new ByteString(ArraysKt___ArraysJvmKt.copyOfRange(byteString.getData$okio(), 0, 64));
                    }
                    outline732.append(byteString.hex());
                    outline732.append("…]");
        ...
        if (utf8 != null) {
            ...
            if (access$codePointIndexToCharIndex < utf8.length()) {
                ...
                outline733.append(byteString.getData$okio().length);
                outline733.append(" text=");
                outline733.append(replace$default);
                outline733.append("…]");
                str = outline733.toString();
            } else {
