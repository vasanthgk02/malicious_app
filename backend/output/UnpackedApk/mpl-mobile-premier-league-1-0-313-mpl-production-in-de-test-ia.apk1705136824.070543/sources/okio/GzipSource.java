...
public final class GzipSource implements Source {
    ...
    private final void checkEqual(String str, int i, int i2) {
        if (i2 != i) {
            throw new IOException(GeneratedOutlineSupport.outline70(new Object[]{str, Integer.valueOf(i2), Integer.valueOf(i)}, 3, "%s: actual 0x%08x != expected 0x%08x", "java.lang.String.format(this, *args)"));
        }
    }
