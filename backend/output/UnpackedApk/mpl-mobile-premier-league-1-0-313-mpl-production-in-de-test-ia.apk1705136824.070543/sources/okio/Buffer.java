...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public static final class UnsafeCursor implements Closeable {
                ...
                if (i2 <= 0) {
                    if (j >= 0) {
                        ...
                        while (true) {
                            ...
                            long j3 = (long) (i3 - segment3.pos);
                            if (j3 > j2) {
                                segment3.limit = i3 - ((int) j2);
                                break;
                            }
        ...
        public final int seek(long j) {
            ...
            if (buffer2 == null) {
                ...
                setSegment$okio(segment3);
                this.offset = j2;
                Intrinsics.checkNotNull(segment3);
                this.data = segment3.data;
                int i4 = segment3.pos + ((int) (j2 - j3));
                this.start = i4;
    ...
    public final byte m1127deprecated_getByte(long j) {
        return getByte(j);
    }

    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m1128deprecated_size() {
        return this.size;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0055, code lost:
        r3 = com.android.tools.r8.GeneratedOutlineSupport.outline73("Number too large: ");
    ...
    public String readUtf8LineStrict(long j) throws EOFException {
        if (j >= 0) {
            ...
            outline73.append(Math.min(size(), j));
            outline73.append(" content=");
            outline73.append(buffer.readByteString().hex());
    ...
    public int write(ByteBuffer byteBuffer) throws IOException {
        Intrinsics.checkNotNullParameter(byteBuffer, DefaultSettingsSpiCall.SOURCE_PARAM);
                ...
                if (segment != null) {
                    if (size() - j < j) {
                        ...
                        while (j2 < size3) {
                            ...
                            i = (int) ((((long) segment.pos) + j) - j2);
                            while (i < min) {
                                if (bArr[i] != b2 || !BufferKt.rangeEquals(segment, i + 1, internalArray$okio, 1, size2)) {
                                    i++;
                                }
                            }
                            j2 += (long) (segment.limit - segment.pos);
                        ...
                        while (j2 < size5) {
                            ...
                            int i2 = (int) ((((long) segment.pos) + j) - j2);
                            while (i < min2) {
                                if (bArr2[i] != b3 || !BufferKt.rangeEquals(segment, i + 1, internalArray$okio2, 1, size4)) {
                                    i2 = i + 1;
                                }
                            }
                            j3 = j2 + ((long) (segment.limit - segment.pos));
