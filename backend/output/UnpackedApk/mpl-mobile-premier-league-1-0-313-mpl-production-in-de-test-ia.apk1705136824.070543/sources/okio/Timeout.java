...
public class Timeout {
    ...
    public final Timeout deadline(long j, TimeUnit timeUnit) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline45("duration <= 0: ", j).toString());
    }
    ...
    public final void intersectWith(Timeout timeout, Function0<Unit> function0) {
        Intrinsics.checkNotNullParameter(timeout, SMTNotificationConstants.NOTIF_ATTRIBUTION_OTHER);
    ...
    public Timeout timeout(long j, TimeUnit timeUnit) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline45("timeout < 0: ", j).toString());
    }
