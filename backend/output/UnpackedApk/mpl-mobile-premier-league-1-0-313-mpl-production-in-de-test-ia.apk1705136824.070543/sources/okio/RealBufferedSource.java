...
public final class RealBufferedSource implements BufferedSource {
    ...
    public long readHexadecimalUnsignedLong() {
        ...
        L_0x003a:
            ...
            r1.append(r3)
            r3 = 16
            kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt.checkRadix(r3)
            kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt.checkRadix(r3)
    ...
    public String toString() {
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("buffer(");
    ...
    public String readUtf8LineStrict(long j) {
        if (j >= 0) {
            ...
            outline73.append(Math.min(this.bufferField.size(), j));
    ...
    public long indexOf(byte b2, long j, long j2) {
        ...
        if (!this.closed) {
            ...
            StringBuilder outline76 = GeneratedOutlineSupport.outline76("fromIndex=", j, " toIndex=");
            outline76.append(j2);
            throw new IllegalArgumentException(outline76.toString().toString());
        }
        throw new IllegalStateException("closed".toString());
    }
