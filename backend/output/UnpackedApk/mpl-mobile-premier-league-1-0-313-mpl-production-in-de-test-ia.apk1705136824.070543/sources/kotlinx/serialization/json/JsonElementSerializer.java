...
public final class JsonElementSerializer implements KSerializer<JsonElement> {
    ...
    public static final SerialDescriptor descriptor = TypeUtilsKt.buildSerialDescriptor("kotlinx.serialization.json.JsonElement", SEALED.INSTANCE, new SerialDescriptor[0], JsonElementSerializer$descriptor$1.INSTANCE);

    public Object deserialize(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return TypeUtilsKt.asJsonDecoder(decoder).decodeJsonElement();
    }
