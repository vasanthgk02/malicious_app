...
public final class ReferenceArraySerializer<ElementKlass, Element extends ElementKlass> extends ListLikeSerializer<Element, Element[], ArrayList<Element>> {
    ...
    public Iterator collectionIterator(Object obj) {
        ...
        return TweetUtils.iterator(objArr);
    }
    ...
    public Object toResult(Object obj) {
        ArrayList arrayList = (ArrayList) obj;
        Intrinsics.checkNotNullParameter(arrayList, "<this>");
        KClass<ElementKlass> kClass2 = this.kClass;
        Intrinsics.checkNotNullParameter(arrayList, "<this>");
        Intrinsics.checkNotNullParameter(kClass2, "eClass");
        Object newInstance = Array.newInstance(TweetUtils.getJavaClass(kClass2), arrayList.size());
        if (newInstance != null) {
