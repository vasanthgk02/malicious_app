...
public final class UShortSerializer implements KSerializer<UShort> {
    ...
    public static final SerialDescriptor descriptor = TypeUtilsKt.InlinePrimitiveDescriptor("kotlin.UShort", TypeUtilsKt.serializer(ShortCompanionObject.INSTANCE));
