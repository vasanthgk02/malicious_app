...
public final class SerialDescriptorForNullable implements SerialDescriptor, CachedNames {
    ...
    public final Set<String> serialNames = Platform_commonKt.cachedSerialNames(this.original);
    ...
    public SerialDescriptorForNullable(SerialDescriptor serialDescriptor) {
        ...
        this.serialName = Intrinsics.stringPlus(serialDescriptor.getSerialName(), ColorPropConverter.PREFIX_ATTR);
    }
