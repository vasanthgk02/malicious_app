...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public static final SerialDescriptor descriptor = TypeUtilsKt.InlinePrimitiveDescriptor("kotlin.ULong", TypeUtilsKt.serializer(LongCompanionObject.INSTANCE));
