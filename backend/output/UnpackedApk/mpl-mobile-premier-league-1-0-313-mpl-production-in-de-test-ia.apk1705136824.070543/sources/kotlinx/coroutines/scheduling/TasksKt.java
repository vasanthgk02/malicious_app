...
public final class TasksKt {
    ...
    public static final long IDLE_WORKER_KEEP_ALIVE_NS = TimeUnit.SECONDS.toNanos(TypeUtilsKt.systemProp$default((String) "kotlinx.coroutines.scheduler.keep.alive.sec", 60, 0, 0, 12, (Object) null));
    public static final int MAX_POOL_SIZE = TypeUtilsKt.systemProp$default((String) "kotlinx.coroutines.scheduler.max.pool.size", 2097150, 0, 2097150, 4, (Object) null);
    public static final TaskContext NonBlockingContext = new TaskContextImpl(0);
    public static final long WORK_STEALING_TIME_RESOLUTION_NS = TypeUtilsKt.systemProp$default((String) "kotlinx.coroutines.scheduler.resolution.ns", 100000, 0, 0, 12, (Object) null);
    public static SchedulerTimeSource schedulerTimeSource = NanoTimeSource.INSTANCE;

    static {
        int i = SystemPropsKt__SystemPropsKt.AVAILABLE_PROCESSORS;
        CORE_POOL_SIZE = TypeUtilsKt.systemProp$default((String) "kotlinx.coroutines.scheduler.core.pool.size", i < 2 ? 2 : i, 1, 0, 8, (Object) null);
    }
}
