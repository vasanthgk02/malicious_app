        ...
        if (cancellableContinuationImpl.isReusable()) {
            ...
            while (true) {
                ...
                if (Intrinsics.areEqual(obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                    if (DispatchedContinuation._reusableCancellableContinuation$FU.compareAndSet(dispatchedContinuation, DispatchedContinuationKt.REUSABLE_CLAIMED, continuationCancellationCause)) {
                        break;
                    }
