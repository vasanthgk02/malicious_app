...
public class ScopeCoroutine<T> extends AbstractCoroutine<T> implements CoroutineStackFrame {
    ...
    public void afterCompletion(Object obj) {
        DispatchedContinuationKt.resumeCancellableWith$default(TweetUtils.intercepted(this.uCont), TypeUtilsKt.recoverResult(obj, this.uCont), null, 2);
    }

    public void afterResume(Object obj) {
        Continuation<T> continuation = this.uCont;
        continuation.resumeWith(TypeUtilsKt.recoverResult(obj, continuation));
    }
