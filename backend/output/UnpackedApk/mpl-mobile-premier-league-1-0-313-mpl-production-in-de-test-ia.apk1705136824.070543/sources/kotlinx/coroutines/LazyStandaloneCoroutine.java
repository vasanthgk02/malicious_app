...
public final class LazyStandaloneCoroutine extends StandaloneCoroutine {
    ...
    public LazyStandaloneCoroutine(CoroutineContext coroutineContext, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        this.continuation = TweetUtils.createCoroutineUnintercepted(function2, this, this);
    }

    public void onStart() {
        try {
            DispatchedContinuationKt.resumeCancellableWith$default(TweetUtils.intercepted(this.continuation), Unit.INSTANCE, null, 2);
        } catch (Throwable th) {
            TypeUtilsKt.dispatcherFailure(this, th);
            throw null;
        }
    }
}
