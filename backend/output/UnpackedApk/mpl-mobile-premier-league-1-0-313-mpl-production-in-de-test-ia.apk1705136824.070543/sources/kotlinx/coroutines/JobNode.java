...
public abstract class JobNode extends CompletionHandlerBase implements DisposableHandle, Incomplete {
    ...
    public void dispose() {
        ...
        JobSupport job2 = getJob();
        do {
            state$kotlinx_coroutines_core = job2.getState$kotlinx_coroutines_core();
        ...
        } while (!JobSupport._state$FU.compareAndSet(job2, state$kotlinx_coroutines_core, JobSupportKt.EMPTY_ACTIVE));
    }
