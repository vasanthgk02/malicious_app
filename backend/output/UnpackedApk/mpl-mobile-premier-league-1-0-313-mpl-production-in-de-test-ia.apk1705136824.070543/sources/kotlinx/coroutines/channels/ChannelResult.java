...
public final class ChannelResult<T> {
    ...
    public static final class Closed extends Failed {
        ...
        public String toString() {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("Closed(");
            outline73.append(this.cause);
            outline73.append(')');
    ...
    public static class Failed {
        public String toString() {
            return Constants.DOWNLOAD_STATUS_FAILED;
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof ChannelResult) && Intrinsics.areEqual(obj2, ((ChannelResult) obj).holder)) {
            return true;
        }
        return false;
    }
