...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public static final class Itr<E> implements ChannelIterator<E> {
        ...
        public Object hasNext(Continuation<? super Boolean> continuation) {
            ...
            CancellableContinuationImpl orCreateCancellableContinuation = TypeUtilsKt.getOrCreateCancellableContinuation(TweetUtils.intercepted(continuation));
                ...
                if (this.channel.enqueueReceiveInternal(receiveHasNext)) {
                    ...
                    if (pollInternal2 instanceof Closed) {
                        ...
                        if (closed.closeCause == null) {
                            ...
                            orCreateCancellableContinuation.resumeWith(TweetUtils.createFailure(closed.getReceiveException()));
                        }
                    } else if (pollInternal2 != AbstractChannelKt.POLL_FAILED) {
                        Boolean bool = Boolean.TRUE;
                        Function1<E, Unit> function12 = this.channel.onUndeliveredElement;
                        if (function12 != null) {
                            function1 = new OnUndeliveredElementKt$bindCancellationFun$1(function12, pollInternal2, orCreateCancellableContinuation.getContext());
                        }
        ...
        public E next() {
            ...
            if (!(e2 instanceof Closed)) {
                E e3 = AbstractChannelKt.POLL_FAILED;
                if (e2 != e3) {
                    this.result = e3;
                    return e2;
                }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                this.cont.resumeWith(new ChannelResult(new Closed(closed.closeCause)));
            } else {
                this.cont.resumeWith(TweetUtils.createFailure(closed.getReceiveException()));
            }
        }

        public String toString() {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("ReceiveElement@");
            outline73.append(DebugStringsKt.getHexAddress(this));
            outline73.append("[receiveMode=");
            return GeneratedOutlineSupport.outline56(outline73, this.receiveMode, ']');
        }

        public Symbol tryResumeReceive(E e2, PrepareOp prepareOp) {
            if (this.cont.tryResume(this.receiveMode == 1 ? new ChannelResult(e2) : e2, null, resumeOnCancellationFun(e2)) == null) {
                return null;
            }
    ...
    public static final class ReceiveElementWithUndeliveredHandler<E> extends ReceiveElement<E> {
        ...
        public Function1<Throwable, Unit> resumeOnCancellationFun(E e2) {
            return new OnUndeliveredElementKt$bindCancellationFun$1(this.onUndeliveredElement, e2, this.cont.getContext());
        }
    }
    ...
    public static class ReceiveHasNext<E> extends Receive<E> {
        ...
        public Function1<Throwable, Unit> resumeOnCancellationFun(E e2) {
            ...
            if (function1 != null) {
                return new OnUndeliveredElementKt$bindCancellationFun$1(function1, e2, this.cont.getContext());
            }
            return null;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            Object obj;
            if (closed.closeCause == null) {
                obj = this.cont.tryResume(Boolean.FALSE, null);
            } else {
        ...
        public String toString() {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("ReceiveHasNext@");
            outline73.append(DebugStringsKt.getHexAddress(this));
            return outline73.toString();
        }

        public Symbol tryResumeReceive(E e2, PrepareOp prepareOp) {
            if (this.cont.tryResume(Boolean.TRUE, null, resumeOnCancellationFun(e2)) == null) {
                return null;
            }
            return CancellableContinuationImplKt.RESUME_TOKEN;
        }
    ...
    public final class RemoveReceiveOnCancel extends BeforeResumeCancelHandler {
        ...
        public String toString() {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("RemoveReceiveOnCancel[");
            outline73.append(this.receive);
            outline73.append(']');
            return outline73.toString();
        }
    ...
    public boolean enqueueReceiveInternal(Receive<? super E> receive) {
        ...
        do {
            ...
            tryCondAddNext = prevNode2.tryCondAddNext(receive, lockFreeLinkedListHead2, abstractChannel$enqueueReceiveInternal$$inlined$addLastIfPrevAndIf$1);
            if (tryCondAddNext == 1) {
                return true;
            }
    ...
    public final Object receive(Continuation<? super E> continuation) {
        ...
        if (this.onUndeliveredElement == null) {
            receiveElement = new ReceiveElement(orCreateCancellableContinuation, 0);
        } else {
            receiveElement = new ReceiveElementWithUndeliveredHandler(orCreateCancellableContinuation, 0, this.onUndeliveredElement);
        }
        while (true) {
            ...
            if (pollInternal2 instanceof Closed) {
                ...
                orCreateCancellableContinuation.resume(receiveElement.receiveMode == 1 ? new ChannelResult(pollInternal2) : pollInternal2, receiveElement.resumeOnCancellationFun(pollInternal2));
            }
        }
    ...
    public final Object m986tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        if (pollInternal == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.failed;
        }
        return pollInternal instanceof Closed ? new Closed(((Closed) pollInternal).closeCause) : pollInternal;
    }
}
