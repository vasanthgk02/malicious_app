...
public class DatabaseConfiguration {
    ...
    public final PrepackagedDatabaseCallback prepackagedDatabaseCallback = null;
    ...
    public DatabaseConfiguration(Context context2, String str, Factory factory, MigrationContainer migrationContainer2, List list, boolean z, JournalMode journalMode2, Executor executor, Executor executor2, Intent intent, boolean z2, boolean z3, Set set, String str2, File file, Callable callable, List list2, List list3) {
    ...
    public boolean isMigrationRequired(int r3, int r4) {
        ...
        L_0x000e:
            ...
            java.util.Set<java.lang.Integer> r4 = r2.migrationNotRequiredFrom
