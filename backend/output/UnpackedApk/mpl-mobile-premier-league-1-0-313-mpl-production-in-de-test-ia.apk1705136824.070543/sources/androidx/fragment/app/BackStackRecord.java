...
public final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
        ...
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (fragment != null) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        StringBuilder outline73 = GeneratedOutlineSupport.outline73("Bump nesting of ");
                        outline73.append(op.mFragment);
                        outline73.append(" to ");
                        outline73.append(op.mFragment.mBackStackNesting);
                        outline73.toString();
                    }
                }
            }
    ...
    public FragmentTransaction detach(Fragment fragment) {
        ...
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("Cannot detach Fragment attached to a different FragmentManager. Fragment ");
        outline73.append(fragment.toString());
        outline73.append(" is already attached to a FragmentManager.");
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (op.mCmd) {
                ...
                case 10:
                    ...
                    break;
                default:
                    StringBuilder outline73 = GeneratedOutlineSupport.outline73("Unknown cmd: ");
                    outline73.append(op.mCmd);
    ...
    public FragmentTransaction hide(Fragment fragment) {
        ...
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("Cannot hide Fragment attached to a different FragmentManager. Fragment ");
        outline73.append(fragment.toString());
        outline73.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(outline73.toString());
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        ...
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("Cannot remove Fragment attached to a different FragmentManager. Fragment ");
        outline73.append(fragment.toString());
        outline73.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(outline73.toString());
    }
    ...
    public FragmentTransaction setMaxLifecycle(Fragment fragment, State state) {
        if (fragment.mFragmentManager != this.mManager) {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("Cannot setMaxLifecycle for Fragment not attached to FragmentManager ");
            outline73.append(this.mManager);
            throw new IllegalArgumentException(outline73.toString());
        } else if (state == State.INITIALIZED && fragment.mState > -1) {
    ...
    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        if (fragment != null) {
            FragmentManager fragmentManager = fragment.mFragmentManager;
            if (!(fragmentManager == null || fragmentManager == this.mManager)) {
                StringBuilder outline73 = GeneratedOutlineSupport.outline73("Cannot setPrimaryNavigation for Fragment attached to a different FragmentManager. Fragment ");
                outline73.append(fragment.toString());
                outline73.append(" is already attached to a FragmentManager.");
                throw new IllegalStateException(outline73.toString());
            }
    ...
    public FragmentTransaction show(Fragment fragment) {
        ...
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("Cannot show Fragment attached to a different FragmentManager. Fragment ");
        outline73.append(fragment.toString());
        outline73.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(outline73.toString());
    }
            ...
            for (int i = 0; i < size; i++) {
                ...
                switch (op.mCmd) {
                    ...
                    case 10:
                        ...
                        break;
                    default:
                        StringBuilder outline73 = GeneratedOutlineSupport.outline73("cmd=");
                        outline73.append(op.mCmd);
