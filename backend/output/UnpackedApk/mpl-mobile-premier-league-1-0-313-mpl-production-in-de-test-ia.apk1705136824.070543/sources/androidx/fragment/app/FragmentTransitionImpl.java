        ...
        OneShotPreDrawListener.add(viewGroup, new Runnable() {
            public void run() {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    view.setTransitionName((String) map.get(ViewCompat.getTransitionName(view)));
                }
            }
        });
    }
        ...
        OneShotPreDrawListener.add(view, new Runnable() {
            public void run() {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    String transitionName = ViewCompat.getTransitionName(view);
                    if (transitionName != null) {
                        view.setTransitionName(FragmentTransitionImpl.findKeyForValue(map, transitionName));
                    }
                }
            }
        });
