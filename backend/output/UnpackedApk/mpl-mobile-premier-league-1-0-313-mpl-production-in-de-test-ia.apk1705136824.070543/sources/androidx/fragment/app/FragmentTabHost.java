...
public class FragmentTabHost extends TabHost implements OnTabChangeListener {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("FragmentTabHost.SavedState{");
            outline73.append(Integer.toHexString(System.identityHashCode(this)));
            outline73.append(" curTab=");
            return GeneratedOutlineSupport.outline62(outline73, this.curTab, "}");
        }
    ...
    private void ensureContent() {
        if (this.mRealTabContent == null) {
            ...
            if (frameLayout == null) {
                StringBuilder outline73 = GeneratedOutlineSupport.outline73("No tab content FrameLayout found for id ");
                outline73.append(this.mContainerId);
