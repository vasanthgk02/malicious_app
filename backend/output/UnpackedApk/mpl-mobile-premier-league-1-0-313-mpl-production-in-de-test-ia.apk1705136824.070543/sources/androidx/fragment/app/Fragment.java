...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(final ActivityResultContract<I, O> activityResultContract, Function<Void, ActivityResultRegistry> function, ActivityResultCallback<O> activityResultCallback) {
        if (this.mState <= 1) {
            ...
            AnonymousClass8 r2 = new OnPreAttachedListener() {
            ...
            registerOnPreAttachListener(r2);
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline47("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
    }
    ...
    public FragmentContainer createFragmentContainer() {
        return new FragmentContainer() {
            public View onFindViewById(int i) {
                ...
                StringBuilder outline73 = GeneratedOutlineSupport.outline73("Fragment ");
                outline73.append(Fragment.this);
                outline73.append(" does not have a view");
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        this.mChildFragmentManager.dump(GeneratedOutlineSupport.outline50(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public String generateActivityResultKey() {
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("fragment_");
        outline73.append(this.mWho);
        outline73.append("_rq#");
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline47("Fragment ", this, " has not been attached yet."));
    }
        ...
        if (this.mFragmentManager != null) {
            if (this.mDefaultFactory == null) {
                ...
                if (application == null && FragmentManager.isLoggingEnabled(3)) {
                    StringBuilder outline73 = GeneratedOutlineSupport.outline73("Could not find Application instance from Context ");
                    outline73.append(requireContext().getApplicationContext());
                    outline73.append(", you will not be able to use AndroidViewModel with the default ViewModelProvider.Factory");
                    outline73.toString();
                }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline47("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onActivityCreated()"));
    }
    ...
    public void performAttach() {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onAttach()"));
    }
    ...
    public void performCreate(Bundle bundle) {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onCreate()"));
    }
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }

    public void performDestroyView() {
        this.mChildFragmentManager.dispatchDestroyView();
        if (this.mView != null && ((LifecycleRegistry) this.mViewLifecycleOwner.getLifecycle()).mState.isAtLeast(State.CREATED)) {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onDestroyView()"));
    }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onDetach()"));
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onResume()"));
    }
    ...
    public void performStart() {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onStart()"));
    }
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(String[] strArr, int i) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline47("Fragment ", this, " not attached to Activity"));
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline47("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline47("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline47("Fragment ", this, " not attached to a context."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline47("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(GeneratedOutlineSupport.outline47("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(GeneratedOutlineSupport.outline47("Fragment ", this, " did not call through to super.onViewStateRestored()"));
    ...
    public void setTargetFragment(Fragment fragment, int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline47("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
    }
