...
public abstract class FragmentTransaction {
    ...
    public static final class Op {
        ...
        public Op(int i, Fragment fragment, State state) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        if (FragmentTransition.supportsTransition()) {
            ...
            if (transitionName != null) {
                if (this.mSharedElementSourceNames == null) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport.outline52("A shared element with the target name '", str, "' has already been added to the transaction."));
                } else if (this.mSharedElementSourceNames.contains(transitionName)) {
                    throw new IllegalArgumentException(GeneratedOutlineSupport.outline52("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
    ...
    public void doAddOp(int i, Fragment fragment, String str, int i2) {
        ...
        if (cls.isAnonymousClass() || !Modifier.isPublic(modifiers) || (cls.isMemberClass() && !Modifier.isStatic(modifiers))) {
            ...
            outline73.append(" must be a public static class to be  properly recreated from instance state.");
        ...
        if (str != null) {
            ...
            if (str2 == null || str.equals(str2)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                throw new IllegalStateException(GeneratedOutlineSupport.outline63(sb, fragment.mTag, " now ", str));
            }
        }
        if (i != 0) {
            if (i != -1) {
