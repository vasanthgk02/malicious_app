...
public class ArrayLinkedVariables implements ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f2, boolean z) {
        if (f2 <= -0.001f || f2 >= 0.001f) {
            ...
            while (i != -1 && i3 < this.currentSize) {
                ...
                if (i5 == i6) {
                    float f3 = this.mArrayValues[i] + f2;
    ...
    public String toString() {
        ...
        int i2 = 0;
        while (i != -1 && i2 < this.currentSize) {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73(GeneratedOutlineSupport.outline50(str, " -> "));
            outline73.append(this.mArrayValues[i]);
            outline73.append(" : ");
            StringBuilder outline732 = GeneratedOutlineSupport.outline73(outline73.toString());
            outline732.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
    ...
    public float use(ArrayRow arrayRow, boolean z) {
        ...
        ArrayRowVariables arrayRowVariables = arrayRow.variables;
