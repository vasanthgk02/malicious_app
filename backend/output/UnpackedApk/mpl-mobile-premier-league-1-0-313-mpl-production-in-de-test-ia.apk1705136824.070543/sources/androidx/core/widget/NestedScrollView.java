...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("HorizontalScrollView.SavedState{");
            outline73.append(Integer.toHexString(System.identityHashCode(this)));
            outline73.append(" scrollPosition=");
            return GeneratedOutlineSupport.outline57(outline73, this.scrollPosition, "}");
        }
    ...
    public boolean fullScroll(int i) {
        ...
        if (z) {
            ...
            if (childCount > 0) {
                ...
                this.mTempRect.bottom = getPaddingBottom() + childAt.getBottom() + ((LayoutParams) childAt.getLayoutParams()).bottomMargin;
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent r12) {
        ...
        L_0x008b:
            androidx.core.view.NestedScrollingChildHelper r12 = r11.mChildHelper
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(FrameLayout.getChildMeasureSpec(i, getPaddingRight() + getPaddingLeft() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), MeasureSpec.makeMeasureSpec(measuredHeight2, 1073741824));
            }
        }
    }
            ...
            if (actionMasked == 1) {
                ...
                if (findPointerIndex != -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        int i5 = scrollRange;
                        if (overScrollByCompat(0, i4, 0, getScrollY(), 0, scrollRange, 0, 0) && !hasNestedScrollingParent(0)) {
                            this.mVelocityTracker.clear();
                        }
                        int scrollY2 = getScrollY() - scrollY;
                        int[] iArr = this.mScrollConsumed;
                        iArr[1] = 0;
                        this.mChildHelper.dispatchNestedScrollInternal(0, scrollY2, 0, i4 - scrollY2, this.mScrollOffset, 0, iArr);
                        ...
                        if (z) {
                            ...
                            int i8 = scrollY + i7;
                            if (i8 < 0) {
                                this.mEdgeGlowTop.onPull(((float) i7) / ((float) getHeight()), motionEvent2.getX(findPointerIndex) / ((float) getWidth()));
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (i8 > i5) {
                                this.mEdgeGlowBottom.onPull(((float) i7) / ((float) getHeight()), 1.0f - (motionEvent2.getX(findPointerIndex) / ((float) getWidth())));
                                if (!this.mEdgeGlowTop.isFinished()) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean scrollAndFocus(int r18, int r19, int r20) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
