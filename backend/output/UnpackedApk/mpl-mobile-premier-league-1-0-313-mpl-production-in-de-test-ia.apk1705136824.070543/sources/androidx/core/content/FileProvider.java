...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public File getFileForUri(Uri uri) {
            ...
            if (file != null) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline46("Unable to find configured root for ", uri));
            }
        }
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                Entry entry = null;
                for (Entry next : this.mRoots.entrySet()) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline50("Failed to find configured root that contains ", canonicalPath));
            } catch (IOException unused) {
    ...
    public static PathStrategy parsePathStrategy(Context context, String str) throws IOException, XmlPullParserException {
        ...
        if (resolveContentProvider != null) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline50("Couldn't find meta-data for provider with authority ", str));
        }
    }
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        ...
        if ("r".equals(str)) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline50("Invalid mode: ", str));
        }
