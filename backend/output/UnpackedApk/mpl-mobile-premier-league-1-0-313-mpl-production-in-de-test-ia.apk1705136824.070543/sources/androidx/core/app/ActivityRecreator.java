...
public final class ActivityRecreator {
    ...
    public static final class LifecycleCheckCallbacks implements ActivityLifecycleCallbacks {
        ...
        if (VERSION.SDK_INT >= 28) {
            ...
            try {
                ...
                if (needsRelaunchCall()) {
                    requestRelaunchActivityMethod.invoke(obj2, new Object[]{obj, null, null, Integer.valueOf(0), Boolean.FALSE, null, null, Boolean.FALSE, Boolean.FALSE});
                } else {
                    activity.recreate();
                }
                mainHandler.post(new Runnable() {
