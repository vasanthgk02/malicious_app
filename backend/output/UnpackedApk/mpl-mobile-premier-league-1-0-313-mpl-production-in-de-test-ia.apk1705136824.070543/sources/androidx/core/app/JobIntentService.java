...
public abstract class JobIntentService extends Service {
    ...
    public static final class CompatWorkEnqueuer extends WorkEnqueuer {
        ...
        public CompatWorkEnqueuer(Context context, ComponentName componentName) {
            ...
            WakeLock newWakeLock = powerManager.newWakeLock(1, componentName.getClassName() + ":launch");
            this.mLaunchWakeLock = newWakeLock;
            newWakeLock.setReferenceCounted(false);
            WakeLock newWakeLock2 = powerManager.newWakeLock(1, componentName.getClassName() + ":run");
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i) {
            if (!this.mHasJobId) {
                ...
                StringBuilder outline74 = GeneratedOutlineSupport.outline74("Given job ID ", i, " is different than previous ");
                outline74.append(this.mJobId);
