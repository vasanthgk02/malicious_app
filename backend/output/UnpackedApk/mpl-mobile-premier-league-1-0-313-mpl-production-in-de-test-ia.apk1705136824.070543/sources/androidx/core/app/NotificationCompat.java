...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public static Builder fromAndroidAction(android.app.Notification.Action action) {
                Builder builder;
                if (VERSION.SDK_INT < 23 || action.getIcon() == null) {
    ...
    public static class BigPictureStyle extends Style {
        ...
        public static class Api16Impl {
            public static void setBigLargeIcon(android.app.Notification.BigPictureStyle bigPictureStyle, Bitmap bitmap) {
                bigPictureStyle.bigLargeIcon(bitmap);
            }

            public static void setSummaryText(android.app.Notification.BigPictureStyle bigPictureStyle, CharSequence charSequence) {
                bigPictureStyle.setSummaryText(charSequence);
            }
        }

        public static class Api23Impl {
            public static void setBigLargeIcon(android.app.Notification.BigPictureStyle bigPictureStyle, Icon icon) {
        ...
        public static IconCompat asIconCompat(Parcelable parcelable) {
            if (parcelable != null) {
                if (VERSION.SDK_INT >= 23 && (parcelable instanceof Icon)) {
        ...
        /* JADX WARNING: type inference failed for: r2v6, types: [android.graphics.Bitmap] */
        /* JADX WARNING: type inference failed for: r2v8, types: [android.graphics.Bitmap] */
        /* JADX WARNING: type inference failed for: r2v9, types: [android.content.Context] */
        /* JADX WARNING: type inference failed for: r2v10, types: [android.content.Context] */
        ...
        /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r2v0
          assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY], android.content.Context, android.graphics.Bitmap]
          uses: [android.graphics.Bitmap, android.content.Context]
          mth insns count: 60
        ...
        public void apply(androidx.core.app.NotificationBuilderWithBuilderAccessor r7) {
            /*
                ...
                android.graphics.Bitmap r1 = r6.mPicture
                android.app.Notification$BigPictureStyle r0 = r0.bigPicture(r1)
                boolean r1 = r6.mBigLargeIconSet
                if (r1 == 0) goto L_0x008b
                androidx.core.graphics.drawable.IconCompat r1 = r6.mBigLargeIcon
                r2 = 0
            ...
            L_0x0022:
                ...
                boolean r1 = r7 instanceof androidx.core.app.NotificationCompatBuilder
                if (r1 == 0) goto L_0x0032
                androidx.core.app.NotificationCompatBuilder r7 = (androidx.core.app.NotificationCompatBuilder) r7
                android.content.Context r2 = r7.getContext()
            L_0x0032:
                androidx.core.graphics.drawable.IconCompat r7 = r6.mBigLargeIcon
                android.graphics.drawable.Icon r7 = r7.toIcon(r2)
                androidx.core.app.NotificationCompat.BigPictureStyle.Api23Impl.setBigLargeIcon(r0, r7)
                goto L_0x008b
            L_0x003c:
                int r7 = r1.getType()
                r1 = 1
                ...
                boolean r1 = r7 instanceof android.graphics.Bitmap
            ...
            L_0x0062:
                ...
                android.graphics.Bitmap r2 = androidx.core.graphics.drawable.IconCompat.createLegacyIconFromAdaptiveIcon(r7, r1)
            L_0x006d:
                androidx.core.app.NotificationCompat.BigPictureStyle.Api16Impl.setBigLargeIcon(r0, r2)
                goto L_0x008b
            L_0x0071:
            ...
            L_0x0088:
                androidx.core.app.NotificationCompat.BigPictureStyle.Api16Impl.setBigLargeIcon(r0, r2)
            L_0x008b:
                boolean r7 = r6.mSummaryTextSet
                if (r7 == 0) goto L_0x0094
                java.lang.CharSequence r7 = r6.mSummaryText
                androidx.core.app.NotificationCompat.BigPictureStyle.Api16Impl.setSummaryText(r0, r7)
            L_0x0094:
                return
            */
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (!(actionArr == null || actionArr.length == 0)) {
                for (android.app.Notification.Action fromAndroidAction : actionArr) {
                    addAction(Builder.fromAndroidAction(fromAndroidAction).build());
                }
            }
            ...
            if (VERSION.SDK_INT >= 24 && bundle.containsKey(NotificationCompat.EXTRA_CHRONOMETER_COUNT_DOWN)) {
                setChronometerCountDown(bundle.getBoolean(NotificationCompat.EXTRA_CHRONOMETER_COUNT_DOWN));
            }
            if (VERSION.SDK_INT >= 26 && bundle.containsKey(NotificationCompat.EXTRA_COLORIZED)) {
    ...
    public static final class CarExtender implements Extender {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static androidx.core.app.NotificationCompat.CarExtender.UnreadConversation getUnreadConversationFromBundle(android.os.Bundle r21) {
            /*
                r0 = r21
                r1 = 0
    ...
    public static class MessagingStyle extends Style {
        ...
        public static final class Message {
                    ...
                    if (bundle.containsKey("text")) {
                        if (bundle.containsKey("time")) {
                            if (bundle.containsKey(KEY_PERSON)) {
                                ...
                                person = bundle.containsKey("sender") ? new androidx.core.app.Person.Builder().setName(bundle.getCharSequence("sender")).build() : null;
                            } else {
            ...
            /* JADX WARNING: type inference failed for: r2v4, types: [android.app.Person] */
            /* JADX WARNING: type inference failed for: r2v5, types: [android.app.Person] */
            /* JADX WARNING: type inference failed for: r2v6 */
            /* JADX WARNING: type inference failed for: r2v7 */
            /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r2v0
              assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY], android.app.Person, java.lang.CharSequence]
              uses: [java.lang.CharSequence, android.app.Person]
              mth insns count: 24
            	at jadx.core.dex.visitors.typeinference.TypeSearch.fillTypeCandidates(TypeSearch.java:237)
            	at java.base/java.util.ArrayList.forEach(ArrayList.java:1511)
            	at jadx.core.dex.visitors.typeinference.TypeSearch.run(TypeSearch.java:53)
        ...
        private Message findLatestIncomingMessage() {
            ...
            while (true) {
                ...
                if (size >= 0) {
                    ...
                    return (Message) GeneratedOutlineSupport.outline29(this.mMessages, -1);
                } else {
                    return null;
                }
            }
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r12, int r13, boolean r14) {
            ...
            L_0x013d:
                ...
                int r0 = androidx.core.R$id.chronometer
                r7.setChronometerCountDown(r0, r14)
                goto L_0x0198
            L_0x0184:
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:41:0x011c, code lost:
            if (r11.mTintList != null) goto L_0x0124;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:43:0x0122, code lost:
            if (r11.mTintMode == androidx.core.graphics.drawable.IconCompat.DEFAULT_TINT_MODE) goto L_0x0131;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:44:0x0124, code lost:
            r1.mutate();
            r1.setTintList(r11.mTintList);
            r1.setTintMode(r11.mTintMode);
         */
        ...
        private android.graphics.Bitmap createColoredBitmap(androidx.core.graphics.drawable.IconCompat r11, int r12, int r13) {
            ...
            L_0x001a:
                ...
                goto L_0x0050
            L_0x003e:
                java.lang.String r5 = r11.getResPackage()
                android.content.res.Resources r5 = androidx.core.graphics.drawable.IconCompat.getResources(r0, r5)
            ...
            L_0x0050:
                ...
                android.graphics.drawable.Icon r11 = r11.toIcon(r0)
            ...
            L_0x0066:
                goto L_0x0117
            L_0x0068:
                java.io.InputStream r1 = r11.getUriInputStream(r0)
            ...
            L_0x0087:
                ...
                android.content.res.Resources r0 = r0.getResources()
                android.graphics.Bitmap r1 = android.graphics.BitmapFactory.decodeStream(r1)
                android.graphics.Bitmap r1 = androidx.core.graphics.drawable.IconCompat.createLegacyIconFromAdaptiveIcon(r1, r4)
                r2.<init>(r0, r1)
                goto L_0x00bf
            L_0x0099:
                android.graphics.drawable.BitmapDrawable r1 = new android.graphics.drawable.BitmapDrawable
                android.content.res.Resources r0 = r0.getResources()
                java.lang.Object r2 = r11.mObj1
                android.graphics.Bitmap r2 = (android.graphics.Bitmap) r2
                android.graphics.Bitmap r2 = androidx.core.graphics.drawable.IconCompat.createLegacyIconFromAdaptiveIcon(r2, r4)
                r1.<init>(r0, r2)
                goto L_0x0118
            L_0x00ac:
                java.io.InputStream r1 = r11.getUriInputStream(r0)
            ...
            L_0x00e5:
                android.content.res.Resources r1 = androidx.core.graphics.drawable.IconCompat.getResources(r0, r1)
                int r6 = r11.mInt1     // Catch:{ RuntimeException -> 0x00f5 }
                android.content.res.Resources$Theme r0 = r0.getTheme()     // Catch:{ RuntimeException -> 0x00f5 }
                android.graphics.drawable.Drawable r0 = androidx.core.content.res.ResourcesCompat.getDrawable(r1, r6, r0)     // Catch:{ RuntimeException -> 0x00f5 }
                r1 = r0
                goto L_0x0118
            L_0x00f5:
            ...
            L_0x0118:
                ...
                android.content.res.ColorStateList r0 = r11.mTintList
                if (r0 != 0) goto L_0x0124
                android.graphics.PorterDuff$Mode r0 = r11.mTintMode
            ...
            L_0x0124:
                ...
                android.content.res.ColorStateList r0 = r11.mTintList
                r1.setTintList(r0)
                android.graphics.PorterDuff$Mode r11 = r11.mTintMode
                r1.setTintMode(r11)
            L_0x0131:
                r11 = r1
            L_0x0132:
    ...
    public static final class WearableExtender implements Extender {
        ...
        public static android.app.Notification.Action getActionFromActionCompat(Action action) {
            ...
            if (VERSION.SDK_INT >= 23) {
                ...
                new android.app.Notification.Action.Builder(icon, action.getTitle(), action.getActionIntent());
            } else {
    ...
    public static Action getActionCompatFromAction(android.app.Notification.Action action) {
        RemoteInput[] remoteInputArr;
        boolean z;
        int i;
        ...
        if (VERSION.SDK_INT >= 23) {
            if (action.getIcon() == null) {
                int i4 = action2.icon;
                if (i4 != 0) {
                    Action action3 = new Action(i4, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual);
                    return action3;
                }
            }
            if (action.getIcon() != null) {
                ...
                if (!(IconCompat.getType(icon) == 2 && IconCompat.getResId(icon) == 0)) {
                    iconCompat = IconCompat.createFromIcon(icon);
                }
            }
    ...
    public static LocusIdCompat getLocusId(Notification notification) {
        ...
        if (locusId != null) {
            b.checkNotNull(locusId, "locusId cannot be null");
        ...
        if (VERSION.SDK_INT >= 28) {
            ...
            if (!(stringArray == null || stringArray.length == 0)) {
                for (String uri : stringArray) {
                    arrayList.add(new androidx.core.app.Person.Builder().setUri(uri).build());
                }
            }
        }
        return arrayList;
