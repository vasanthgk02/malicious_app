...
public abstract class ConstraintTracker<T> {
    ...
    public void setState(T r4) {
        ...
        L_0x0014:
            ...
            androidx.work.impl.utils.taskexecutor.WorkManagerTaskExecutor r1 = (androidx.work.impl.utils.taskexecutor.WorkManagerTaskExecutor) r1     // Catch:{ all -> 0x002f }
            java.util.concurrent.Executor r1 = r1.mMainThreadExecutor     // Catch:{ all -> 0x002f }
