...
public class SystemJobService extends JobService implements ExecutionListener {
    ...
    public boolean onStartJob(android.app.job.JobParameters r9) {
        ...
        L_0x002f:
            ...
            monitor-enter(r3)
            java.util.Map<java.lang.String, android.app.job.JobParameters> r4 = r8.mJobParameters     // Catch:{ all -> 0x00b5 }
            boolean r4 = r4.containsKey(r0)     // Catch:{ all -> 0x00b5 }
            if (r4 == 0) goto L_0x0051
            androidx.work.Logger r9 = androidx.work.Logger.get()     // Catch:{ all -> 0x00b5 }
            java.lang.String r4 = TAG     // Catch:{ all -> 0x00b5 }
            ...
            r1[r2] = r0     // Catch:{ all -> 0x00b5 }
            java.lang.String r0 = java.lang.String.format(r5, r1)     // Catch:{ all -> 0x00b5 }
            java.lang.Throwable[] r1 = new java.lang.Throwable[r2]     // Catch:{ all -> 0x00b5 }
            r9.debug(r4, r0, r1)     // Catch:{ all -> 0x00b5 }
            monitor-exit(r3)     // Catch:{ all -> 0x00b5 }
            return r2
        L_0x0051:
            androidx.work.Logger r4 = androidx.work.Logger.get()     // Catch:{ all -> 0x00b5 }
            java.lang.String r5 = TAG     // Catch:{ all -> 0x00b5 }
            java.lang.String r6 = "onStartJob for %s"
            java.lang.Object[] r7 = new java.lang.Object[r1]     // Catch:{ all -> 0x00b5 }
            r7[r2] = r0     // Catch:{ all -> 0x00b5 }
            java.lang.String r6 = java.lang.String.format(r6, r7)     // Catch:{ all -> 0x00b5 }
            java.lang.Throwable[] r2 = new java.lang.Throwable[r2]     // Catch:{ all -> 0x00b5 }
            r4.debug(r5, r6, r2)     // Catch:{ all -> 0x00b5 }
            java.util.Map<java.lang.String, android.app.job.JobParameters> r2 = r8.mJobParameters     // Catch:{ all -> 0x00b5 }
            r2.put(r0, r9)     // Catch:{ all -> 0x00b5 }
            monitor-exit(r3)     // Catch:{ all -> 0x00b5 }
            r2 = 0
        ...
        L_0x00a4:
            ...
            androidx.work.impl.utils.taskexecutor.TaskExecutor r3 = r9.mWorkTaskExecutor
            androidx.work.impl.utils.StartWorkRunnable r4 = new androidx.work.impl.utils.StartWorkRunnable
            r4.<init>(r9, r0, r2)
            ...
            androidx.work.impl.utils.SerialExecutor r9 = r3.mBackgroundExecutor
            r9.execute(r4)
            return r1
        L_0x00b5:
            r9 = move-exception
