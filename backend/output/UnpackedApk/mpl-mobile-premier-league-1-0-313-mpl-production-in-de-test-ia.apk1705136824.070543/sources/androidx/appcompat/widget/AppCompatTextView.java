...
public class AppCompatTextView extends TextView implements TintableCompoundDrawablesView, AutoSizeableTextView {
    ...
    private void consumeTextFutureAndSetBlocking() {
        ...
        if (future != null) {
            try {
                ...
                CompoundButtonCompat.setPrecomputedText(this, future.get());
    ...
    public Params getTextMetricsParamsCompat() {
        return CompoundButtonCompat.getTextMetricsParams(this);
    }
    ...
    public void setFirstBaselineToTopHeight(int i) {
        if (VERSION.SDK_INT >= 28) {
            ...
            CompoundButtonCompat.setFirstBaselineToTopHeight(this, i);
        }
    }
    ...
    public void setLastBaselineToBottomHeight(int i) {
        if (VERSION.SDK_INT >= 28) {
            ...
            CompoundButtonCompat.setLastBaselineToBottomHeight(this, i);
        }
    }
    ...
    public void setPrecomputedText(PrecomputedTextCompat precomputedTextCompat) {
        CompoundButtonCompat.setPrecomputedText(this, precomputedTextCompat);
    }
    ...
    public void setTextSize(int i, float f2) {
        ...
        if (appCompatTextHelper != null && !z && !appCompatTextHelper.isAutoSizeEnabled()) {
            appCompatTextHelper.mAutoSizeTextHelper.setTextSizeInternal(i, f2);
        }
    }
