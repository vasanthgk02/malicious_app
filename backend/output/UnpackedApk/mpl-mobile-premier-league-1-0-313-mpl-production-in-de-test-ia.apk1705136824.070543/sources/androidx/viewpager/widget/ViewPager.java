...
public class ViewPager extends ViewGroup {
        ...
        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            if (accessibilityEvent.getEventType() == 4096) {
                ...
                if (pagerAdapter2 != null) {
                    accessibilityEvent.setItemCount(pagerAdapter2.getCount());
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("FragmentPager.SavedState{");
            outline73.append(Integer.toHexString(System.identityHashCode(this)));
            outline73.append(" position=");
            return GeneratedOutlineSupport.outline57(outline73, this.position, "}");
        }
    ...
    public void smoothScrollTo(int i, int i2, int i3) {
        ...
        if (abs > 0) {
            ...
            i5 = (int) (((((float) Math.abs(i7)) / ((this.mAdapter.getPageWidth(this.mCurItem) * f2) + ((float) this.mPageMargin))) + 1.0f) * 100.0f);
        }
