...
public final class PausingDispatcher extends CoroutineDispatcher {
    ...
    public void dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        if (dispatchQueue2 != null) {
            ...
            if (immediate.isDispatchNeeded(coroutineContext) || dispatchQueue2.canRun()) {
                immediate.dispatch(coroutineContext, new DispatchQueue$dispatchAndEnqueue$$inlined$with$lambda$1(dispatchQueue2, coroutineContext, runnable));
            } else {
                dispatchQueue2.enqueue(runnable);
            }
        } else {
            throw null;
        }
