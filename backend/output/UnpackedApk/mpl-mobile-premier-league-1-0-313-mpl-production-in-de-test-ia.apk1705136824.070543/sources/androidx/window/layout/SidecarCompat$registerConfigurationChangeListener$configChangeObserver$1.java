...
public final class SidecarCompat$registerConfigurationChangeListener$configChangeObserver$1 implements ComponentCallbacks {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        ExtensionCallbackInterface extensionCallbackInterface = sidecarCompat.extensionCallback;
        if (extensionCallbackInterface != null) {
            Activity activity = this.$activity;
            extensionCallbackInterface.onWindowLayoutChanged(activity, sidecarCompat.getWindowLayoutInfo(activity));
        }
    }
