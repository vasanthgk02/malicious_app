...
public final class Utf8 {
    ...
    public static final class SafeProcessor extends Processor {
        public String decodeUtf8(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
                ...
                while (r13 < i3) {
                    byte b2 = bArr[r13];
                    if (!CompoundButtonCompat.access$400(b2)) {
                        break;
                    }
                    i = r13 + 1;
                    cArr[i4] = (char) b2;
                ...
                while (r13 < i3) {
                    int i6 = r13 + 1;
                    byte b3 = bArr[r13];
                    if (CompoundButtonCompat.access$400(b3)) {
                        int i7 = i5 + 1;
                        cArr[i5] = (char) b3;
                        r13 = i6;
                        while (true) {
                            ...
                            byte b4 = bArr[r13];
                            if (!CompoundButtonCompat.access$400(b4)) {
                                break;
                            }
                            r13++;
                            i7 = i5 + 1;
                        ...
                        if (!(b3 < -32)) {
                            if (b3 < -16) {
                                if (i6 < i3 - 1) {
                                    int i8 = i6 + 1;
                                    CompoundButtonCompat.access$900(b3, bArr[i6], bArr[i8], cArr, i5);
                                    r13 = i8 + 1;
                                    i5++;
                                } else {
                                ...
                                byte b5 = bArr[i6];
                                int i10 = i9 + 1;
                                CompoundButtonCompat.access$1000(b3, b5, bArr[i9], bArr[i10], cArr, i5);
                                i5 = i5 + 1 + 1;
                                r13 = i10 + 1;
                            } else {
                                throw InvalidProtocolBufferException.invalidUtf8();
                            ...
                            CompoundButtonCompat.access$700(b3, bArr[i6], cArr, i5);
                            r13 = i6 + 1;
                            i5++;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
        ...
        public int partialIsValidUtf8(int r12, byte[] r13, int r14, int r15) {
            ...
            L_0x0023:
                ...
                int r12 = androidx.datastore.preferences.protobuf.Utf8.access$000(r8, r14)
                return r12
            L_0x0036:
                r10 = r14
                r14 = r12
            ...
            L_0x004a:
                ...
                int r12 = androidx.datastore.preferences.protobuf.Utf8.access$000(r8, r9)
                return r12
            L_0x005b:
                r14 = r12
                r12 = 0
            ...
            L_0x0061:
                ...
                int r12 = androidx.datastore.preferences.protobuf.Utf8.incompleteStateFor(r8, r9, r14)
                return r12
            L_0x006e:
                r10 = r14
                r14 = r12
            ...
            L_0x00aa:
                ...
                int r3 = androidx.datastore.preferences.protobuf.Utf8.access$1100(r13, r12, r15)
                goto L_0x00ef
            L_0x00b5:
                int r8 = r12 + 1
                byte r12 = r13[r12]
    ...
    public static final class UnsafeProcessor extends Processor {
                    ...
                    if (CompoundButtonCompat.access$400(b3)) {
                        ...
                        if (!(b3 < -32)) {
                            if (b3 < -16) {
                                if (i6 < i3 - 1) {
                                    int i8 = i6 + 1;
                                    CompoundButtonCompat.access$900(b3, UnsafeUtil.getByte(bArr, (long) i6), UnsafeUtil.getByte(bArr, (long) i8), cArr, i5);
                                    r13 = i8 + 1;
                                    i5++;
                                } else {
                                    throw InvalidProtocolBufferException.invalidUtf8();
                                ...
                                int i10 = i9 + 1;
                                CompoundButtonCompat.access$1000(b3, b5, UnsafeUtil.getByte(bArr, (long) i9), UnsafeUtil.getByte(bArr, (long) i10), cArr, i5);
                                i5 = i5 + 1 + 1;
                                r13 = i10 + 1;
                            } else {
                                throw InvalidProtocolBufferException.invalidUtf8();
                            ...
                            CompoundButtonCompat.access$700(b3, UnsafeUtil.getByte(bArr, (long) i6), cArr, i5);
                            r13 = i6 + 1;
                            i5++;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0036, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r1, r8) > -65) goto L_0x003d;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:28:0x0067, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r1, r8) > -65) goto L_0x0069;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int partialIsValidUtf8(int r24, byte[] r25, int r26, int r27) {
            ...
            L_0x002b:
                ...
                long r20 = r8 + r17
                byte r0 = androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r1, r8)
            ...
            L_0x003e:
                ...
                int r0 = androidx.datastore.preferences.protobuf.Utf8.access$000(r7, r0)
                return r0
            L_0x0055:
                r8 = r20
            L_0x0057:
            ...
            L_0x006a:
                ...
                long r21 = r8 + r17
                byte r6 = androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r1, r8)
                int r0 = (r21 > r2 ? 1 : (r21 == r2 ? 0 : -1))
                if (r0 < 0) goto L_0x007f
                int r0 = androidx.datastore.preferences.protobuf.Utf8.access$000(r7, r6)
                return r0
            L_0x007f:
                r8 = r21
                r0 = 0
            ...
            L_0x0085:
                ...
                int r0 = androidx.datastore.preferences.protobuf.Utf8.incompleteStateFor(r7, r6, r0)
                return r0
            L_0x0096:
                r8 = r21
            L_0x0098:
            ...
            L_0x00b9:
                ...
                long r21 = r6 + r17
                byte r3 = androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r1, r6)
            ...
            L_0x0107:
                int r0 = r0 + -2
                long r6 = r8 + r17
                byte r3 = androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r1, r8)
            ...
            L_0x0119:
                long r8 = r6 + r17
                byte r2 = androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r1, r6)
            ...
            L_0x012a:
                ...
                long r2 = r6 + r17
                byte r6 = androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r1, r6)
                if (r6 > r15) goto L_0x00fc
                long r6 = r2 + r17
                byte r2 = androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r1, r2)
