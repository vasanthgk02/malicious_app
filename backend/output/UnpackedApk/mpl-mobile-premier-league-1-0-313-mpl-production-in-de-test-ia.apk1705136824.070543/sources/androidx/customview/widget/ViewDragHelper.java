...
public class ViewDragHelper {
    ...
    public static ViewDragHelper create(ViewGroup viewGroup, float f2, Callback callback) {
        ...
        viewDragHelper.mTouchSlop = (int) ((1.0f / f2) * ((float) viewDragHelper.mTouchSlop));
    ...
    public void captureChildView(View view, int i) {
        ...
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
        outline73.append(this.mParentView);
        outline73.append(")");
        throw new IllegalArgumentException(outline73.toString());
    }

    public final boolean checkNewEdgeDrag(float f2, float f3, int i, int i2) {
    ...
    public final boolean checkTouchSlop(View view, float f2, float f3) {
        boolean z = false;
        if (view == null) {
            return false;
        }
        ...
        if (z2 && z3) {
            ...
            if (z3 && Math.abs(f3) > ((float) this.mTouchSlop)) {
                z = true;
            }
            return z;
        }
    ...
    public final void dispatchViewReleased(float f2, float f3) {
    ...
    public final boolean forceSettleCapturedViewAt(int i, int i2, int i3, int i4) {
        ...
        float computeAxisDuration2 = ((float) computeAxisDuration(i6, clampMag2, this.mCallback.getViewVerticalDragRange(view))) * (f5 / f4);
        this.mScroller.startScroll(left, top, i5, i6, (int) (computeAxisDuration2 + (((float) computeAxisDuration) * f6)));
        setDragState(2);
        return true;
    }
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 3) {
                ...
                if (isViewUnder(this.mCapturedView, (int) x2, (int) y2)) {
            ...
            if (i8 != 0) {
                left = this.mCallback.clampViewPositionHorizontal(this.mCapturedView, left, i8);
                ViewCompat.offsetLeftAndRight(this.mCapturedView, left - left2);
            }
            int i10 = left;
            if (i9 != 0) {
                top = this.mCallback.clampViewPositionVertical(this.mCapturedView, top, i9);
                ViewCompat.offsetTopAndBottom(this.mCapturedView, top - top2);
            }
            int i11 = top;
            if (!(i8 == 0 && i9 == 0)) {
                this.mCallback.onViewPositionChanged(this.mCapturedView, i10, i11, i10 - left2, i11 - top2);
            }
            saveLastMotion(motionEvent);
        }
    }
    ...
    public final void reportNewEdgeDrags(float f2, float f3, int i) {
        int i2 = 1;
    ...
    public final void saveInitialMotion(float f2, float f3, int i) {
        float[] fArr = this.mInitialMotionX;
        int i2 = 0;
    ...
    public final float clampMag(float f2, float f3, float f4) {
        float abs = Math.abs(f2);
        if (abs < f3) {
            return 0.0f;
        }
