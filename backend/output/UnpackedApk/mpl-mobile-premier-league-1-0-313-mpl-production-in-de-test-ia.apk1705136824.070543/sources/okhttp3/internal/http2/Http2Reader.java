...
public final class Http2Reader implements Closeable {
    ...
    public final Reader hpackReader;
    ...
    public static final class Companion {
        ...
        public final int lengthWithoutPadding(int i, int i2, int i3) throws IOException {
            ...
            throw new IOException(GeneratedOutlineSupport.outline43("PROTOCOL_ERROR padding ", i3, " > remaining length ", i));
        }
    ...
    public static final class ContinuationSource implements Source {
        ...
        private final void readContinuationHeader() throws IOException {
            ...
            this.flags = Util.and(this.source.readByte(), (int) InvitationReply.EXPIRED);
    ...
    private final void readData(Handler handler, int i, int i2, int i3) throws IOException {
        if (i3 != 0) {
            ...
            if (!z) {
                if ((i2 & 8) != 0) {
                    i4 = Util.and(this.source.readByte(), (int) InvitationReply.EXPIRED);
                }
    ...
    private final void readGoAway(Handler handler, int i, int i2, int i3) throws IOException {
        if (i < 8) {
            throw new IOException(GeneratedOutlineSupport.outline41("TYPE_GOAWAY length < 8: ", i));
        } else if (i3 == 0) {
            ...
            throw new IOException(GeneratedOutlineSupport.outline41("TYPE_GOAWAY unexpected error code: ", readInt2));
        } else {
    ...
    private final void readPing(Handler handler, int i, int i2, int i3) throws IOException {
        if (i != 8) {
            throw new IOException(GeneratedOutlineSupport.outline41("TYPE_PING length != 8: ", i));
        } else if (i3 == 0) {
            int readInt = this.source.readInt();
            int readInt2 = this.source.readInt();
            boolean z = true;
    ...
    private final void readPriority(Handler handler, int i, int i2, int i3) throws IOException {
        if (i != 5) {
            throw new IOException(GeneratedOutlineSupport.outline42("TYPE_PRIORITY length: ", i, " != 5"));
        } else if (i3 != 0) {
            readPriority(handler, i3);
        } else {
    ...
    private final void readPushPromise(Handler handler, int i, int i2, int i3) throws IOException {
        if (i3 != 0) {
            int and = (i2 & 8) != 0 ? Util.and(this.source.readByte(), (int) InvitationReply.EXPIRED) : 0;
    ...
    private final void readRstStream(Handler handler, int i, int i2, int i3) throws IOException {
        if (i != 4) {
            throw new IOException(GeneratedOutlineSupport.outline42("TYPE_RST_STREAM length: ", i, " != 4"));
        } else if (i3 != 0) {
            int readInt = this.source.readInt();
            ...
            throw new IOException(GeneratedOutlineSupport.outline41("TYPE_RST_STREAM unexpected error code: ", readInt));
        } else {
    ...
    private final void readSettings(Handler handler, int i, int i2, int i3) throws IOException {
        ...
        if (i3 != 0) {
            ...
            if (i6 < 0 ? i4 >= i5 : i4 <= i5) {
                ...
                throw new IOException(GeneratedOutlineSupport.outline41("PROTOCOL_ERROR SETTINGS_MAX_FRAME_SIZE: ", readInt));
            }
            handler.settings(false, settings);
        } else {
            throw new IOException(GeneratedOutlineSupport.outline41("TYPE_SETTINGS length % 6 != 0: ", i));
        }
    }
    ...
    private final void readWindowUpdate(Handler handler, int i, int i2, int i3) throws IOException {
        ...
        throw new IOException(GeneratedOutlineSupport.outline41("TYPE_WINDOW_UPDATE length !=4: ", i));
    }
    ...
    public final boolean nextFrame(boolean z, Handler handler) throws IOException {
        ...
        try {
            ...
            if (readMedium <= 16384) {
                int and = Util.and(this.source.readByte(), (int) InvitationReply.EXPIRED);
                int and2 = Util.and(this.source.readByte(), (int) InvitationReply.EXPIRED);
                int readInt = this.source.readInt() & Integer.MAX_VALUE;
                ...
                StringBuilder outline73 = GeneratedOutlineSupport.outline73("Expected a SETTINGS frame but was ");
                outline73.append(Http2.INSTANCE.formattedType$okhttp(and));
                throw new IOException(outline73.toString());
            }
            throw new IOException(GeneratedOutlineSupport.outline41("FRAME_SIZE_ERROR: ", readMedium));
    ...
    public final void readConnectionPreface(Handler handler) throws IOException {
        ...
        if (!this.client) {
            ...
            if (logger.isLoggable(Level.FINE)) {
                ...
                StringBuilder outline73 = GeneratedOutlineSupport.outline73("<< CONNECTION ");
                outline73.append(readByteString.hex());
                logger2.fine(Util.format(outline73.toString(), new Object[0]));
            }
            if (!Intrinsics.areEqual(Http2.CONNECTION_PREFACE, readByteString)) {
                StringBuilder outline732 = GeneratedOutlineSupport.outline73("Expected a connection header but was ");
                outline732.append(readByteString.utf8());
    ...
    private final void readPriority(Handler handler, int i) throws IOException {
        int readInt = this.source.readInt();
        handler.priority(i, readInt & Integer.MAX_VALUE, Util.and(this.source.readByte(), (int) InvitationReply.EXPIRED) + 1, (readInt & ((int) 2147483648L)) != 0);
    }
}
