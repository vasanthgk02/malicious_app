...
public final class Http2 {
    ...
    static {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            strArr[i] = CharsKt__CharKt.replace$default(Util.format("%8s", binaryString), ' ', '0', false, 4);
        }
        BINARY = strArr;
        ...
        for (int i4 = 0; i4 < 3; i4++) {
            ...
            for (int i6 = 0; i6 < 1; i6++) {
                ...
                sb.append(FLAGS[i7]);
                sb.append("|");
                FLAGS[i8 | 8] = GeneratedOutlineSupport.outline62(sb, FLAGS[i5], "|PADDED");
            }
        }
    ...
    public final String formatFlags(int i, int i2) {
        ...
        if (!(i == 2 || i == 3)) {
            if (i == 4 || i == 6) {
                ...
                if (i == 5 && (i2 & 4) != 0) {
                    str2 = CharsKt__CharKt.replace$default(str2, (String) "HEADERS", (String) "PUSH_PROMISE", false, 4);
                } else if (i == 0 && (i2 & 32) != 0) {
                    str2 = CharsKt__CharKt.replace$default(str2, (String) "PRIORITY", (String) "COMPRESSED", false, 4);
                }
                return str2;
            }
        }
    ...
    public final String frameLog(boolean z, int i, int i2, int i3, int i4) {
        return Util.format("%s 0x%08x %5d %-13s %s", z ? "<<" : CMapParser.MARK_END_OF_DICTIONARY, Integer.valueOf(i), Integer.valueOf(i2), formattedType$okhttp(i3), formatFlags(i3, i4));
    }
}
