...
public final class Huffman {
    ...
    public static final class Node {
        ...
        public Node(int i, int i2) {
            this.children = null;
            this.symbol = i;
            this.terminalBitCount = (i2 & 7) == 0 ? 8 : i2 & 7;
        }
    }
    ...
    private final void addCode(int i, int i2, int i3) {
        ...
        while (i3 > 8) {
            i3 -= 8;
            int i4 = (i2 >>> i3) & InvitationReply.EXPIRED;
        ...
        int i5 = 8 - i3;
        int i6 = (i2 << i5) & InvitationReply.EXPIRED;
    ...
    public final void decode(BufferedSource bufferedSource, long j, BufferedSink bufferedSink) {
        ...
        for (long j2 = 0; j2 < j; j2++) {
            i = (i << 8) | Util.and(bufferedSource.readByte(), (int) InvitationReply.EXPIRED);
            i2 += 8;
            while (i2 >= 8) {
                int i3 = i2 - 8;
                int i4 = (i >>> i3) & InvitationReply.EXPIRED;
        ...
        while (i2 > 0) {
            int i5 = (i << (8 - i2)) & InvitationReply.EXPIRED;
    ...
    public final int encodedLength(ByteString byteString) {
        ...
        for (int i = 0; i < size; i++) {
            j += (long) CODE_BIT_COUNTS[Util.and(byteString.getByte(i), (int) InvitationReply.EXPIRED)];
        }
