...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public static final List<String> HTTP_2_SKIPPED_REQUEST_HEADERS = Util.immutableListOf("connection", HOST, "keep-alive", PROXY_CONNECTION, "te", TRANSFER_ENCODING, ENCODING, "upgrade", ":method", ":path", ":scheme", ":authority");
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            while (i < size) {
                ...
                if (name != null) {
                    ...
                    if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (Intrinsics.areEqual(lowerCase, "te") && Intrinsics.areEqual(headers.value(i), Values.TRAILERS))) {
