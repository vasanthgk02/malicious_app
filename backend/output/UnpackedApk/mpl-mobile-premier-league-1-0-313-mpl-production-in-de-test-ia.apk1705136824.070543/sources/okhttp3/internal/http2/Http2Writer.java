...
public final class Http2Writer implements Closeable {
    ...
    public final Writer hpackWriter;
    ...
    public final void frameHeader(int i, int i2, int i3, int i4) throws IOException {
        ...
        if (i2 <= this.maxFrameSize) {
            ...
            if (z) {
                ...
                this.sink.writeByte(i3 & InvitationReply.EXPIRED);
                this.sink.writeByte(i4 & InvitationReply.EXPIRED);
                this.sink.writeInt(i & Integer.MAX_VALUE);
                return;
            }
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline41("reserved bit set: ", i).toString());
        }
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("FRAME_SIZE_ERROR length > ");
        outline73.append(this.maxFrameSize);
        outline73.append(": ");
        outline73.append(i2);
