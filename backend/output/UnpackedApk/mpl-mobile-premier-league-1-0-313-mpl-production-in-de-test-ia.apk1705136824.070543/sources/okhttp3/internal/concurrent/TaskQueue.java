...
public final class TaskQueue {
    ...
    public static final class AwaitIdleTask extends Task {
        ...
        public AwaitIdleTask() {
            super(GeneratedOutlineSupport.outline62(new StringBuilder(), Util.okHttpName, " awaitIdle"), false);
        }
    ...
    public final List<Task> getScheduledTasks() {
        List<Task> list;
        synchronized (this.taskRunner) {
            list = ArraysKt___ArraysJvmKt.toList(this.futureTasks);
        }
        return list;
    }
    ...
    public final void schedule(okhttp3.internal.concurrent.Task r3, long r4) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r2.shutdown     // Catch:{ all -> 0x004f }
            if (r1 == 0) goto L_0x0041
            boolean r4 = r3.getCancelable()     // Catch:{ all -> 0x004f }
            if (r4 == 0) goto L_0x0028
            okhttp3.internal.concurrent.TaskRunner$Companion r4 = okhttp3.internal.concurrent.TaskRunner.Companion     // Catch:{ all -> 0x004f }
            java.util.logging.Logger r4 = r4.getLogger()     // Catch:{ all -> 0x004f }
            java.util.logging.Level r5 = java.util.logging.Level.FINE     // Catch:{ all -> 0x004f }
            boolean r4 = r4.isLoggable(r5)     // Catch:{ all -> 0x004f }
            if (r4 == 0) goto L_0x0026
            java.lang.String r4 = "schedule canceled (queue is shutdown)"
            okhttp3.internal.concurrent.TaskLoggerKt.log(r3, r2, r4)     // Catch:{ all -> 0x004f }
        L_0x0026:
            monitor-exit(r0)
            return
        L_0x0028:
            ...
            okhttp3.internal.concurrent.TaskLoggerKt.log(r3, r2, r4)     // Catch:{ all -> 0x004f }
        L_0x003b:
            java.util.concurrent.RejectedExecutionException r3 = new java.util.concurrent.RejectedExecutionException     // Catch:{ all -> 0x004f }
            r3.<init>()     // Catch:{ all -> 0x004f }
            throw r3     // Catch:{ all -> 0x004f }
        L_0x0041:
            r1 = 0
            boolean r3 = r2.scheduleAndDecide$okhttp(r3, r4, r1)     // Catch:{ all -> 0x004f }
            if (r3 == 0) goto L_0x004d
            okhttp3.internal.concurrent.TaskRunner r3 = r2.taskRunner     // Catch:{ all -> 0x004f }
            r3.kickCoordinator$okhttp(r2)     // Catch:{ all -> 0x004f }
        L_0x004d:
            monitor-exit(r0)
            return
        L_0x004f:
    ...
    public final boolean scheduleAndDecide$okhttp(Task task, long j, boolean z) {
        ...
        if (TaskRunner.Companion.getLogger().isLoggable(Level.FINE)) {
            if (z) {
                StringBuilder outline73 = GeneratedOutlineSupport.outline73("run again after ");
                outline73.append(TaskLoggerKt.formatDuration(j2 - nanoTime));
                str = outline73.toString();
            } else {
                StringBuilder outline732 = GeneratedOutlineSupport.outline73("scheduled after ");
                outline732.append(TaskLoggerKt.formatDuration(j2 - nanoTime));
