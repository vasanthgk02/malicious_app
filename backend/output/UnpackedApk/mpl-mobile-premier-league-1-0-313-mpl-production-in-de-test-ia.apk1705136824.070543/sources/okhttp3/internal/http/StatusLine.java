...
public final class StatusLine {
    ...
    public static final class Companion {
        ...
        public final StatusLine parse(String str) throws IOException {
            ...
            int i = 9;
            if (CharsKt__CharKt.startsWith$default(str, (String) "HTTP/1.", false, 2)) {
                if (str.length() < 9 || str.charAt(8) != ' ') {
                    throw new ProtocolException(GeneratedOutlineSupport.outline50("Unexpected status line: ", str));
                }
            ...
            } else if (CharsKt__CharKt.startsWith$default(str, (String) "ICY ", false, 2)) {
                protocol = Protocol.HTTP_1_0;
                i = 4;
            } else {
                throw new ProtocolException(GeneratedOutlineSupport.outline50("Unexpected status line: ", str));
