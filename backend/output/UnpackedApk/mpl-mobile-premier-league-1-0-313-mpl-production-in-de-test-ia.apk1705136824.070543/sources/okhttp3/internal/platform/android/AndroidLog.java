...
public final class AndroidLog {
    ...
    static {
        ...
        knownLoggers = ArraysKt___ArraysJvmKt.toMap((Map<? extends K, ? extends V>) linkedHashMap);
    }
    ...
    public final void androidLog$okhttp(String str, int i, String str2, Throwable th) {
        ...
        if (Log.isLoggable(loggerTag, i)) {
            if (th != null) {
                StringBuilder outline78 = GeneratedOutlineSupport.outline78(str2, "\n");
            ...
            int i2 = 0;
            while (i2 < length) {
                int indexOf$default = CharsKt__CharKt.indexOf$default((CharSequence) str2, 10, i2, false, 4);
    ...
    public final void enable() {
        for (Entry next : knownLoggers.entrySet()) {
