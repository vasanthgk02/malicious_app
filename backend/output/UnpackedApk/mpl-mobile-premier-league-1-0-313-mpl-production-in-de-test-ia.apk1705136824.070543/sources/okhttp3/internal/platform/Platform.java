...
public class Platform {
    ...
    public static final class Companion {
        ...
        private final Platform findJvmPlatform() {
            if (isConscryptPreferred()) {
                ConscryptPlatform buildIfSupported = ConscryptPlatform.Companion.buildIfSupported();
                if (buildIfSupported != null) {
                    return buildIfSupported;
                }
            }
            if (isBouncyCastlePreferred()) {
                BouncyCastlePlatform buildIfSupported2 = BouncyCastlePlatform.Companion.buildIfSupported();
    ...
    public void logCloseableLeak(String str, Object obj) {
        Intrinsics.checkNotNullParameter(str, "message");
        if (obj == null) {
            str = GeneratedOutlineSupport.outline50(str, " To see where this was allocated, set the OkHttpClient logger level to FINE: Logger.getLogger(OkHttpClient.class.getName()).setLevel(Level.FINE);");
        }
    ...
    public X509TrustManager platformTrustManager() {
        ...
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("Unexpected default trust managers: ");
        String arrays = Arrays.toString(trustManagers);
        Intrinsics.checkNotNullExpressionValue(arrays, "java.util.Arrays.toString(this)");
        outline73.append(arrays);
