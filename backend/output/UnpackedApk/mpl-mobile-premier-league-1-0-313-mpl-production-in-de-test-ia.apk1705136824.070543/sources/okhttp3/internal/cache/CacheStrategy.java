        ...
        public Factory(long j, Request request2, Response response) {
            ...
            if (response != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (CharsKt__CharKt.equals(name, (String) "Date", true)) {
                        this.servedDate = DatesKt.toHttpDateOrNull(value);
                        this.servedDateString = value;
                    } else if (CharsKt__CharKt.equals(name, (String) "Expires", true)) {
                        this.expires = DatesKt.toHttpDateOrNull(value);
                    } else if (CharsKt__CharKt.equals(name, (String) "Last-Modified", true)) {
                        this.lastModified = DatesKt.toHttpDateOrNull(value);
                        this.lastModifiedString = value;
                    } else if (CharsKt__CharKt.equals(name, (String) Names.ETAG, true)) {
                        this.etag = value;
                    } else if (CharsKt__CharKt.equals(name, (String) Names.AGE, true)) {
