...
public final class ConnectionSpecSelector {
    ...
    public final ConnectionSpec configureSecureSocket(SSLSocket sSLSocket) throws IOException {
        ...
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("Unable to find acceptable protocols. isFallback=");
        outline73.append(this.isFallback);
        outline73.append(',');
        outline73.append(" modes=");
        outline73.append(this.connectionSpecs);
        outline73.append(',');
        outline73.append(" supported protocols=");
        String[] enabledProtocols = sSLSocket.getEnabledProtocols();
        Intrinsics.checkNotNull(enabledProtocols);
        String arrays = Arrays.toString(enabledProtocols);
        Intrinsics.checkNotNullExpressionValue(arrays, "java.util.Arrays.toString(this)");
        outline73.append(arrays);
        throw new UnknownServiceException(outline73.toString());
    }
