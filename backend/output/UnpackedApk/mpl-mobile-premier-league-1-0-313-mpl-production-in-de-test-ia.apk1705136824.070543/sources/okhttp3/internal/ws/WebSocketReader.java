...
public final class WebSocketReader implements Closeable {
    ...
    public final UnsafeCursor maskCursor;
    ...
    public WebSocketReader(boolean z, BufferedSource bufferedSource, FrameCallback frameCallback2, boolean z2, boolean z3) {
        ...
        this.maskCursor = !this.isClient ? new UnsafeCursor() : unsafeCursor;
    }
    ...
    private final void readControlFrame() throws IOException {
        ...
        switch (this.opcode) {
            ...
            case 10:
                ...
                return;
            default:
                StringBuilder outline73 = GeneratedOutlineSupport.outline73("Unknown control opcode: ");
                outline73.append(Util.toHexString(this.opcode));
                    ...
                    if (!((and & 32) != 0)) {
                        if (!((and & 16) != 0)) {
                            ...
                            if (j == ((long) 126)) {
                                ...
                                if (readLong < 0) {
                                    StringBuilder outline73 = GeneratedOutlineSupport.outline73("Frame length 0x");
                                    outline73.append(Util.toHexString(this.frameLength));
                                    outline73.append(" > 0x7FFFFFFFFFFFFFFF");
                                    throw new ProtocolException(outline73.toString());
                                }
                            }
    ...
    private final void readMessage() throws IOException {
        while (!this.closed) {
            ...
            if (!this.isFinalFrame) {
                ...
                if (this.opcode != 0) {
                    StringBuilder outline73 = GeneratedOutlineSupport.outline73("Expected continuation opcode. Got: ");
                    outline73.append(Util.toHexString(this.opcode));
                    throw new ProtocolException(outline73.toString());
                }
            } else {
