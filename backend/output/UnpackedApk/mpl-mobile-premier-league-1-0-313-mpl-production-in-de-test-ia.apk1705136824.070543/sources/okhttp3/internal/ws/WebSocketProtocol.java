...
public final class WebSocketProtocol {
    ...
    public final String closeCodeExceptionMessage(int i) {
        if (i < 1000 || i >= 5000) {
            return GeneratedOutlineSupport.outline41("Code must be in range [1000,5000): ", i);
        }
        if ((1004 > i || 1006 < i) && (1015 > i || 2999 < i)) {
            return null;
        }
        return GeneratedOutlineSupport.outline42("Code ", i, " is reserved and may not be used.");
    }
