...
public final class Challenge {
    ...
    public final Map<String, String> m1013deprecated_authParams() {
        return this.authParams;
    }

    /* renamed from: -deprecated_charset  reason: not valid java name */
    public final Charset m1014deprecated_charset() {
        return charset();
    }

    /* renamed from: -deprecated_realm  reason: not valid java name */
    public final String m1015deprecated_realm() {
        return realm();
    }

    /* renamed from: -deprecated_scheme  reason: not valid java name */
    public final String m1016deprecated_scheme() {
        return this.scheme;
    }
    ...
    public int hashCode() {
        return this.authParams.hashCode() + GeneratedOutlineSupport.outline11(this.scheme, 899, 31);
    }
    ...
    public final Challenge withCharset(Charset charset) {
        ...
        Map<String, String> mutableMap = ArraysKt___ArraysJvmKt.toMutableMap(this.authParams);
        String name = charset.name();
        Intrinsics.checkNotNullExpressionValue(name, "charset.name()");
        ((HashMap) mutableMap).put("charset", name);
