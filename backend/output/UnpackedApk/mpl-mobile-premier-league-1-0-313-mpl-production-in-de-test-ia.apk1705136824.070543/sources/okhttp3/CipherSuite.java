...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_EMPTY_RENEGOTIATION_INFO_SCSV = Companion.init("TLS_EMPTY_RENEGOTIATION_INFO_SCSV", InvitationReply.EXPIRED);
    ...
    public static final CipherSuite TLS_RSA_WITH_SEED_CBC_SHA = Companion.init("TLS_RSA_WITH_SEED_CBC_SHA", FTPReply.FILE_STATUS_OK);
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            if (CharsKt__CharKt.startsWith$default(str, (String) "TLS_", false, 2)) {
                StringBuilder outline73 = GeneratedOutlineSupport.outline73("SSL_");
                if (str != null) {
            ...
            } else if (!CharsKt__CharKt.startsWith$default(str, (String) "SSL_", false, 2)) {
                return str;
            } else {
                StringBuilder outline732 = GeneratedOutlineSupport.outline73("TLS_");
                if (str != null) {
    ...
    public final String m1017deprecated_javaName() {
