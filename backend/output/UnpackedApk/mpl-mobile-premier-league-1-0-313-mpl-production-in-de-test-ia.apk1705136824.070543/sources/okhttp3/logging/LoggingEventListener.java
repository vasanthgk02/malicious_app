...
public final class LoggingEventListener extends EventListener {
    ...
    public void callStart(Call call) {
        ...
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("callStart: ");
        outline73.append(call.request());
        logWithTime(outline73.toString());
    }
    ...
    public LoggingEventListener(Logger logger2) {
        this.logger = logger2;
    }
}
