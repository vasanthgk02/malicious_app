...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            strArr2 = Util.intersect(enabledProtocols, strArr3, naturalOrderComparator);
        } else {
    ...
    public final List<CipherSuite> m1018deprecated_cipherSuites() {
        return cipherSuites();
    }

    /* renamed from: -deprecated_supportsTlsExtensions  reason: not valid java name */
    public final boolean m1019deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    /* renamed from: -deprecated_tlsVersions  reason: not valid java name */
    public final List<TlsVersion> m1020deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        ...
        if (strArr != null) {
            ...
            NaturalOrderComparator naturalOrderComparator = NaturalOrderComparator.INSTANCE;
            Intrinsics.checkNotNull(naturalOrderComparator, "null cannot be cast to non-null type java.util.Comparator<T of kotlin.comparisons.ComparisonsKt__ComparisonsKt.naturalOrder>{ kotlin.TypeAliasesKt.Comparator<T of kotlin.comparisons.ComparisonsKt__ComparisonsKt.naturalOrder> }");
            if (!Util.hasIntersection(strArr, enabledProtocols, naturalOrderComparator)) {
                return false;
            }
        }
    ...
    public String toString() {
        ...
        StringBuilder outline78 = GeneratedOutlineSupport.outline78("ConnectionSpec(", "cipherSuites=");
        outline78.append(Objects.toString(cipherSuites(), "[all enabled]"));
        outline78.append(", ");
        outline78.append("tlsVersions=");
        outline78.append(Objects.toString(tlsVersions(), "[all enabled]"));
        outline78.append(", ");
        outline78.append("supportsTlsExtensions=");
        return GeneratedOutlineSupport.outline65(outline78, this.supportsTlsExtensions, ')');
    }
}
