...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m1067deprecated_get(String str) {
            Intrinsics.checkNotNullParameter(str, "mediaType");
            return get(str);
        }

        /* renamed from: -deprecated_parse  reason: not valid java name */
        public final MediaType m1068deprecated_parse(String str) {
            Intrinsics.checkNotNullParameter(str, "mediaType");
            return parse(str);
        }
        ...
        public final MediaType get(String str) {
                ...
                while (end < str.length()) {
                    ...
                    if (matcher2.lookingAt()) {
                        ...
                        if (group3 == null) {
                            ...
                            } else if (CharsKt__CharKt.startsWith$default(group4, (String) "'", false, 2) && CharsKt__CharKt.endsWith$default(group4, (String) "'", false, 2) && group4.length() > 2) {
                        ...
                        StringBuilder outline73 = GeneratedOutlineSupport.outline73("Parameter is not formatted correctly: \"");
            ...
            throw new IllegalArgumentException(("No subtype found for: \"" + str + StringEscapeUtils.CSV_QUOTE).toString());
        }
    ...
    public final String m1065deprecated_subtype() {
        return this.subtype;
    }

    /* renamed from: -deprecated_type  reason: not valid java name */
    public final String m1066deprecated_type() {
        return this.type;
    }
    ...
    public final String parameter(String str) {
        ...
        IntProgression step = RangesKt___RangesKt.step(new IntRange(0, TweetUtils.getLastIndex((T[]) strArr)), 2);
        int i = step.first;
        int i2 = step.last;
        int i3 = step.step;
        if (i3 < 0 ? i >= i2 : i <= i2) {
            while (!CharsKt__CharKt.equals(this.parameterNamesAndValues[i], str, true)) {
                if (i != i2) {
                    i += i3;
                }
            }
