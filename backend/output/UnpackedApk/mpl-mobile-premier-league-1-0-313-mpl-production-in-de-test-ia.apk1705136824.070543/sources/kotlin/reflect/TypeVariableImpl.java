...
public final class TypeVariableImpl implements TypeVariable<GenericDeclaration>, Object {
    ...
    public Type[] getBounds() {
        ...
        for (KType computeJavaType : upperBounds) {
            arrayList.add(TypesJVMKt.computeJavaType(computeJavaType, true));
        }
    ...
    public GenericDeclaration getGenericDeclaration() {
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("getGenericDeclaration() is not yet supported for type variables created from KType: ");
        outline73.append(this.typeParameter);
        throw new NotImplementedError(GeneratedOutlineSupport.outline50("An operation is not implemented: ", outline73.toString()));
    }
