...
public class KProperty0Impl<V> extends KPropertyImpl<V> implements KProperty0<V> {
    ...
    public final Lazy<Object> delegateFieldValue = TweetUtils.lazy(LazyThreadSafetyMode.PUBLICATION, new KProperty0Impl$delegateFieldValue$1(this));
    ...
    public static final class Getter<R> extends kotlin.reflect.jvm.internal.KPropertyImpl.Getter<R> implements kotlin.reflect.KProperty0.Getter<R> {
        ...
        public KPropertyImpl m889getProperty() {
            return this.property;
        }
    }
    ...
    public KProperty0Impl(KDeclarationContainerImpl kDeclarationContainerImpl, PropertyDescriptor propertyDescriptor) {
        ...
        ReflectProperties$LazyVal<Getter<V>> lazy = TweetUtils.lazy((Function0<? extends T>) new KProperty0Impl$_getter$1<Object>(this));
