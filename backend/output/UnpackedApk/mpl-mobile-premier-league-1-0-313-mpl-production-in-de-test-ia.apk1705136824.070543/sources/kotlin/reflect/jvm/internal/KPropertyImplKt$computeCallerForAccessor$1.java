...
public final class KPropertyImplKt$computeCallerForAccessor$1 extends Lambda implements Function0<Boolean> {
    ...
    public KPropertyImplKt$computeCallerForAccessor$1(Accessor accessor) {
        // this.$this_computeCallerForAccessor = accessor;
        super(0);
    }

    public final boolean invoke() {
        return this.$this_computeCallerForAccessor.getProperty().getDescriptor().getAnnotations().hasAnnotation(UtilKt.JVM_STATIC);
    }
}
