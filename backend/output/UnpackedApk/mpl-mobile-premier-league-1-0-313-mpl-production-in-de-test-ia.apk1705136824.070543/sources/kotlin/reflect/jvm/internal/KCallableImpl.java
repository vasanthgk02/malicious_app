...
public abstract class KCallableImpl<R> implements KCallable<R>, KTypeParameterOwnerImpl {
    ...
    public KCallableImpl() {
        ReflectProperties$LazySoftVal<List<Annotation>> lazySoft = TweetUtils.lazySoft(new KCallableImpl$_annotations$1(this));
        Intrinsics.checkNotNullExpressionValue(lazySoft, "ReflectProperties.lazySo…or.computeAnnotations() }");
        this._annotations = lazySoft;
        ReflectProperties$LazySoftVal<ArrayList<KParameter>> lazySoft2 = TweetUtils.lazySoft(new KCallableImpl$_parameters$1(this));
        Intrinsics.checkNotNullExpressionValue(lazySoft2, "ReflectProperties.lazySo…ze()\n        result\n    }");
        this._parameters = lazySoft2;
        ReflectProperties$LazySoftVal<KTypeImpl> lazySoft3 = TweetUtils.lazySoft(new KCallableImpl$_returnType$1(this));
        Intrinsics.checkNotNullExpressionValue(lazySoft3, "ReflectProperties.lazySo…eturnType\n        }\n    }");
        this._returnType = lazySoft3;
        ReflectProperties$LazySoftVal<List<KTypeParameterImpl>> lazySoft4 = TweetUtils.lazySoft(new KCallableImpl$_typeParameters$1(this));
    ...
    public R callBy(Map<KParameter, ? extends Object> map) {
        ...
        if (isAnnotationConstructor()) {
            ...
            if (defaultCaller != null) {
                ...
                StringBuilder outline73 = GeneratedOutlineSupport.outline73("This callable does not support a default call: ");
                outline73.append(getDescriptor());
            ...
            boolean z = false;
            int i2 = 0;
            for (KParameter next : parameters2) {
                if (i != 0 && i % 32 == 0) {
                ...
                if (map.containsKey(next)) {
                    ...
                    arrayList2.add(UtilKt.isInlineClassType(next.getType()) ? null : UtilKt.defaultPrimitiveValue(TweetUtils.getJavaType(next.getType())));
                    i2 = (1 << (i % 32)) | i2;
                    z = true;
                } else if (next.isVararg()) {
                    arrayList2.add(defaultEmptyArray(next.getType()));
                } else {
                    throw new IllegalArgumentException("No argument provided for a required parameter: " + next);
                }
                if (next.getKind() == Kind.VALUE) {
                    i++;
                }
            }
            if (!z) {
            ...
            if (defaultCaller2 != null) {
                ...
                StringBuilder outline732 = GeneratedOutlineSupport.outline73("This callable does not support a default call: ");
                outline732.append(getDescriptor());
    ...
    public final Object defaultEmptyArray(KType kType) {
        Class javaClass = TweetUtils.getJavaClass(TweetUtils.getJvmErasure(kType));
        if (javaClass.isArray()) {
            Object newInstance = Array.newInstance(javaClass.getComponentType(), 0);
            Intrinsics.checkNotNullExpressionValue(newInstance, "type.jvmErasure.java.run…\"\n            )\n        }");
            return newInstance;
        }
        StringBuilder outline73 = GeneratedOutlineSupport.outline73("Cannot instantiate the default empty array of type ");
        outline73.append(javaClass.getSimpleName());
        outline73.append(", because it is not an array type");
        throw new KotlinReflectionInternalError(outline73.toString());
    }
