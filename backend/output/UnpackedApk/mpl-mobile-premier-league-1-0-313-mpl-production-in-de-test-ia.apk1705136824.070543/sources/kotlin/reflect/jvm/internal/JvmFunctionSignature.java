...
public abstract class JvmFunctionSignature {
    ...
    public static final class FakeJavaAnnotationConstructor extends JvmFunctionSignature {
        ...
        public FakeJavaAnnotationConstructor(Class<?> cls) {
            ...
            this.methods = TweetUtils.sortedWith(declaredMethods, new JvmFunctionSignature$FakeJavaAnnotationConstructor$$special$$inlined$sortedBy$1());
        }

        public String asString() {
            return ArraysKt___ArraysJvmKt.joinToString$default(this.methods, "", "<init>(", ")V", 0, null, JvmFunctionSignature$FakeJavaAnnotationConstructor$asString$1.INSTANCE, 24);
        }
    }
    ...
    public static final class JavaConstructor extends JvmFunctionSignature {
        ...
        public String asString() {
            ...
            return TweetUtils.joinToString$default(parameterTypes, "", "<init>(", ")V", 0, null, JvmFunctionSignature$JavaConstructor$asString$1.INSTANCE, 24);
        }
    }
    ...
    public static final class JavaMethod extends JvmFunctionSignature {
        ...
        public JavaMethod(Method method2) {
            // Intrinsics.checkNotNullParameter(method2, AnalyticsConstants.METHOD);
            super(null);
            this.method = method2;
        }

        public String asString() {
            return TweetUtils.access$getSignature$p(this.method);
        }
    }
