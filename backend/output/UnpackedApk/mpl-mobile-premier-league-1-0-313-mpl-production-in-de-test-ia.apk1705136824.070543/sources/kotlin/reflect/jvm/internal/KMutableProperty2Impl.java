...
public final class KMutableProperty2Impl<D, E, V> extends KProperty2Impl<D, E, V> implements Object<D, E, V>, Function2, KMutableProperty {
    public final ReflectProperties$LazyVal<Setter<D, E, V>> _setter;
    ...
    /* compiled from: KProperty2Impl.kt */
    public static final class Setter<D, E, V> extends kotlin.reflect.jvm.internal.KPropertyImpl.Setter<V> implements Object<D, E, V>, Function3 {
    ...
    public KMutableProperty2Impl(KDeclarationContainerImpl kDeclarationContainerImpl, PropertyDescriptor propertyDescriptor) {
        ...
        ReflectProperties$LazyVal<Setter<D, E, V>> lazy = TweetUtils.lazy((Function0<? extends T>) new KMutableProperty2Impl$_setter$1<Object>(this));
