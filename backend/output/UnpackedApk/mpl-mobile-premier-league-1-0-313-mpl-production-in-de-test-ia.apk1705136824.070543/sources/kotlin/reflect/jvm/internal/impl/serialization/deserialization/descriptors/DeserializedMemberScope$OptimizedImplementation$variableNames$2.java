...
public final class DeserializedMemberScope$OptimizedImplementation$variableNames$2 extends Lambda implements Function0<Set<? extends Name>> {
    ...
    public DeserializedMemberScope$OptimizedImplementation$variableNames$2(OptimizedImplementation optimizedImplementation, DeserializedMemberScope deserializedMemberScope) {
    ...
    public Object invoke() {
        return ArraysKt___ArraysJvmKt.plus(this.this$0.propertyProtosBytes.keySet(), (Iterable<? extends T>) this.this$1.getNonDeclaredVariableNames());
    }
}
