...
public final class DeserializedMemberScope$NoReorderImplementation$variableNames$2 extends Lambda implements Function0<Set<? extends Name>> {
    ...
    public DeserializedMemberScope$NoReorderImplementation$variableNames$2(NoReorderImplementation noReorderImplementation, DeserializedMemberScope deserializedMemberScope) {
    ...
    public Object invoke() {
        ...
        for (MessageLite messageLite : list) {
            linkedHashSet.add(TweetUtils.getName(deserializedMemberScope.f5951c.nameResolver, ((ProtoBuf$Property) messageLite).name_));
        }
        return ArraysKt___ArraysJvmKt.plus((Set<? extends T>) linkedHashSet, (Iterable<? extends T>) this.this$1.getNonDeclaredVariableNames());
    }
}
