...
public final class ParameterizedTypeImpl implements ParameterizedType, Type {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ParameterizedType) {
            ...
            if (Intrinsics.areEqual(this.rawType, parameterizedType.getRawType()) && Intrinsics.areEqual(this.ownerType, parameterizedType.getOwnerType()) && Arrays.equals(this.typeArguments, parameterizedType.getActualTypeArguments())) {
                return true;
            }
        }
        return false;
    ...
    public String getTypeName() {
        ...
        if (type != null) {
            ...
            sb.append(SFSBuddyVariable.OFFLINE_PREFIX);
            sb.append(this.rawType.getSimpleName());
        } else {
            sb.append(TypesJVMKt.access$typeToString(this.rawType));
        }
        if (!(this.typeArguments.length == 0)) {
            TweetUtils.joinTo(this.typeArguments, sb, ", ", "<", ">", -1, "...", ParameterizedTypeImpl$getTypeName$1$1.INSTANCE);
        }
    ...
    public int hashCode() {
        ...
        Type type = this.ownerType;
        return (hashCode ^ (type != null ? type.hashCode() : 0)) ^ Arrays.hashCode(this.typeArguments);
    }
