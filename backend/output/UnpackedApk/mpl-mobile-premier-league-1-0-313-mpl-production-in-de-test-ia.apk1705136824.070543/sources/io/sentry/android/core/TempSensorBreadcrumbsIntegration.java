...
public final class TempSensorBreadcrumbsIntegration implements Integration, Closeable, SensorEventListener {
    ...
    public void close() throws IOException {
        ...
        if (sensorManager2 != null) {
            ...
            if (sentryAndroidOptions != null) {
                sentryAndroidOptions.getLogger().log(SentryLevel.DEBUG, (String) "TempSensorBreadcrumbsIntegration removed.", new Object[0]);
            }
        }
    }
    ...
    public void register(IHub iHub, SentryOptions sentryOptions) {
        ...
        sentryAndroidOptions.getLogger().log(SentryLevel.DEBUG, (String) "enableSystemEventsBreadcrumbs enabled: %s", Boolean.valueOf(this.options.isEnableSystemEventBreadcrumbs()));
        if (this.options.isEnableSystemEventBreadcrumbs()) {
            ...
            if (sensorManager2 != null) {
                ...
                if (defaultSensor != null) {
                    ...
                    sentryOptions.getLogger().log(SentryLevel.DEBUG, (String) "TempSensorBreadcrumbsIntegration installed.", new Object[0]);
                    return;
                }
                this.options.getLogger().log(SentryLevel.INFO, (String) "TYPE_AMBIENT_TEMPERATURE is not available.", new Object[0]);
                return;
            }
            this.options.getLogger().log(SentryLevel.INFO, (String) "SENSOR_SERVICE is not available.", new Object[0]);
        }
    }
}
