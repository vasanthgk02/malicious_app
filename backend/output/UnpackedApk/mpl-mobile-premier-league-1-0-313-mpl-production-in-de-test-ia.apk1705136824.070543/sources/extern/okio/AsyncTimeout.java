    ...
    private static final class Watchdog extends Thread {
        ...
        public void run() {
            /*
                r3 = this;
            L_0x0000:
                java.lang.Class<extern.okio.AsyncTimeout> r0 = extern.okio.AsyncTimeout.class
                monitor-enter(r0)     // Catch:{ InterruptedException -> 0x0000 }
                extern.okio.AsyncTimeout r1 = extern.okio.AsyncTimeout.awaitTimeout()     // Catch:{ all -> 0x0019 }
                if (r1 != 0) goto L_0x000b
                monitor-exit(r0)     // Catch:{ all -> 0x0019 }
                goto L_0x0000
            L_0x000b:
                extern.okio.AsyncTimeout r2 = extern.okio.AsyncTimeout.head     // Catch:{ all -> 0x0019 }
                if (r1 != r2) goto L_0x0014
                r1 = 0
                extern.okio.AsyncTimeout.head = r1     // Catch:{ all -> 0x0019 }
                monitor-exit(r0)     // Catch:{ all -> 0x0019 }
                return
            L_0x0014:
                monitor-exit(r0)     // Catch:{ all -> 0x0019 }
            ...
            L_0x001d:
                goto L_0x001c
            */
            throw new UnsupportedOperationException("Method not decompiled: extern.okio.AsyncTimeout.Watchdog.run():void");
        }
    }
