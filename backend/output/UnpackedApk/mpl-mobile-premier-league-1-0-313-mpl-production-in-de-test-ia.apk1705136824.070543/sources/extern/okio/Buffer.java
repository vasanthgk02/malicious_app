...
public final class Buffer implements BufferedSink, BufferedSource, Cloneable, ByteChannel {
    private static final byte[] DIGITS = {BaseParser.ASCII_ZERO, 49, 50, 51, 52, 53, 54, 55, 56, BaseParser.ASCII_NINE, 97, 98, 99, 100, 101, 102};
    ...
    public int readInt() {
        if (this.size >= 4) {
            ...
            int i2 = segment.limit;
            if (i2 - i < 4) {
                return ((readByte() & 255) << 24) | ((readByte() & 255) << GlyfDescript.X_DUAL) | ((readByte() & 255) << 8) | (readByte() & 255);
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
    ...
    public long readDecimalLong() {
        /*
            ...
            r6 = 0
        L_0x0010:
            extern.okio.Segment r10 = r0.head
            byte[] r11 = r10.data
            int r12 = r10.pos
            int r13 = r10.limit
        L_0x0018:
        ...
        L_0x0038:
            ...
            goto L_0x0076
        L_0x003f:
            extern.okio.Buffer r1 = new extern.okio.Buffer
            r1.<init>()
            extern.okio.Buffer r1 = r1.writeDecimalLong(r3)
            extern.okio.Buffer r1 = r1.writeByte(r15)
        ...
        L_0x009a:
            ...
            extern.okio.Segment r1 = r10.pop()
            r0.head = r1
            extern.okio.SegmentPool.recycle(r10)
            goto L_0x00a8
        L_0x00a6:
            r10.pos = r12
        L_0x00a8:
            if (r6 != 0) goto L_0x00ae
            extern.okio.Segment r1 = r0.head
        ...
        L_0x00c2:
            goto L_0x00c1
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okio.Buffer.readDecimalLong():long");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x0093, code lost:
        r15.head = r6.pop();
        extern.okio.SegmentPool.recycle(r6);
     */
    ...
    public long readHexadecimalUnsignedLong() {
        /*
            ...
            r1 = 0
        L_0x000b:
            extern.okio.Segment r6 = r15.head
            byte[] r7 = r6.data
            int r8 = r6.pos
            int r9 = r6.limit
        L_0x0013:
        ...
        L_0x003a:
            ...
            goto L_0x0013
        L_0x004a:
            extern.okio.Buffer r0 = new extern.okio.Buffer
            r0.<init>()
            extern.okio.Buffer r0 = r0.writeHexadecimalUnsignedLong(r4)
            extern.okio.Buffer r0 = r0.writeByte(r10)
            java.lang.NumberFormatException r1 = new java.lang.NumberFormatException
            java.lang.StringBuilder r2 = new java.lang.StringBuilder
            r2.<init>()
        ...
        L_0x00b5:
            goto L_0x00b4
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okio.Buffer.readHexadecimalUnsignedLong():long");
    }
            ...
            while (i < i2) {
                ...
                if (charAt < 128) {
                    ...
                    if (charAt < 2048) {
                        ...
                        writeByte((charAt >> Tokenizer.FF) | 224);
