...
import extern.okhttp3.internal.cache.CacheRequest;
import extern.okhttp3.internal.cache.CacheStrategy;
import extern.okhttp3.internal.cache.DiskLruCache;
import extern.okhttp3.internal.cache.DiskLruCache.Editor;
import extern.okhttp3.internal.cache.DiskLruCache.Snapshot;
import extern.okhttp3.internal.cache.InternalCache;
import extern.okhttp3.internal.http.HttpHeaders;
import extern.okhttp3.internal.http.HttpMethod;
...
public final class Cache implements Closeable, Flushable {
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        /* JADX INFO: used method not loaded: extern.okhttp3.internal.Util.closeQuietly(java.io.Closeable):null, types can be incorrect */
        /* JADX WARNING: Code restructure failed: missing block: B:11:?, code lost:
            r4.editor.abort();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:9:0x0014, code lost:
            extern.okhttp3.internal.Util.closeQuietly((java.io.Closeable) r4.cacheOut);
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void abort() {
            /*
                r4 = this;
                extern.okhttp3.Cache r0 = extern.okhttp3.Cache.this
                monitor-enter(r0)
            ...
            L_0x0009:
                ...
                extern.okhttp3.Cache r2 = extern.okhttp3.Cache.this     // Catch:{ all -> 0x001f }
                int r3 = r2.writeAbortCount     // Catch:{ all -> 0x001f }
                int r3 = r3 + r1
                r2.writeAbortCount = r3     // Catch:{ all -> 0x001f }
                monitor-exit(r0)     // Catch:{ all -> 0x001f }
                extern.okio.Sink r0 = r4.cacheOut
                extern.okhttp3.internal.Util.closeQuietly(r0)
                extern.okhttp3.internal.cache.DiskLruCache$Editor r0 = r4.editor     // Catch:{ IOException -> 0x001e }
            ...
            L_0x001f:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.Cache.CacheRequestImpl.abort():void");
        }
    ...
    public CacheRequest put(Response response) {
        ...
        if (HttpMethod.invalidatesCache(response.request().method())) {
            ...
            return null;
        } else if (!method.equals(HttpGetRequest.METHOD_GET) || HttpHeaders.hasVaryAll(response)) {
            return null;
        } else {
