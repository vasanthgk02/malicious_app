package extern.okhttp3.internal.ws;

import com.google.firebase.crashlytics.internal.network.HttpGetRequest;
import extern.okhttp3.Call;
import extern.okhttp3.Callback;
...
import extern.okhttp3.WebSocket;
import extern.okhttp3.WebSocketListener;
...
import extern.okhttp3.internal.ws.WebSocketReader.FrameCallback;
...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if (HttpGetRequest.METHOD_GET.equals(request.method())) {
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        final Request build2 = this.originalRequest.newBuilder().header("Upgrade", WebSocketHandshake.HTTP_HEADER_UPGRADE_WEBSOCKET).header("Connection", "Upgrade").header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").build();
    ...
    public void checkResponse(Response response) throws ProtocolException {
        if (response.code() == 101) {
            ...
            if ("Upgrade".equalsIgnoreCase(header)) {
                ...
                if (WebSocketHandshake.HTTP_HEADER_UPGRADE_WEBSOCKET.equalsIgnoreCase(header2)) {
        ...
        throw new ProtocolException("Expected HTTP 101 response but was '" + response.code() + CMap.SPACE + response.message() + "'");
    }
    ...
    public synchronized void onReadPing(extern.okio.ByteString r2) {
        /*
            r1 = this;
            monitor-enter(r1)
            ...
            goto L_0x0022
        L_0x0012:
            java.util.ArrayDeque<extern.okio.ByteString> r0 = r1.pongQueue     // Catch:{ all -> 0x0024 }
        ...
        L_0x0024:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.ws.RealWebSocket.onReadPing(extern.okio.ByteString):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized boolean send(extern.okio.ByteString r7, int r8) {
        /*
            r6 = this;
            monitor-enter(r6)
        ...
        L_0x0022:
            ...
            extern.okhttp3.internal.ws.RealWebSocket$Message r1 = new extern.okhttp3.internal.ws.RealWebSocket$Message     // Catch:{ all -> 0x003e }
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.ws.RealWebSocket.send(extern.okio.ByteString, int):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0058, code lost:
        if ((r5 instanceof extern.okhttp3.internal.ws.RealWebSocket.Message) == false) goto L_0x0086;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x005a, code lost:
        r1 = ((extern.okhttp3.internal.ws.RealWebSocket.Message) r5).data;
        r0 = extern.okio.Okio.buffer(r0.newMessageSink(((extern.okhttp3.internal.ws.RealWebSocket.Message) r5).formatOpcode, (long) r1.size()));
        r0.write(r1);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x0088, code lost:
        if ((r5 instanceof extern.okhttp3.internal.ws.RealWebSocket.Close) == false) goto L_0x009f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008a, code lost:
        r5 = (extern.okhttp3.internal.ws.RealWebSocket.Close) r5;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x009a, code lost:
        extern.okhttp3.internal.Util.closeQuietly(r4);
     */
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        /*
            ...
            return r1
        L_0x0008:
            extern.okhttp3.internal.ws.WebSocketWriter r0 = r11.writer     // Catch:{ all -> 0x00aa }
            java.util.ArrayDeque<extern.okio.ByteString> r2 = r11.pongQueue     // Catch:{ all -> 0x00aa }
            java.lang.Object r2 = r2.poll()     // Catch:{ all -> 0x00aa }
            extern.okio.ByteString r2 = (extern.okio.ByteString) r2     // Catch:{ all -> 0x00aa }
            r3 = -1
            r4 = 0
            ...
            boolean r6 = r5 instanceof extern.okhttp3.internal.ws.RealWebSocket.Close     // Catch:{ all -> 0x00aa }
            if (r6 == 0) goto L_0x0046
            int r1 = r11.receivedCloseCode     // Catch:{ all -> 0x00aa }
            java.lang.String r6 = r11.receivedCloseReason     // Catch:{ all -> 0x00aa }
            if (r1 == r3) goto L_0x0031
            extern.okhttp3.internal.ws.RealWebSocket$Streams r3 = r11.streams     // Catch:{ all -> 0x00aa }
        ...
        L_0x0031:
            ...
            extern.okhttp3.internal.ws.RealWebSocket$CancelRunnable r7 = new extern.okhttp3.internal.ws.RealWebSocket$CancelRunnable     // Catch:{ all -> 0x00aa }
            r7.<init>()     // Catch:{ all -> 0x00aa }
            r8 = r5
            extern.okhttp3.internal.ws.RealWebSocket$Close r8 = (extern.okhttp3.internal.ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00aa }
        ...
        L_0x004f:
            ...
            goto L_0x009a
        L_0x0056:
            boolean r2 = r5 instanceof extern.okhttp3.internal.ws.RealWebSocket.Message     // Catch:{ all -> 0x00a5 }
            if (r2 == 0) goto L_0x0086
            r1 = r5
            extern.okhttp3.internal.ws.RealWebSocket$Message r1 = (extern.okhttp3.internal.ws.RealWebSocket.Message) r1     // Catch:{ all -> 0x00a5 }
            extern.okio.ByteString r1 = r1.data     // Catch:{ all -> 0x00a5 }
            extern.okhttp3.internal.ws.RealWebSocket$Message r5 = (extern.okhttp3.internal.ws.RealWebSocket.Message) r5     // Catch:{ all -> 0x00a5 }
            int r2 = r5.formatOpcode     // Catch:{ all -> 0x00a5 }
            int r3 = r1.size()     // Catch:{ all -> 0x00a5 }
            long r5 = (long) r3     // Catch:{ all -> 0x00a5 }
            extern.okio.Sink r0 = r0.newMessageSink(r2, r5)     // Catch:{ all -> 0x00a5 }
            extern.okio.BufferedSink r0 = extern.okio.Okio.buffer(r0)     // Catch:{ all -> 0x00a5 }
        ...
        L_0x0086:
            boolean r2 = r5 instanceof extern.okhttp3.internal.ws.RealWebSocket.Close     // Catch:{ all -> 0x00a5 }
            if (r2 == 0) goto L_0x009f
            extern.okhttp3.internal.ws.RealWebSocket$Close r5 = (extern.okhttp3.internal.ws.RealWebSocket.Close) r5     // Catch:{ all -> 0x00a5 }
            int r2 = r5.code     // Catch:{ all -> 0x00a5 }
            extern.okio.ByteString r3 = r5.reason     // Catch:{ all -> 0x00a5 }
            r0.writeClose(r2, r3)     // Catch:{ all -> 0x00a5 }
            if (r4 == 0) goto L_0x009a
            extern.okhttp3.WebSocketListener r0 = r11.listener     // Catch:{ all -> 0x00a5 }
        ...
        L_0x00aa:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.ws.RealWebSocket.writeOneFrame():boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
        r0.writePing(extern.okio.ByteString.EMPTY);
     */
    ...
    public void writePingFrame() {
        /*
            ...
            return
        L_0x0007:
            extern.okhttp3.internal.ws.WebSocketWriter r0 = r7.writer     // Catch:{ all -> 0x0053 }
        ...
        L_0x0012:
            ...
            return
        L_0x0048:
            extern.okio.ByteString r1 = extern.okio.ByteString.EMPTY     // Catch:{ IOException -> 0x004e }
        ...
        L_0x0053:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.ws.RealWebSocket.writePingFrame():void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x002d, code lost:
        extern.okhttp3.internal.Util.closeQuietly((java.io.Closeable) r0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0030, code lost:
        throw r4;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void failWebSocket(java.lang.Exception r4, @javax.annotation.Nullable extern.okhttp3.Response r5) {
        /*
            r3 = this;
            monitor-enter(r3)
        ...
        L_0x0007:
            ...
            extern.okhttp3.internal.ws.RealWebSocket$Streams r0 = r3.streams     // Catch:{ all -> 0x0031 }
            r1 = 0
        ...
        L_0x0022:
            monitor-exit(r3)     // Catch:{ all -> 0x0031 }
            extern.okhttp3.WebSocketListener r1 = r3.listener     // Catch:{ all -> 0x002c }
        ...
        L_0x0031:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.ws.RealWebSocket.failWebSocket(java.lang.Exception, extern.okhttp3.Response):void");
    }
}
