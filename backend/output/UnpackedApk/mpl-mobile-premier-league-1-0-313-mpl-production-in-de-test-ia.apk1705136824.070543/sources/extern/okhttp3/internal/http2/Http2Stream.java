...
public final class Http2Stream {
    ...
    final class FramingSink implements Sink {
        ...
        public void close() throws java.io.IOException {
            /*
                r8 = this;
                extern.okhttp3.internal.http2.Http2Stream r0 = extern.okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r0)
            ...
            L_0x0009:
                monitor-exit(r0)     // Catch:{ all -> 0x0052 }
                extern.okhttp3.internal.http2.Http2Stream r0 = extern.okhttp3.internal.http2.Http2Stream.this
                extern.okhttp3.internal.http2.Http2Stream$FramingSink r0 = r0.sink
                boolean r0 = r0.finished
                r1 = 1
                if (r0 != 0) goto L_0x003c
                extern.okio.Buffer r0 = r8.sendBuffer
                long r2 = r0.size()
                r4 = 0
            ...
            L_0x002d:
                extern.okhttp3.internal.http2.Http2Stream r0 = extern.okhttp3.internal.http2.Http2Stream.this
                extern.okhttp3.internal.http2.Http2Connection r2 = r0.connection
                extern.okhttp3.internal.http2.Http2Stream r0 = extern.okhttp3.internal.http2.Http2Stream.this
                int r3 = r0.id
                r4 = 1
                r5 = 0
            ...
            L_0x003c:
                extern.okhttp3.internal.http2.Http2Stream r2 = extern.okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r2)
                r8.closed = r1     // Catch:{ all -> 0x004f }
                monitor-exit(r2)     // Catch:{ all -> 0x004f }
                extern.okhttp3.internal.http2.Http2Stream r0 = extern.okhttp3.internal.http2.Http2Stream.this
                extern.okhttp3.internal.http2.Http2Connection r0 = r0.connection
                r0.flush()
                extern.okhttp3.internal.http2.Http2Stream r0 = extern.okhttp3.internal.http2.Http2Stream.this
            ...
            L_0x0056:
                goto L_0x0055
            */
            throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.http2.Http2Stream.FramingSink.close():void");
        }
    }
