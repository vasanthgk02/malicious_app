...
import extern.okhttp3.internal.io.FileSystem;
...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
            ...
            r5.this$0.journalWriter = extern.okio.Okio.buffer(extern.okio.Okio.blackhole());
         */
        ...
        public void run() {
            /*
                r5 = this;
                extern.okhttp3.internal.cache.DiskLruCache r0 = extern.okhttp3.internal.cache.DiskLruCache.this
                monitor-enter(r0)
                extern.okhttp3.internal.cache.DiskLruCache r1 = extern.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
            ...
            L_0x000d:
                r1 = 0
            L_0x000e:
                extern.okhttp3.internal.cache.DiskLruCache r4 = extern.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
                ...
                return
            L_0x0017:
                extern.okhttp3.internal.cache.DiskLruCache r1 = extern.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ IOException -> 0x001d }
            ...
            L_0x0021:
                extern.okhttp3.internal.cache.DiskLruCache r1 = extern.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ IOException -> 0x0033 }
            ...
            L_0x0033:
                ...
                extern.okhttp3.internal.cache.DiskLruCache r1 = extern.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
                extern.okio.Sink r2 = extern.okio.Okio.blackhole()     // Catch:{ all -> 0x0045 }
                extern.okio.BufferedSink r2 = extern.okio.Okio.buffer(r2)     // Catch:{ all -> 0x0045 }
            ...
            L_0x0045:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.cache.DiskLruCache.AnonymousClass1.run():void");
        }
    };
    boolean closed;
    ...
    public final class Editor {
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public extern.okio.Source newSource(int r5) {
            /*
                r4 = this;
                extern.okhttp3.internal.cache.DiskLruCache r0 = extern.okhttp3.internal.cache.DiskLruCache.this
                monitor-enter(r0)
                ...
                extern.okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x002f }
                boolean r1 = r1.readable     // Catch:{ all -> 0x002f }
                r2 = 0
                if (r1 == 0) goto L_0x0027
                extern.okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x002f }
                extern.okhttp3.internal.cache.DiskLruCache$Editor r1 = r1.currentEditor     // Catch:{ all -> 0x002f }
                if (r1 == r4) goto L_0x0015
                goto L_0x0027
            L_0x0015:
                extern.okhttp3.internal.cache.DiskLruCache r1 = extern.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ FileNotFoundException -> 0x0025 }
                extern.okhttp3.internal.io.FileSystem r1 = r1.fileSystem     // Catch:{ FileNotFoundException -> 0x0025 }
                extern.okhttp3.internal.cache.DiskLruCache$Entry r3 = r4.entry     // Catch:{ FileNotFoundException -> 0x0025 }
                java.io.File[] r3 = r3.cleanFiles     // Catch:{ FileNotFoundException -> 0x0025 }
                r5 = r3[r5]     // Catch:{ FileNotFoundException -> 0x0025 }
                extern.okio.Source r5 = r1.source(r5)     // Catch:{ FileNotFoundException -> 0x0025 }
            ...
            L_0x002f:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.cache.DiskLruCache.Editor.newSource(int):extern.okio.Source");
        }
        ...
        public void abortUnlessCommitted() {
            /*
                ...
                extern.okhttp3.internal.cache.DiskLruCache$Entry r1 = r3.entry     // Catch:{ all -> 0x0015 }
                extern.okhttp3.internal.cache.DiskLruCache$Editor r1 = r1.currentEditor     // Catch:{ all -> 0x0015 }
                if (r1 != r3) goto L_0x0013
                extern.okhttp3.internal.cache.DiskLruCache r1 = extern.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ IOException -> 0x0013 }
                r2 = 0
            ...
            L_0x0015:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.cache.DiskLruCache.Editor.abortUnlessCommitted():void");
        }
    }
    ...
    private void readJournal() throws java.io.IOException {
        /*
            r9 = this;
            java.lang.String r0 = ", "
            extern.okhttp3.internal.io.FileSystem r1 = r9.fileSystem
            java.io.File r2 = r9.journalFile
            extern.okio.Source r1 = r1.source(r2)
            extern.okio.BufferedSource r1 = extern.okio.Okio.buffer(r1)
        ...
        L_0x0053:
            ...
            goto L_0x0053
        L_0x005d:
            java.util.LinkedHashMap<java.lang.String, extern.okhttp3.internal.cache.DiskLruCache$Entry> r2 = r9.lruEntries     // Catch:{ all -> 0x00a8 }
            ...
            goto L_0x0076
        L_0x0070:
            extern.okio.BufferedSink r0 = r9.newJournalWriter()     // Catch:{ all -> 0x00a8 }
        ...
        L_0x00ae:
            goto L_0x00ad
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.cache.DiskLruCache.readJournal():void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized extern.okhttp3.internal.cache.DiskLruCache.Snapshot get(java.lang.String r4) throws java.io.IOException {
        /*
            r3 = this;
            monitor-enter(r3)
            ...
            java.util.LinkedHashMap<java.lang.String, extern.okhttp3.internal.cache.DiskLruCache$Entry> r0 = r3.lruEntries     // Catch:{ all -> 0x0050 }
            java.lang.Object r0 = r0.get(r4)     // Catch:{ all -> 0x0050 }
            extern.okhttp3.internal.cache.DiskLruCache$Entry r0 = (extern.okhttp3.internal.cache.DiskLruCache.Entry) r0     // Catch:{ all -> 0x0050 }
            r1 = 0
            ...
            goto L_0x004e
        L_0x001a:
            extern.okhttp3.internal.cache.DiskLruCache$Snapshot r0 = r0.snapshot()     // Catch:{ all -> 0x0050 }
        ...
        L_0x0022:
            ...
            extern.okio.BufferedSink r1 = r3.journalWriter     // Catch:{ all -> 0x0050 }
            java.lang.String r2 = "READ"
            extern.okio.BufferedSink r1 = r1.writeUtf8(r2)     // Catch:{ all -> 0x0050 }
            r2 = 32
            extern.okio.BufferedSink r1 = r1.writeByte(r2)     // Catch:{ all -> 0x0050 }
            extern.okio.BufferedSink r4 = r1.writeUtf8(r4)     // Catch:{ all -> 0x0050 }
            r1 = 10
        ...
        L_0x0050:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.cache.DiskLruCache.get(java.lang.String):extern.okhttp3.internal.cache.DiskLruCache$Snapshot");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized extern.okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        /*
            r5 = this;
            monitor-enter(r5)
            ...
            java.util.LinkedHashMap<java.lang.String, extern.okhttp3.internal.cache.DiskLruCache$Entry> r0 = r5.lruEntries     // Catch:{ all -> 0x0074 }
            java.lang.Object r0 = r0.get(r6)     // Catch:{ all -> 0x0074 }
            extern.okhttp3.internal.cache.DiskLruCache$Entry r0 = (extern.okhttp3.internal.cache.DiskLruCache.Entry) r0     // Catch:{ all -> 0x0074 }
            r1 = -1
            r3 = 0
        ...
        L_0x0023:
            ...
            extern.okhttp3.internal.cache.DiskLruCache$Editor r7 = r0.currentEditor     // Catch:{ all -> 0x0074 }
        ...
        L_0x002b:
            ...
            goto L_0x006b
        L_0x0034:
            extern.okio.BufferedSink r7 = r5.journalWriter     // Catch:{ all -> 0x0074 }
            java.lang.String r8 = "DIRTY"
            extern.okio.BufferedSink r7 = r7.writeUtf8(r8)     // Catch:{ all -> 0x0074 }
            r8 = 32
            extern.okio.BufferedSink r7 = r7.writeByte(r8)     // Catch:{ all -> 0x0074 }
            extern.okio.BufferedSink r7 = r7.writeUtf8(r6)     // Catch:{ all -> 0x0074 }
            r8 = 10
        ...
        L_0x0056:
            ...
            extern.okhttp3.internal.cache.DiskLruCache$Entry r0 = new extern.okhttp3.internal.cache.DiskLruCache$Entry     // Catch:{ all -> 0x0074 }
            r0.<init>(r6)     // Catch:{ all -> 0x0074 }
            java.util.LinkedHashMap<java.lang.String, extern.okhttp3.internal.cache.DiskLruCache$Entry> r7 = r5.lruEntries     // Catch:{ all -> 0x0074 }
            r7.put(r6, r0)     // Catch:{ all -> 0x0074 }
        L_0x0062:
            extern.okhttp3.internal.cache.DiskLruCache$Editor r6 = new extern.okhttp3.internal.cache.DiskLruCache$Editor     // Catch:{ all -> 0x0074 }
        ...
        L_0x0074:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.cache.DiskLruCache.edit(java.lang.String, long):extern.okhttp3.internal.cache.DiskLruCache$Editor");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void completeEdit(extern.okhttp3.internal.cache.DiskLruCache.Editor r10, boolean r11) throws java.io.IOException {
        /*
            r9 = this;
            monitor-enter(r9)
            extern.okhttp3.internal.cache.DiskLruCache$Entry r0 = r10.entry     // Catch:{ all -> 0x00fb }
            extern.okhttp3.internal.cache.DiskLruCache$Editor r1 = r0.currentEditor     // Catch:{ all -> 0x00fb }
        ...
        L_0x000f:
            ...
            extern.okhttp3.internal.io.FileSystem r3 = r9.fileSystem     // Catch:{ all -> 0x00fb }
        ...
        L_0x0047:
            ...
            extern.okhttp3.internal.io.FileSystem r2 = r9.fileSystem     // Catch:{ all -> 0x00fb }
            ...
            extern.okhttp3.internal.io.FileSystem r10 = r9.fileSystem     // Catch:{ all -> 0x00fb }
        ...
        L_0x007f:
            ...
            extern.okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r1 = "CLEAN"
            extern.okio.BufferedSink r10 = r10.writeUtf8(r1)     // Catch:{ all -> 0x00fb }
            ...
            goto L_0x00d9
        L_0x00bb:
            java.util.LinkedHashMap<java.lang.String, extern.okhttp3.internal.cache.DiskLruCache$Entry> r10 = r9.lruEntries     // Catch:{ all -> 0x00fb }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x00fb }
            r10.remove(r11)     // Catch:{ all -> 0x00fb }
            extern.okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r11 = "REMOVE"
            extern.okio.BufferedSink r10 = r10.writeUtf8(r11)     // Catch:{ all -> 0x00fb }
            r10.writeByte(r3)     // Catch:{ all -> 0x00fb }
            extern.okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x00fb }
        ...
        L_0x00ff:
            goto L_0x00fe
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.cache.DiskLruCache.completeEdit(extern.okhttp3.internal.cache.DiskLruCache$Editor, boolean):void");
    }
    ...
    public synchronized boolean remove(java.lang.String r7) throws java.io.IOException {
        /*
            ...
            java.util.LinkedHashMap<java.lang.String, extern.okhttp3.internal.cache.DiskLruCache$Entry> r0 = r6.lruEntries     // Catch:{ all -> 0x0029 }
            java.lang.Object r7 = r0.get(r7)     // Catch:{ all -> 0x0029 }
            extern.okhttp3.internal.cache.DiskLruCache$Entry r7 = (extern.okhttp3.internal.cache.DiskLruCache.Entry) r7     // Catch:{ all -> 0x0029 }
            r0 = 0
        ...
        L_0x0029:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.cache.DiskLruCache.remove(java.lang.String):boolean");
    }
