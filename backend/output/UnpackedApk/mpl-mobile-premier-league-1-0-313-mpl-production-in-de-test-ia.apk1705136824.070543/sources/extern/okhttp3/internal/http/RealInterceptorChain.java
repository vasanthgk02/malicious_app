...
public final class RealInterceptorChain implements Chain {
    ...
    public Chain withConnectTimeout(int i, TimeUnit timeUnit) {
        RealInterceptorChain realInterceptorChain = new RealInterceptorChain(this.interceptors, this.streamAllocation, this.httpCodec, this.connection, this.index, this.request, this.call, this.eventListener, Util.checkDuration(Values.TIMEOUT, (long) i, timeUnit), this.readTimeout, this.writeTimeout);
    ...
    public Chain withReadTimeout(int i, TimeUnit timeUnit) {
        RealInterceptorChain realInterceptorChain = new RealInterceptorChain(this.interceptors, this.streamAllocation, this.httpCodec, this.connection, this.index, this.request, this.call, this.eventListener, this.connectTimeout, Util.checkDuration(Values.TIMEOUT, (long) i, timeUnit), this.writeTimeout);
        return realInterceptorChain;
    }
    ...
    public Chain withWriteTimeout(int i, TimeUnit timeUnit) {
        RealInterceptorChain realInterceptorChain = new RealInterceptorChain(this.interceptors, this.streamAllocation, this.httpCodec, this.connection, this.index, this.request, this.call, this.eventListener, this.connectTimeout, this.readTimeout, Util.checkDuration(Values.TIMEOUT, (long) i, timeUnit));
        return realInterceptorChain;
    }
