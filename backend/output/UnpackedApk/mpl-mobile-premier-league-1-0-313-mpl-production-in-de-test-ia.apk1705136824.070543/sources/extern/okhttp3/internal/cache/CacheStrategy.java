...
import extern.okhttp3.CacheControl;
...
public final class CacheStrategy {
            ...
            if (!cacheControl2.noCache()) {
                ...
                if (j2 < j + computeFreshnessLifetime) {
                    ...
                    if (j2 >= computeFreshnessLifetime) {
                        newBuilder.addHeader(Names.WARNING, "110 HttpURLConnection \"Response is stale\"");
                    }
                    if (cacheResponseAge > 86400000 && isFreshnessLifetimeHeuristic()) {
                        newBuilder.addHeader(Names.WARNING, "113 HttpURLConnection \"Heuristic expiration\"");
                    }
    ...
    public static boolean isCacheable(extern.okhttp3.Response r3, extern.okhttp3.Request r4) {
        /*
            int r0 = r3.code()
        ...
        L_0x0031:
            ...
            extern.okhttp3.CacheControl r0 = r3.cacheControl()
        ...
        L_0x0059:
            return r2
        L_0x005a:
            extern.okhttp3.CacheControl r3 = r3.cacheControl()
            boolean r3 = r3.noStore()
            if (r3 != 0) goto L_0x006f
            extern.okhttp3.CacheControl r3 = r4.cacheControl()
            boolean r3 = r3.noStore()
            if (r3 != 0) goto L_0x006f
            r2 = 1
        L_0x006f:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.cache.CacheStrategy.isCacheable(extern.okhttp3.Response, extern.okhttp3.Request):boolean");
    }
}
