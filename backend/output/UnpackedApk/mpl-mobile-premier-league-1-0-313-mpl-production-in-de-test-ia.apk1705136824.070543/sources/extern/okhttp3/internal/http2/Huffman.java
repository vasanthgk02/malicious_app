...
class Huffman {
    ...
    public void encode(extern.okio.ByteString r9, extern.okio.BufferedSink r10) throws java.io.IOException {
        /*
            r8 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x003a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.internal.http2.Huffman.encode(extern.okio.ByteString, extern.okio.BufferedSink):void");
    }
    ...
    public byte[] decode(byte[] bArr) {
        ...
        for (byte b3 : bArr) {
            ...
            i += 8;
            while (i >= 8) {
                node = node.children[(b2 >>> (i - 8)) & InvitationReply.EXPIRED];
        ...
        while (i > 0) {
            Node node2 = node.children[(b2 << (8 - i)) & InvitationReply.EXPIRED];
    ...
    private void addCode(int i, int i2, byte b2) {
        ...
        while (b2 > 8) {
            b2 = (byte) (b2 - 8);
            int i3 = (i2 >>> b2) & InvitationReply.EXPIRED;
        ...
        int i4 = 8 - b2;
        int i5 = (i2 << i4) & InvitationReply.EXPIRED;
        int i6 = 1 << i4;
