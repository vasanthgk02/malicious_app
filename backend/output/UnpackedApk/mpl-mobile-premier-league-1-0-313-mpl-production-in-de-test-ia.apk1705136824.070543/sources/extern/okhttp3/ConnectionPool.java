...
import extern.okhttp3.internal.connection.StreamAllocation.StreamAllocationReference;
        ...
        this.cleanupRunnable = new Runnable() {
            ...
            public void run() {
                /*
                    r6 = this;
                L_0x0000:
                    extern.okhttp3.ConnectionPool r0 = extern.okhttp3.ConnectionPool.this
                ...
                L_0x0011:
                    ...
                    long r2 = r2 * r4
                    long r0 = r0 - r2
                    extern.okhttp3.ConnectionPool r2 = extern.okhttp3.ConnectionPool.this
                    monitor-enter(r2)
                    extern.okhttp3.ConnectionPool r3 = extern.okhttp3.ConnectionPool.this     // Catch:{ InterruptedException -> 0x002b }
                ...
                L_0x0030:
                    goto L_0x002f
                */
                throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.ConnectionPool.AnonymousClass1.run():void");
            }
        };
    ...
    private int pruneAndGetAllocationCount(RealConnection realConnection, long j) {
        ...
        while (i < list.size()) {
            ...
            if (reference.get() != null) {
                ...
                Platform.get().logCloseableLeak("A connection to " + realConnection.route().address().url() + " was leaked. Did you forget to close a response body?", ((StreamAllocationReference) reference).callStackTrace);
                list.remove(i);
