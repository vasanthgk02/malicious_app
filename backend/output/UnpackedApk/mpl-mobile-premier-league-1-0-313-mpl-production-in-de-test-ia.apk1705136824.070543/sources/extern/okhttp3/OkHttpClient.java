...
import extern.okhttp3.Call.Factory;
...
public class OkHttpClient implements Factory, WebSocket.Factory, Cloneable {
    ...
    public static final class Builder {
        ...
        public Builder callTimeout(Duration duration) {
            this.callTimeout = Util.checkDuration(Values.TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public Builder connectTimeout(Duration duration) {
            this.connectTimeout = Util.checkDuration(Values.TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public Builder readTimeout(Duration duration) {
            this.readTimeout = Util.checkDuration(Values.TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public Builder writeTimeout(Duration duration) {
            this.writeTimeout = Util.checkDuration(Values.TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public Builder pingInterval(Duration duration) {
            this.pingInterval = Util.checkDuration(Values.TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }
    ...
    static {
        Internal.instance = new Internal() {
            public void addLenient(extern.okhttp3.Headers.Builder builder, String str) {
                builder.addLenient(str);
            }

            public void addLenient(extern.okhttp3.Headers.Builder builder, String str, String str2) {
            ...
            public int code(extern.okhttp3.Response.Builder builder) {
                return builder.code;
            }
            ...
            public boolean isInvalidHttpUrlHost(IllegalArgumentException illegalArgumentException) {
                return illegalArgumentException.getMessage().startsWith(okhttp3.HttpUrl.Builder.INVALID_HOST);
            }
