...
import extern.okhttp3.internal.publicsuffix.PublicSuffixDatabase;
...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public Builder scheme(String str) {
            if (str != null) {
                ...
                } else if (str.equalsIgnoreCase(NetworkRequestHandler.SCHEME_HTTPS)) {
        ...
        public Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl2 == null || !httpUrl2.scheme.equals(this.scheme)) {
                ...
                boolean z2 = false;
                while (true) {
                    delimiterOffset = Util.delimiterOffset(str2, i2, skipTrailingAsciiWhitespace, (String) "@/\\?#");
                ...
                if (i42 < i32) {
                    ...
                    if (this.port == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str2.substring(i42, i32) + StringEscapeUtils.CSV_QUOTE);
                    }
                } else {
                    this.host = canonicalizeHost(str2, i2, portColonOffset2);
                ...
                if (this.host != null) {
                    ...
                    throw new IllegalArgumentException("Invalid URL host: \"" + str2.substring(i2, portColonOffset2) + StringEscapeUtils.CSV_QUOTE);
                }
            } else {
            ...
            int delimiterOffset3 = Util.delimiterOffset(str2, skipLeadingAsciiWhitespace, skipTrailingAsciiWhitespace, (String) "?#");
        ...
        private void resolvePath(java.lang.String r11, int r12, int r13) {
            ...
            L_0x0029:
                ...
                int r12 = extern.okhttp3.internal.Util.delimiterOffset(r11, r6, r13, r12)
            ...
            L_0x0044:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: extern.okhttp3.HttpUrl.Builder.resolvePath(java.lang.String, int, int):void");
        }
    ...
    public boolean isHttps() {
        return this.scheme.equals(NetworkRequestHandler.SCHEME_HTTPS);
    }
    ...
    public static int defaultPort(String str) {
        ...
        return str.equals(NetworkRequestHandler.SCHEME_HTTPS) ? 443 : -1;
    }
