...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class StubApi23 extends StubApi21 implements android.support.v4.media.session.MediaSessionCompatApi23.Callback {
            public StubApi23() {
                super();
            }
        ...
        public class StubApi24 extends StubApi23 implements android.support.v4.media.session.MediaSessionCompatApi24.Callback {
            public StubApi24() {
                super();
            }
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(MediaSessionManager$RemoteUserInfo mediaSessionManager$RemoteUserInfo) {
            long j;
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public class ExtraSession extends Stub {
            public ExtraSession() {
            }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public final Token mToken;
        public androidx.media.VolumeProviderCompat.Callback mVolumeCallback = new androidx.media.VolumeProviderCompat.Callback() {
        ...
        public class MediaSessionStub extends Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                ParcelableVolumeInfo parcelableVolumeInfo = new ParcelableVolumeInfo(i, i2, 2, streamMaxVolume, streamVolume);
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public static QueueItem fromQueueItem(Object obj) {
            if (obj != null) {
                return new QueueItem(obj, MediaDescriptionCompat.fromMediaDescription(android.support.v4.media.session.MediaSessionCompatApi21.QueueItem.getDescription(obj)), android.support.v4.media.session.MediaSessionCompatApi21.QueueItem.getQueueId(obj));
            }
            return null;
        }
        ...
        public Object getQueueItem() {
            ...
            Object createItem = android.support.v4.media.session.MediaSessionCompatApi21.QueueItem.createItem(this.mDescription.getMediaDescription(), this.mId);
            this.mItem = createItem;
            return createItem;
        }

        public String toString() {
            StringBuilder outline73 = GeneratedOutlineSupport.outline73("MediaSession.QueueItem {Description=");
            outline73.append(this.mDescription);
            outline73.append(", Id=");
            return GeneratedOutlineSupport.outline58(outline73, this.mId, " }");
        }
