...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            if (!(MediaMetadataCompat.METADATA_KEYS_TYPE.indexOfKey(str) >= 0) || ((Integer) MediaMetadataCompat.METADATA_KEYS_TYPE.getOrDefault(str, null)).intValue() == 2) {
                this.mBundle.putParcelable(str, bitmap);
                return this;
            }
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline52("The ", str, " key cannot be used to put a Bitmap"));
        }

        public Builder putLong(String str, long j) {
            if (!(MediaMetadataCompat.METADATA_KEYS_TYPE.indexOfKey(str) >= 0) || ((Integer) MediaMetadataCompat.METADATA_KEYS_TYPE.getOrDefault(str, null)).intValue() == 0) {
                this.mBundle.putLong(str, j);
                return this;
            }
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline52("The ", str, " key cannot be used to put a long"));
        }

        public Builder putRating(String str, RatingCompat ratingCompat) {
            if (!(MediaMetadataCompat.METADATA_KEYS_TYPE.indexOfKey(str) >= 0) || ((Integer) MediaMetadataCompat.METADATA_KEYS_TYPE.getOrDefault(str, null)).intValue() == 3) {
                this.mBundle.putParcelable(str, (Parcelable) ratingCompat.getRating());
                return this;
            }
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline52("The ", str, " key cannot be used to put a Rating"));
        }

        public Builder putString(String str, String str2) {
            if (!(MediaMetadataCompat.METADATA_KEYS_TYPE.indexOfKey(str) >= 0) || ((Integer) MediaMetadataCompat.METADATA_KEYS_TYPE.getOrDefault(str, null)).intValue() == 1) {
                this.mBundle.putCharSequence(str, str2);
                return this;
            }
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline52("The ", str, " key cannot be used to put a String"));
        }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline52("The ", str, " key cannot be used to put a CharSequence"));
        }
