...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements DeathRecipient {
        ...
        public static class StubCompat extends Stub {
            public final WeakReference<Callback> mCallback;
    ...
    public static class MediaControllerExtraData extends ExtraData {
    ...
    public static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public static class ExtraCallback extends StubCompat {
    ...
    public static class TransportControlsApi21 extends TransportControls {
        ...
        public void playFromUri(Uri uri, Bundle bundle) {
            ...
            sendCustomAction((String) MediaSessionCompat.ACTION_PLAY_FROM_URI, bundle2);
        }

        public void prepare() {
            sendCustomAction((String) MediaSessionCompat.ACTION_PREPARE, (Bundle) null);
        }
        ...
        public void prepareFromMediaId(String str, Bundle bundle) {
            ...
            bundle2.putBundle(MediaSessionCompat.ACTION_ARGUMENT_EXTRAS, bundle);
            sendCustomAction((String) MediaSessionCompat.ACTION_PREPARE_FROM_MEDIA_ID, bundle2);
        }
        ...
        public void prepareFromSearch(String str, Bundle bundle) {
            ...
            bundle2.putBundle(MediaSessionCompat.ACTION_ARGUMENT_EXTRAS, bundle);
            sendCustomAction((String) MediaSessionCompat.ACTION_PREPARE_FROM_SEARCH, bundle2);
        }
        ...
        public void prepareFromUri(Uri uri, Bundle bundle) {
            ...
            bundle2.putParcelable(MediaSessionCompat.ACTION_ARGUMENT_URI, uri);
            bundle2.putBundle(MediaSessionCompat.ACTION_ARGUMENT_EXTRAS, bundle);
            sendCustomAction((String) MediaSessionCompat.ACTION_PREPARE_FROM_URI, bundle2);
        }
        ...
        public void setCaptioningEnabled(boolean z) {
            ...
            sendCustomAction((String) MediaSessionCompat.ACTION_SET_CAPTIONING_ENABLED, bundle);
        }
        ...
        public void setRepeatMode(int i) {
            ...
            sendCustomAction((String) MediaSessionCompat.ACTION_SET_REPEAT_MODE, bundle);
        }

        public void setShuffleMode(int i) {
            Bundle bundle = new Bundle();
            bundle.putInt(MediaSessionCompat.ACTION_ARGUMENT_SHUFFLE_MODE, i);
            sendCustomAction((String) MediaSessionCompat.ACTION_SET_SHUFFLE_MODE, bundle);
        }
        ...
        public void setRating(RatingCompat ratingCompat, Bundle bundle) {
            ...
            bundle2.putBundle(MediaSessionCompat.ACTION_ARGUMENT_EXTRAS, bundle);
            sendCustomAction((String) MediaSessionCompat.ACTION_SET_RATING, bundle2);
        }
    ...
    public MediaControllerCompat(Context context, MediaSessionCompat mediaSessionCompat) {
        ...
        if (mediaSessionCompat != null) {
            Token sessionToken = mediaSessionCompat.getSessionToken();
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        if (str != null) {
            ...
            if ((c2 == 0 || c2 == 1) && (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE))) {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline52("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
            }
        }
    }
